							...
							<div class="features_items">
								...
								<div class=""
									...
									<s:if test="accountFlag=='csr'">
										<s:a href='%{#csrMyUrl}' id="techSearchAccountName">
											<s:property value="%{accountName}" />
										</s:a>
									</s:if>
									<s:else>
										<s:a href='#' id="techSearchAccountName">
											<s:property value="%{accountName}" />
										</s:a>
									</s:else>
									<s:if test="accountFlag=='csr'">
									...
									<s:if test="accountFlag=='csr'">
										<s:a href='%{#csrReqEditUrl}' id="techSearchJdId"> >> <s:property
												value="%{jdId}" />
										</s:a>
									</s:if>
									<s:else>
										<s:a href='%{#custReqEditUrl}' id="techSearchJdId"> >> <s:property
												value="%{jdId}" />
										</s:a>
									</s:else>
								...
								<div class="" id="profileBox"
									...
									<div class="backgroundcolor">
										<div class="panel-heading">
											<h4 class="panel-title">
												<font color="#ffffff">Tech&nbsp;Review&nbsp;Details</font> <i
													id="updownArrowAccount"
													onclick="toggleContentAccount('techReviewForm')"
													class="fa fa-angle-up"></i>
												<s:url var="contechReqEditUrl"
													action="Requirements/requirementedit.action">
													<s:param name="requirementId">
														<s:property value="%{requirementId}" />
													</s:param>
												...
												<span class="pull-right"><s:a
														href='%{#contechReqEditUrl}'>
										...
										<div id="emailPhoneShowOnOverlay">
											<div class="overlayOrButton_color">
												<table>
													<tr>
														<td><h4 style="">
																<font color="#ffffff">&nbsp;&nbsp;Techie&nbsp;Details&nbsp;&nbsp;
																</font>
															</h4></td>
													</tr>
													<span class=" pull-right"><h5>
															<a href="" id="techSearchPhoneOverlayClose"
																class="emailPhoneShow_popup_close"
																onclick="techReviewEmailPhoneOverlay();"><i
									...
									<div id="techReviewCommentsOverlay_popup">
										<div id="reviewCommentsOverlay">
												...
												<table>
													<tr>
														<td><h4 style="font-family: cursive">
																<font class="titleColor">&nbsp;&nbsp;Review&nbsp;Comments&nbsp;&nbsp;
																</font>
															</h4></td>
														<span class="pull-right">
															<h5>
																&nbsp;&nbsp;&nbsp;&nbsp;<a href=""
																	id="techSearchCommentsOverlayClose"
																	class="techReviewCommentsOverlay_popup_close"
																	onclick="techReviewCommentsOverlayJs()"><i
																	class="fa fa-times-circle-o fa-size"></i></a>
															</h5>
														</span>
												</table>
											...
											<div>
												...
												<s:textarea name="reviewComments" id="reviewComments"
													disabled="true"
										...
										<div id="techReviewBoxResults" class="techReviewPopupStyle">
											<div class="backgroundcolor">
												<table>
													<tr>
														<td><h4 style="font-family: cursive">
																<font class="titleColor">&nbsp;&nbsp;Tech&nbsp;Review&nbsp;Results&nbsp;of&nbsp;Consultant&nbsp;&nbsp;
																</font>
															</h4></td>
														<span class="pull-right">
															<h5>
																&nbsp;&nbsp;&nbsp;&nbsp;<a href="#"
																	id="techSearchResultOverlay"
																	class="techReviewResults_popup_close"
																	onclick="techReviewResultsOverlay()"><i
																	class="fa fa-times-circle-o fa-size"></i></a>
															</h5>
														</span>
												</table>
											...
											<div style="padding: 0 1%">
												...
												<div id="reviewalignBox">
													<div class="techreview_details row">
														...
														<div class="col-sm-4">
															...
															<span id="examStatus"
																class="col-sm-12 col-lg-6 no_gutter"> </span> <span
																id="onlineExam"> <s:select
												...
												<span id="notOnline"> <label class="headingLabel">Skill&nbsp;Details</label>
													...
													</div> <label class="headingLabel">Rating&nbsp;Details(**Rating&nbsp;between&nbsp;1(min)&nbsp;to&nbsp;10(max))</label>

													<div id="reviewalignBox row">


														<div class="col-sm-3">
															<label class="contact_search">Technical&nbsp;Skills
															</label>
														...
														<div class="col-sm-3">
															<label class="contact_search">Domain&nbsp;Skills
															</label>
														...
														..............................
														..........................................</font>
												</span> <span id="online"> <s:hidden id="contechId"
														name="contechId" /> <s:hidden id="consultantId"
														name="consultantId" value="%{consult_id}" /> <s:hidden
														id="requirementId" name="consultantId"
														value="%{requirementId}" /> <label class="headingLabel">Online&nbsp;Exam&nbsp;Details</label>

													<div class="skillQuestionBox">
														<label class="headingLabel " style="color: #56a5ec">Exam&nbsp;Performed&nbsp;On
															&nbsp;<span id="examsubmittedDate" />
														</label>
														<div class="row">
												...
												<div id="reviewalignBox" name="reviewComments">
													...
													<div class="inner-techReviewdiv-elements">
														<s:textarea id="consultantComments"
															...
															type="text" placeholder="Any comments" value=""
															disabled="true" />
													</div>
												</div>
												<span id="examButton">
													<div class="pull-left ">
														<s:submit type="button" id="rejectButton"
															cssClass="cssbutton fa fa-times" value="Rejected"
															onclick="saveExamResult(this.value,'reviewSearch');"
															style="margin-left: -27px;"></s:submit>
													</div>
													<div class="pull-right ">
														<s:submit type="button" id="shortlistButton"
															cssClass="cssbutton fa fa-check" value="ShortListed"
															onclick="saveExamResult(this.value,'reviewSearch');"></s:submit>
													</div>
												</span>
											</div>
										</div>
									...
									<label class="">Consultant Name:<font
										style="color: #FF8A14;"><s:a href='%{#myUrl}'
												id="techSearchConsName">
												<s:property value="%{consult_name}" />
											</s:a></font></label>
									<s:url var="ReqUrl"
										action="Requirements/requirementedit.action">
										<s:param name="requirementId">
									...
									<label class="pull-right ">Job Title:<font
										style="color: #FF8A14; pointer-events: hand;"><s:a
												href='%{#ReqUrl}' id="techSearchReqName">
									...
									<div class="inner-reqdiv-elements" id="techReviewForm">
										<div class="row">
											<div class="col-sm-4">
												...
												<div class="calImage">
													<s:textfield cssClass="form-control" tabindex="1"
														id="searchInterviewDate" placeholder="Interview Date"
														name="searchInterviewDate"
											...
											<div class="col-sm-4">
												<label class="labelStylereq" style="color: #56a5ec">Reviewer
												</label>
												<s:textfield cssClass="form-control" id="eNameTechReview"
													tabindex="2" name="eNameTechReview"
													onkeyup="return getEmpForTechReview();" autocomplete='off'
													maxLength="30" placeholder="Reviewer" />
											</div>
											<div class="col-sm-2 pull-right">
												<label class="labelStylereq" style="color: #56a5ec"></label>
												<s:submit id="techSearchButton"
													cssClass="add_searchButton form-control" tabindex="4"
													type="button" onclick="searchTechReviews();" value=""
													cssStyle="margin:5px 0px 0px">
													<i class="fa fa-search"></i>&nbsp;Search</s:submit>
											</div>
											<s:form action="../Requirements/forwardTechReview.action"
												id="#" theme="simple" enctype="multipart/form-data">
												<s:hidden name="requirementId" id="requirementId"
													value="%{requirementId}" />
												<s:hidden name="consult_id" id="consult_id"
													value="%{consult_id}" />
												...
												<s:url var="reviewUrl"
													action="Requirements/forwardTechReview.action">
													<s:param name="requirementId">
														<s:property value="%{requirementId}" />
													</s:param>
													<s:param name="consult_id">
														<s:property value="%{consult_id}" />
													</s:param>
													<s:param name="accountSearchID">
														<s:property value="%{accountSearchID}" />
													</s:param>
													...
													<s:param name="techReviewStatus">
														<s:property value="%{techReviewStatus}" />
													</s:param>
												</s:url>
												<s:if
													test="#session.primaryrole == 3 || #session.primaryrole == 13 || #session.primaryrole == 7">
													<s:if
														test="techReviewStatus=='Processing' || techReviewStatus=='ShortListed'">
														<div class="col-sm-2 pull-right">
															<label class="labelStylereq" style="color: #56a5ec"></label>
															<%--  <s:submit cssClass="cssbutton form-control" value="Add Review" cssStyle="margin:5px 0px 0px" />--%>
															<s:a href='%{#reviewUrl}' id="techSearchAddButton"
									...
									<s:form>
										...
										<div class="task_content" id="task_div" align="center"
											...
											<div>
												<div>
													<table id="techReviewSearchTable"
														...
														<tbody>
															...
															<s:if test="consultantList ==null">
																<tr>
																	<td colspan="6"><font
																		style="color: red; font-size: 15px;">No Records
																			to display</font></td>
																</tr>
															</s:if>
															<s:iterator value="consultantList">
																...
																<tr>
																	...
																	<s:hidden name="consult_id" id="consult_id"
																		value="%{consult_id}" />
																	<s:hidden name="reviewType" id="reviewType"
																		value="%{reviewType}" />
																	<s:hidden name="forwardedToId" id="forwardedToId"
																		value="%{forwardedToId}" />
																	<s:hidden name="conTechReviewId" id="conTechReviewId"
																		value="%{conTechReviewId}" />
																	<td><s:a href="#"
																			onclick="techReviewResultsToViewOnOverlay('%{reviewType}',%{conTechReviewId});techReviewResultsOverlay();"
																			cssClass="techReviewResults_popup_open">
																			<s:property value="reviewType"></s:property>
																		</s:a></td>
																	...
																	<td><s:a href="#"
																			onclick="getMailPhoneOfReviewedBy(%{forwardedToId});techReviewEmailPhoneOverlay();"
																			cssClass="emailPhoneShow_popup_open">
																			<s:property value="forwardedToName"></s:property>
																		</s:a></td>
																	...
																	<s:if test="comments.length()>20">
																		<td><s:a href="#"
																				onclick="techReviewCommentsOverlayJs(\'%{comments}\');"
																				cssClass="techReviewCommentsOverlay_popup_open">
																				<s:property value="%{comments.substring(0,20)}"></s:property>..</s:a></td>
																	</s:if>
																	<s:else>
																		<td><s:a href="#"
																				onclick="techReviewCommentsOverlayJs(\'%{comments}\');"
																				cssClass="techReviewCommentsOverlay_popup_open">
																				<s:property value="%{comments}"></s:property>
																			</s:a></td>
																	</s:else>
