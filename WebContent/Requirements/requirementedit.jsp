...
<body style="overflow-x: hidden" oncontextmenu="return false"
	onload="doOnloadEditRequirement();
		showHideEndDate();">
	<div id="wrap">
		<header id="header">
			<!--header-->
										...
										<div class="panel-body" id="panel-task-body">
											<s:if test="accountFlag=='Account'">
												<div class=""
													...
													<s:url var="myUrl" action="acc/viewAccount.action">
														...
														<s:a href='%{#myUrl}' id="reqDetailsAccountName"
														style="color: #0000FF;">
											...
											<div class=""
												...
												<s:if test="accountFlag=='csr'">
													<s:a href='%{#myUrl}' id="accountName" cssClass="breadcrum">
														<s:property value="%{accountName}" />
													</s:a>
												</s:if>
												<s:else>
													<s:a href='#' id="accountName" cssClass="breadcrum">
														<s:property value="%{accountName}" />
													</s:a>
												</s:else>
												<s:if test="accountFlag=='csr'">
													<s:a href='%{#reqUrl}' id="requirementList"
														cssClass="breadcrum">>>&nbsp;Requirements&nbsp;List</s:a>
												</s:if>
												<s:else>
													<s:if test="vendor!='yes'">
														<s:if test="#session.primaryrole == 13">
															<s:a href='%{#custDirectorReqUrl}' id="requirementList"
																cssClass="breadcrum">>>&nbsp;Requirements&nbsp;List</s:a>
														</s:if>
														<s:else>
															<s:a href='%{#custReqUrl}' id="requirementList"
																cssClass="breadcrum">>>&nbsp;Requirements&nbsp;List</s:a>
														</s:else>

													</s:if>
													<s:else>
														<s:a href='%{#venReqUrl}' id="requirementList"
															cssClass="breadcrum">>>&nbsp;Requirements&nbsp;List</s:a>
													</s:else>
											...
											<ul class="nav nav-tabs">
												...
												<li class="active_details" id="consultantListLi"><a
													...
													data-toggle="tab" onclick="return getConsultantList()">Submitted&nbsp;Profiles</a></li> 
												...
												<s:elseif test="accountFlag=='techReviews'">

													<s:url var="myUrl"
														action="recruitment/consultant/getTechReviewDetails.action">
											...
											<div class="tab-content" style="overflow:hidden">
												<div class="tab-pane fade in active row" id="details">
													<div class="" id="selectivityProfileBox"
																	...
																	<div class="required">
																		...
																		<div class="col-sm-3">
																			...
																			<s:textfield cssClass="form-control "
																				id="RequirementName" type="text"
																				value="%{requirementVTO.RequirementName}"
																				name="RequirementName" placeholder=""
																				onfocus="removeErrorMessages()" readonly="true"
																				maxLength="50" />
																		</div>
																		<div class="col-sm-3">
																			<label class="labelStyle" id="labelLevelStatusReq">
																				Type </label>
																				<a href="#" data-toggle="tooltip" data-placement="bottom" data-html="true" title="&nbsp;<b>1.</b> If Type is Contract then SOW is Processed<br><b>2.</b> If Full-time then consultant becomes Permanent Customer Employee ">
																			...
																			<s:select name="RequirementTaxTerm"
																				...
																				onchange="showHideEndDate();disableFields()" />
																		</div>
																		
																		<div class="col-sm-3">
																			<label class="labelStyle" id="labelLevelStatusReq">Desired Start Date</label>
																			<div class="calImage">
																				<s:textfield cssClass="form-control "
																					name="RequirementFrom" id="RequirementFrom"
																					placeholder="Start Date"
																					value="%{requirementVTO.RequirementFrom}"
																					onkeypress="return editRequirementDateValidation()"
																		...
																		<div class="col-sm-3" id="endDateDiv" style="display: none;">
															<label class="labelStyle" id="labelLevelStatusReq">Expected End Date
															</label>
															<div class="calImage">
																<s:textfield cssClass="form-control"
																	id="RequirementEnd" placeholder="End Date" name="RequirementEnd"
																	...
																	<i class="fa fa-calendar"></i>
																		...
																		<div id="duration" class="col-sm-3"
																			style="display: none;">
																			<label class="labelStylereq" style="color: #56a5ec;">
																				Duration </label>

																			<div class="form-group input-group"
																				style="margin: 0; display: list-item; list-style-type: none">
																				<s:textfield
																					...
																					onfocus="removeErrorMessages()" maxLength="10"
																		...
																		<div class="col-sm-3">
																			...
																			<s:textfield cssClass="form-control"
																				...
																				name="RequirementNoofResources"
																				placeholder="Positions"
																				onfocus="removeErrorMessages()" maxLength="11" />
																		</div>
																		...
																		<div class="col-sm-3">
																			...
																			<s:select name="RequirementLocation"
																				...
																				headerKey="DF" headerValue="Select Location"
																				cssClass="SelectBoxStyles form-control"
																				onfocus="removeErrorMessages()" />
																		</div>
																		<div class="col-sm-3" style="display: none;">
																			<label class="labelStyle" id="labelLevelStatusReq">
																				Approver </label>
																			<s:select name="RequirementContact1"
																				id="RequirementContact1"
																				value="%{requirementVTO.RequirementContact1}"
																				list="EmployeeNames" headerKey="-1"
																				headerValue="--select--"
																				cssClass="SelectBoxStyles form-control"
																				onfocus="removeErrorMessages()" />
																		</div>
																		...
																		<div class="col-sm-3" style="display: none;">
																			<label class="labelStyle" id="labelLevelStatusReq">
																				Requisitioner </label>
																			<s:select name="RequirementContact2"
																				id="RequirementContact2"
																		...
																		<div class="col-sm-3">
																			<label class="labelStyle" id="labelLevelStatusReq">
																				Status </label>
																			<s:select name="RequirementStatus"
																				id="RequirementStatus"
																				value="%{requirementVTO.RequirementStatus}"
																				list="#@java.util.LinkedHashMap@{'O':'Open','OR':'Open for Resume','I':'Inprogess','F':'Forecast','H':'Hold','W':'Withdrawn','S':'Won','L':'Lost','C':'Closed'}"
																				headerKey="DF"
																				cssClass="SelectBoxStyles form-control"
																				onfocus="removeErrorMessages()" />
																		...
																		<div class="col-sm-3">
																			...
																			<div class="form-group input-group">
																				...
																				<s:textfield cssClass="form-control "
																					...
																					name="RequirementTargetRate" placeholder="Min Rate"
																					onfocus="removeErrorMessages()"
																					onkeypress="return RequirementMinRate(event)"
																					maxLength="10" />
																				<span class="input-group-addon"
																					style="padding-top: 5px">/Hr</span>
																			</div>
																		</div>
																		<div class="col-sm-3">
																			<label class="labelStyle" id="labelLevelStatusReq">
																			...
																			<div class="form-group input-group">
																				...
																				<s:textfield cssClass="form-control "
																					...
																					name="RequirementTargetRate" placeholder="Max Rate"
																					onfocus="removeErrorMessages()"
																		...
																		<div id="reqCustCategory" class="col-sm-3">
																			...
																			<label class="labelStylereq " style="color: #56a5ec;">Req.Category</label>
																			<a href="#" data-toggle="tooltip" data-placement="top"  title="Based on Category selected Interview is Processed by same Category Recruiter">
															                  <img src="/sb/includes/images/icons/isymbol.png" width="15" height="15"/>
															                </a>
																			<s:select id="reqCategoryValue"
																				name="reqCategoryValue"
																		...
																		<s:hidden name="typeOfUser" id="typeOfUser"
																			value="%{#session.typeOfUsr}" />
																	</div>
																	...
																	<div class="form-group req-textarea required col-sm-12">
																		...
																		<s:textarea name="RequirementJobdesc"
																			...
																			placeholder="Enter Job Description Here" rows="3"
																			onkeyup=" JobCheckCharacters(this)"
																			onfocus="removeErrorMessages()" />
																	...
																	<div class="form-group req-textarea required col-sm-12">
																		...
																		<s:textarea name="RequirementResponse"
																			...
																			placeholder="Enter Responsibilities Here" rows="3"
																	...
																	<div class="form-group req-textarea col-sm-12 required">
																		...
																		<s:textarea name="requirementQualification"
																			...
																			rows="3"
																			onkeyup=" QualificationCheckCharacters(this)"
																			onfocus="removeErrorMessages()" />
																	...
																	<div>
																		<div class="col-sm-6 ">
																			<span class="required"> <label
																				class="labelStyle skills" id="labelLevelStatusReq">Skill&nbsp;Set
																			</label> <s:select cssClass="" name="skillCategoryValue"
																					id="skillCategoryValue"
																					list="skillSetValuesMap" multiple="true"
																					onfocus="clearErrosMsgForGrouping()"
																					value="%{requirementVTO.skillSetList}" /> <%--<s:hidden id= "editSkill" value="%{requirementVTO.skillSetList}"/>--%>
																			</span>
																		</div>
																		<div class="col-sm-6 ">
																			<label class="labelStyle" id="labelLevelStatusReq">Preferred&nbsp;Skill&nbsp;Set
																			</label>
																	...
																	<div class="form-group req-textarea col-sm-12">
																		...
																		<s:textarea name="RequirementComments"
																			...
																			placeholder="Enter Comments Here" rows="3"
														...
														<s:if test="accountFlag !='csr'">
															<s:if test="vendor!='yes'">
																<s:if
																	test="#session.primaryrole==3 || #session.primaryrole==13">
																	<div class="col-sm-12">
												...
												<div class="tab-pane fade in row" id="vendorAssociation">
													...
													<div class="" id="profileBox"
														...
														<div class="row">
															<%--	<div class="backgroundcolor"
																...
																<div class="panel-heading">
																	<h4 class="panel-title">
																		<i id="updownArrowVen" style="color: #56a5ec"
																			onclick="toggleContentRequirement('vendorSearchForm')"
															...
															<div class="col-sm-12" id="vendorSearchForm">
																<div class="col-sm-3">
																	...
																	<s:select name="tireType" id="tireTypeSearch" value=""
																		tabindex="1" list="%{typesTiers}" headerKey="-1"
																		headerValue="All"
																		cssClass="SelectBoxStyles form-control"
																...
																<div class="col-sm-3">
																	...
																	<s:select name="status" id="status" value=""
																		tabindex="2"
																		list="#@java.util.LinkedHashMap@{'Active':'Active','Inactive':'Inactive','DF':'All'}"
																		cssClass="SelectBoxStyles form-control" />
																</div>
																	...
																	<div class="">
																		<div class=" pull-right contact_search">
																			...
																			<button
																				...
																				id="vendorAssociationAddButton" tabindex="4"
																		...
																		<div class="pull-right">
																			...
																			<input type="button"
																				...
																				tabindex="3" id="vendorAssociationSearchButton"
																				value="Search"
																		...
																		<table>
																			<tr>
																				...
																				<span class="pull-right">
																					<h5>
																						<a href="" id="vendorAddAssociationOverlayClose"
																	...
																	<div class="col-sm-12">
																		<div class="">
																			<div class="col-sm-6 required">
																				...
																				<s:select name="tireType" id="tireType" value=""
																					...
																					headerValue="Select Type of Tier"
																					cssClass="SelectBoxStyles form-control"
																					onchange="return getVendorsNames()"
																		...
																		<div class="col-sm-12 required">
																			...
																			<label class="labelStyle" id="labelLevelStatusReq">
																				Vendor&nbsp;Names </label>
																			<s:select
																				cssClass="selectBoxStyle form-control bx_style"
																		...
																		<div class="col-sm-12 companyinfo">
																			<div class="col-sm-4 pull-right">
																				<s:submit cssStyle="margin:5px 0px;"
																					id="vendorAssociationSaveButton"
																					cssClass=" add_searchButton form-control col-sm-offset-10 cssbutton"
																					value="" type="button"
															...
															<div id="vendorAssoEdit_popup">
																...
																<div id="vendorAssocitaionEditOverlay">
																	<div class="backgroundcolor">
																		<table>
																			<tr>
																				...
																				<span class="pull-right">
																					<h5>
																						<a href="" class="vendorAssoEdit_popup_close"
																							id="vendorEditAssociationOverlayClose"
																	...
																	<label class="" style="margin-left: 15px;">Name
																		:</label>&nbsp;
																	<vendorNameDisplay></vendorNameDisplay>
																	<br>
																	...
																	<div class="">
																		<div class="col-sm-5 pull-right">
																			<s:submit cssStyle="margin:5px 0px;"
																				id="vendorAssociationUpdateButton"
														...
														<div class="">
															<br />
															<div class="emp_Content col-sm-12" id="emp_div" align="">
																<table id="vendorAssociationResults"
																	...
																	<tbody>
																		<tr>
																			...
																			<th class="unsortable">Rating&nbsp;and&nbsp;Reviews</th>
																		...
																		<div class="pull-right">
																			<s:if test="consultantFlag == 1">
																				...
																				<a
																					...
																					id="reqAddConsultant"><input type="button"
																					class=" cssbutton form-control"
