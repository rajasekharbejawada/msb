                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        ...
                                                        <s:select id="skillCategoryValue" cssClass="form-control SelectBoxStyles" name="skillCategoryValue"  list="skillValuesMap" value="%{editQues.skillCategoryValue1}" headerValue="Select" headerKey="-1" tabindex="2" />
                                                    </div>
                                                    ...
                                                    <div class="col-sm-3">
                                                        ...
                                                        <s:select id="status" cssClass="form-control SelectBoxStyles" name="status"  list="#@java.util.LinkedHashMap@{'Active':'Active','Inactive':'Inactive'}" value="%{editQues.status}" tabindex="4" />
                                                    </div>
                                                </div>
                                            </div>
