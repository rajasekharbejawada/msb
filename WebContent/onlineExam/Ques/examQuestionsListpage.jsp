                                                    ...
                                                    <div class="inner-reqdiv-elements">
                                                        <div class="row">
                                                                ...
                                                                <div class="col-sm-4">
                                                                    ...
                                                                    <s:select id="status" cssClass="form-control SelectBoxStyles" name="status" headerKey="DF" headerValue="All" list="#@java.util.LinkedHashMap@{'Active':'Active','Inactive':'Inactive'}" tabindex="4" />
                                                                </div>
