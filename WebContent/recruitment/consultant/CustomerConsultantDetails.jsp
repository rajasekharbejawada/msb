...
<html>
    <head>
        ...
        <script type="text/javascript" src="<s:url value="/includes/js/Ajax/ConsultantAjax.js?version=1.0"/>"></script>
        ...
        <body style="overflow-x: hidden" oncontextmenu="return false" onload="conDetailsCustomer();consultdoOnLoad();">
        <div id="wrap">
                                ...
                                <div class="features_items">
                                    <div class="col-lg-12 ">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="col-sm-2 pull-right"><span id="resultMessage"></span></div>
                                                ...
                                                <div class="col-sm-12" style="background-color: white; padding-top: 4px;">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <s:if test="consultantVTO.address_flag!='emp'" >  
                                                            <div class="col-sm-6 col-md-6 col-lg-4">
                                                                ...
                                                                <s:select id ="consultantlCountry" cssClass="ConsultBoxStyles" headerKey="0" headerValue="--Select--" value="%{consultantVTO.consult_lcountry}" list="country" cssStyle="display: none" ></s:select>
                                                                </div>
                                                        ...
                                                        <s:if test="consultantVTO.address_flag=='emp'" >  
                                                            ...
                                                            <s:if test="consultantVTO.consult_Country!=''" >
                                                                <div class="col-sm-4">
                                                                    ...
                                                                    <s:select id="consultantCountry1" cssClass="ConsultBoxStyles" value="%{consultantVTO.consult_Country}" list="country" cssStyle="display: none"></s:select>
                                                                    </div>
                                                            ...
                                                            <div class="col-sm-6" >
                                                                ...
                                                                <div id="contactInfoDiv"> 
                                                                    ...
                                                                    <s:hidden label="Same as Permanent Address" name="consult_checkAddress"  id="consult_checkAddress" value="%{consultantVTO.address_flag}" onclick="sameAsAddress();"   ></s:hidden>
                                                                        ...
                                                                        <div class="consultantCustomer">
                                                                            <div class="consultantAddress" > <label class="labelStyle" id="labelLevelStatusReq" >Country</label></div><font class="consul_Customerlabel" >:</font><font class="ven_ReqEdit" id="cosultantCountryCustomer"></font>
                                                                            <s:select id="consultantCountry2" cssClass="ConsultBoxStyles" value="%{consultantVTO.consult_Country}" list="country" cssStyle="display: none"></s:select>
                                                                            </div>
                                                    ...
                                                    <s:if test="%{consultFlag!='vendor'}">
                                                        ...
                                                        <s:hidden  value="%{consultantVTO.consult_status}" name="consult_status" id="consult_status" headerKey="-1"  list="#@java.util.LinkedHashMap@{'Active':'Active','Inactive':'Inactive'}" />
 ...
 <s:hidden name="sessionPRole" id="sessionPRole" value="%{#session.primaryrole}"/>
                                                    <s:hidden name="consultantAppstatus" id="consultantAppstatus" value="%{consultantAppStatus}"/>
                                                    ...
                                                    <%if(request.getAttribute("consultantAppStatus").toString().equals("Processing") && session.getAttribute("primaryrole").toString().equals("1")){ %>
                                                   
                                                    <div class="col-sm-3">
																	<label class="labelStylereq" style="color: #56a5ec;">
																		CSR Status </label>
																	<s:select name="csrstatus" id="csrstatus" value="%{csrAppStatus}"
																		tabindex="2"
...
<div class="form-group col-sm-9">
												...
												<s:textarea name="csrComments" id="csrComments"
													cssClass="form-control" value="%{csrAppComments}"
