...
<body style="overflow-x: hidden" oncontextmenu="return false"
	onload="consultantPage();StateChange();jumper();">
	<div id="wrap">
		<header id="header">
			<!--header-->
								...
								<div class="col-sm-14 ">
									<div class="" id="selectivityProfileBox"
										...
										<div class="backgroundcolor">
											<div class="panel-heading">
												<h4 class="panel-title">
													...
													<font color="#ffffff">Consultant Search</font> <i
														id="updownArrow" onclick="toggleContent('getConsultant')"
														class="fa fa-minus"></i>
											...
											<div class="row">
												<s:form action="getConsultant" theme="simple">
													...
													<s:hidden name="gridDownload" id="gridDownload"
														value="%{gridPDFDownload}" />
													<div class="inner-reqdiv-elements">

														<div class="col-sm-4">
															<label class="labelStylereq" style="color: #56a5ec">Name</label>
															<s:textfield cssClass="form-control" name="consult_name"
																id="consult_name" placeholder="Name"
																value="%{consult_name}" tabindex="1" maxLength="60" />
														</div>
														<div class="col-sm-4">
															<label class="labelStylereq" style="color: #56a5ec">Email
																Id</label>
															<s:textfield cssClass="form-control" name="consult_email"
																id="consult_email" placeholder="Email Id"
																value="%{consult_email}" tabindex="2" maxLength="60" />
														</div>
														<div class="col-sm-4">
															<label class="labelStylereq" style="color: #56a5ec">Status</label>
															<s:select cssClass="SelectBoxStyles form-control"
																name="consult_status" id="consult_status" headerKey="-1"
																headerValue="Select Status" list="{'Active','Inactive'}"
																tabindex="3" />
														</div>


														<s:hidden name="consultState" id="consultState"
															value="%{consult_State}" />
														<div class="col-sm-4">
															<label class="labelStylereq" style="color: #56a5ec">Country</label>
															<s:select cssClass="form-control SelectBoxStyles"
																name="consult_Country" id="consult_Country"
																headerKey="-1" headerValue="All" list="consult_WCountry"
																onchange="StateChange()" tabindex="4" />
														</div>
														<div class="col-sm-4">
															<label class="labelStylereq" style="color: #56a5ec">State</label>
															<s:select cssClass="form-control SelectBoxStyles"
																name="consult_State" id="consult_State" headerKey="-1"
																headerValue="Select State" list="{}" tabindex="5"
																value="%{consult_State}" />
														</div>
														<div class="col-sm-4">
															<label class="labelStylereq" style="color: #56a5ec">City</label>
															<s:textfield cssClass="form-control" name="consult_City"
																id="consult_City" placeholder="Enter City" tabindex="6" />
														</div>


														<div class="col-sm-4">
															<label class="labelStylereq" style="color: #56a5ec">Phone</label>
															<s:textfield cssClass="form-control" name="consult_phno"
																id="consult_phno" placeholder="Phone"
																value="%{consult_phno}" tabindex="7" maxLength="15" />
														</div>
														...
														<s:if
															test="consultantFlag == 'Team' || consultantFlag == 'All'">
															<div class="col-sm-4">
																<label class="labelStylereq"
																	style="color: #56a5ec; margin-right: 10px;">Members</label>
																<s:textfield cssClass="form-control"
																	id="enameForRecruitment" name="enameForRecruitment"
																	onkeyup="return getEmpRecruitment();"
																	autocomplete='off' maxLength="30" tabindex="8"
																	placeholder="Name"
																	onfocus="return removeErrorMsgForTechie();" />
																<s:hidden cssClass="form-control"
																	id="enameIdForRecruitment" name="enameIdForRecruitment"
														...
														<div class="col-sm-4">
															<label class="labelStyle" id="labelLevelStatusReq">Specialization
															</label>
															<s:select cssClass="" name="skillCategoryValue"
																tabindex="9" id="skillCategoryValue"
														...
														<div class="col-sm-2 pull-right">
															...
															<s:submit type="button" cssStyle="margin:5px 0px;"
																cssClass="add_searchButton form-control" tabindex="10"
																id="searchButton" value="" onclick="submmition();">
										...
										<div id="responseMessage"
											style="color: green; margin-left: 2%"></div>
										<div class="col-sm-12">
											...
											<s:form>
												<div class="task_content" id="task_div" align="center"
													...
													<div>
														<div>
															...
															<table id="task_results" class="responsive CSSTable_task"
																...
																<tbody>
																	...
																	<s:iterator value="ConsultantListDetails">
																		...
																		<s:url var="myUrl"
																			action="editConsultantDetails.action?consultFlag=vendor">
																		...
																		<tr>
																			...
																			<td><s:a href='%{#myUrl}'>
																					<s:property value="%{consult_name}"></s:property>
																				</s:a></td>
																			...
																			<s:if test="%{consult_skill.length()>8}">
																				<td><s:a href="#"
																						cssClass="consultantSkillOverlay_popup_open"
																						onclick="consultantSkillSetOverlay('%{consult_skill}')">
																						<s:property value="consult_skill.substring(0,8)"></s:property>
																					</s:a></td>
																			</s:if>
																			<s:else>
																				<td><s:a href="#"
																						cssClass="consultantSkillOverlay_popup_open"
																						onclick="consultantSkillSetOverlay('%{consult_skill}')">
																						<s:property value="consult_skill"></s:property>
																					</s:a></td>
																			</s:else>
															...
															<s:if test="ConsultantListDetails.size > 0">
																<label> Display <select id="cpaginationOption"
																	class="disPlayRecordsCss" onchange="cpagerOption()"
																	style="width: auto">
																		<option>10</option>
																		<option>15</option>
																		<option>25</option>
																		<option>50</option>
																</select> Consultants per page
																</label>
															</s:if>
												...
												<div id="downloading_grid">
													<div class="col-lg-2 pull-right">
														<div onclick="downloadPDFConsultantList()" tabindex="11"
								...
								<div id="consultantSkillOverlay_popup">
									<div id="consultantSkillSetBox" class="marginTasks">
											...
											<table>
												<tr>
													...
													<span class="pull-right">
														<h5>
															&nbsp;&nbsp;&nbsp;&nbsp;<a href=""
																class="consultantSkillOverlay_popup_close"
																onclick="consultantSkillOverlayClose()"><i
										...
										<div>
											...
											<s:textarea name="skillSetDetails"
												id="consultantSkillSetDetails" disabled="true"
	...
	<div
		style="display: none; position: absolute; top: 270px; left: 700px; overflow: auto; z-index: 1900000"
		id="menu-popup">
