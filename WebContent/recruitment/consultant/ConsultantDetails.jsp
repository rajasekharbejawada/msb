...
<body oncontextmenu="return false" style="overflow-x: hidden"
	onload=" doOtherSkill();doOtherSecondrySkill();loadConsultRelocation();loadConsultantAvaliable();consultdoOnLoad();defaultClick();">
	<div id="wrap">
		<header id="header">
			<!--header-->
			...
			<section id="generalForm">
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-sm-12 col-md-9 col-lg-9 right_content"
							...
							<s:if test="consultFlag=='vendor'">
								<s:url var="myUrl" action="getMyConsultantSearch.action">
									<s:param name="consultantFlag">
										<s:property value="%{consultantFlag}" />
									</s:param>

								</s:url>
								<span class="pull-right" style="padding: 18px"><s:a
										href='%{#myUrl}' id="vendorBackButton">
							...
							<s:if test="consultFlag=='customer'">
								...
								<s:if test="vendor=='yes'">
									<s:url var="myUrl"
										...
										<s:param name="requirementId">
											<s:property value="%{requirementId}" />
										</s:param>
										<s:param name="accountSearchID">
											<s:property value="%{accountSearchID}" />
										</s:param>
										<s:param name="accountFlag">
											<s:property value="%{accountFlag}" />
										</s:param>
										<s:param name="customerFlag">
											<s:property value="%{customerFlag}" />
										</s:param>
										<s:param name="jdId">
								...
								<span class="pull-right" style="padding: 19px"><s:a
										href='%{#myUrl}' id="customerBackButton">
										<img src="<s:url value="/includes/images/backButton.png"/>"
											height="25" width="25">
									</s:a></span>
							</s:if>
							<s:if test="consultFlag =='consultant'">
								...
								<span class="pull-right" style="padding: 19px"><s:a
										href='%{#myUrl}' id="consultantBackButton">
										<img src="<s:url value="/includes/images/backButton.png"/>"
											height="25" width="25">
									</s:a></span>
							</s:if>
							...
							<ul class="nav nav-tabs">
								<li class="" id="consultantLi"><a aria-expanded="false"
									onclick="cheadingMessage(this);" id="c_details"
									href="#Consultant" data-toggle="tab"> Consultant Details </a></li>
								<li id="attachLi" class=""><a aria-expanded="false"
									onclick="showAttachmentDetails('<%=request.getParameter("consult_id")%>');
						...
						<%-- <ul class="active_details">
								<li class="dropdown" style="margin: 12px"><a
									...
									style="background-color: #fff; width: 40px; cursor: pointer;"><img
										...
										class="accDetails">Consultant Details</headingmess>
									...
									<ul class="active_details dropdown-menu  "
										...
										<li class="  " id="consultantLi"><a aria-expanded="false"
											...
											style="background-color: #fff; width: 40px; cursor: pointer;"><img
												...
												height="15" width="15"><font style="color: blue">&nbsp;Consultant
													Details </font></a></li>

										<li class="  " id="attachLi"><a aria-expanded="false"
											href="#consult_attach" data-toggle="tab" id="c_attach"
											onclick="cheadingMessage(this);showAttachmentDetails('<%=request.getParameter("consult_id")%>');"
											unlockScreen();"
							...
							<div class="tab-content">
								...
								<div class="tab-pane fade in active" id="Consultant">
									...
									<div class="panel-body">
										...
										<s:if test="%{updateMessage =='success'}">
											<span id="fadeout_message"><successMessage>
												<font style="color: green"> Consultant record Updated
													successfully!</font></successMessage></span>
										</s:if>
										<s:if test="%{updateMessage=='failure'}">
											<font style="color: green"> Sorry, Consultant record
												not update!</font>
										</s:if>
										<span><consult_error id="consultDetailsErrMsg"></consult_error></span>
										<form action="updateConsultantDetails" id="consultantForm"
											theme="simple">
											...
											<s:hidden id="requirementId" name="requirementId"
												value="%{requirementId}" />
											<s:hidden id="accountSearchID" name="accountSearchID"
												value="%{accountSearchID}" />
											<s:hidden id="accountFlag" name="accountFlag"
												value="%{accountFlag}" />
											<s:hidden id="customerFlag" name="customerFlag"
												value="%{customerFlag}" />
											<s:hidden id="jdId" name="jdId" value="%{jdId}" />
											<s:hidden id="vendor" name="vendor" value="%{vendor}" />
											<s:hidden id="consultantFlag" name="consultantFlag"
											...
											<s:hidden name="relocation_value" value= "%{consultantVTO.consult_relocation}"/>
											...
											<div class="col-sm-4">
												...
												<s:select cssClass="form-control SelectBoxStyles "
													...
													onchange="loadConsultantAvaliable();" tabindex="2" />
											</div>
											...
											<div class="col-sm-4 required">
												...
												<s:textfield cssClass="form-control" name="consult_fstname"
													...
													id="consult_fstname" placeholder="First Name" tabindex="4"
													onkeyup="consultvalid_fname()" maxlength="30" />
											</div>
											<div class="col-sm-4">
												<span class="required"> <label class="labelStylereq">Last
														Name</label> <s:textfield cssClass="form-control"
														name="consult_lstname"
														value="%{consultantVTO.consult_lstname}"
														id="consult_lstname" onkeyup="consultvalid_lstname()"
														placeholder="Last Name" tabindex="5" maxlength="30" />
												</span>
											</div>
											<div class="col-sm-4">
												...
												<s:textfield cssClass="form-control" name="consult_midname"
													...
													placeholder="Middle Name" id="consult_midname" tabindex="6"
													maxlength="30" />
											</div>
											<div class="col-sm-4 required">
											...
											<div class="col-sm-4">
												<span class="required"> <label class="labelStylereq">Mobile
														No</label> <s:textfield cssClass="form-control"
														name="consult_mobileNo"
											...
											<%--  <div class="col-sm-4">
												...
												<s:select cssClass="form-control SelectBoxStyles"
													...
													headerValue="Select ID Proof" name="	"
											...
											<div class="col-sm-4" id="visaSelectDiv"
												style="display: none">
											...
											<div class="col-sm-4" id="proofdownloadDiv"
												style="display: none">
											...
											<div class="col-sm-4" id="proofuploadDiv"
												style="display: none">
												<label class="labelStylereq"></label>
												<s:label>
													<figcaption>
											...
											<div class="col-sm-6" style="">
												...
												<div id="AddressBox">
													...
													<div class="col-lg-10 col-md-offset-1">
														<span class="required"><label class="labelStylereq">Address Line 1</label></span>
														...
														<span class="required"> <label
															class="labelStylereq">City</label> <s:textfield
																...
																placeholder="City" value="%{consultantVTO.consult_City}"
																name="consult_City"
																oninvalid="setCustomValidity('Must be valid fn')"
																pattern="[a-zA-Z]{3,}"
																onchange="try{setCustomValidity('')}catch(e){}"
																onkeyup="pcityValidation()"
																onclick="removedCheckedAddress();" maxlength="20"
																tabindex="18" /> <%-- <s:select cssClass="form-control SelectBoxStyles" name="consult_CCountry" id="consult_CCountry" label="Country" headerKey="" headerValue="Select Country" list="consult_CCountry" onchange="ConsultantStateChange()" tabindex="1"/>
															...
															<label class="labelStylereq">Country</label> <s:select
																...
																onclick="removedCheckedAddress();" tabindex="19" /> <label
															class="labelStylereq">State</label> <s:select
																...
																onchange="StateChangeValidation()" tabindex="20" /> <%-- onchange="alert(this.options[this.selectedIndex].innerHTML)" --%>
														</span>
														...
														<span class="required"><label class="labelStylereq">Zip</label></span>
											...
											<div class="col-sm-6">
												...
												<div id="AddressBox">
													<div class="contactInfoDiv" id="trStyleContact">
														...
														value="%{consultantVTO.address_flag}" onclick="sameAsAddress();"></s:checkbox><span></span>
														</div>
													<div class="col-lg-10 col-md-offset-1">
														
														<label class="labelStylereq">Address Line 1</label>
														<s:textfield cssClass="form-control"
															...
															oninvalid="setCustomValidity('Must be valid fn')"
															onchange="try{setCustomValidity('')}catch(e){}"
															onkeyup="pCAddressValidation()" maxlength="100"
															tabindex="23" />
														<label class="labelStylereq">Address Line 2</label>
														<s:textfield cssClass="form-control"
														...
														<span class="required"> <label
															class="labelStylereq">City</label> <s:textfield
																...
																pattern="[a-zA-Z]{3,}"
																onchange="try{setCustomValidity('')}catch(e){}"
																onkeyup="pCCityValidation()" maxlength="20"
																tabindex="25" /> <%-- <s:select cssClass="form-control SelectBoxStyles" name="consult_CCountry" id="consult_CCountry" label="Country" headerKey="" headerValue="Select Country" list="consult_CCountry" onchange="ConsultantStateChange()" tabindex="1"/>
                                                                <s:select cssClass="form-control SelectBoxStyles" label="State" id="consult_CState" name="consult_CState"    headerKey="" headerValue="Select State" list="{'Relocation','Travel'}" /> --%>
															<label class="labelStylereq">Country</label> <s:select
																cssClass="form-control SelectBoxStyles"
																value="%{consultantVTO.consult_CCountry}" list="country"
																id="consult_CCountry" name="consult_CCountry"
																onchange="ConsultantCurrentStateChange()"
																onkeyup="pCCountryValidation()" tabindex="26" /> <label
															class="labelStylereq">State</label> <s:select
																cssClass="form-control SelectBoxStyles"
														...
														<s:textfield cssClass="form-control"
															...
															oninvalid="setCustomValidity('Must be valid fn')"
															onchange="try{setCustomValidity('')}catch(e){}"
															onkeyup="pCZipValidation()" tabindex="28" />
											...
											<s:if test="%{consultFlag=='vendor'}">
												<div class="col-sm-12">
													<div class="form-group">
														...
														<s:textarea cssClass="form-control"
															...
															id="consult_education" placeholder="Education"
												...
												<div class="row">
													<div class="col-sm-4 ">
														<span class="required"> <label
															class="labelStylereq">Job Title</label> <s:textfield
																cssClass="form-control" name="consult_jobTitle"
																value="%{consultantVTO.consult_jobTitle}"
																id="consult_jobTitle" placeholder="Job Title"
																tabindex="30" maxlength="30"
																onkeyup="jobtitleValidate()" /></span>
															</div>
															<div class="col-sm-4">
														<span class="required"> <label
															class="labelStylereq">Experience</label> <s:select
																cssClass="form-control SelectBoxStyles"
																...
																list="experience" onchange="expValidate()" tabindex="31" />
														</span>
														</div>
														<div class="col-sm-4">
														<span class="required"> <label
															class="labelStylereq">Working Country</label> <s:select
																cssClass="form-control SelectBoxStyles"
																value="%{consultantVTO.consult_wcountry}"
																name="consult_wcountry" id="consult_wcountry"
																headerKey="" headerValue="Select Country" list="country"
																tabindex="32" onchange="ConsultantCurrentWorkingStateChange(this,consultwState);workingCountryValidate()" />
														</span>
														</div>
														</div>
														<div class="row">
												...
												<s:textfield cssClass="form-control"
													value="%{consultantVTO.consultwCity}"
													name="consultwCity" id="consultwCity"
													placeholder="City" tabindex="34" maxlength="10" />
														</div>
														<div class="col-sm-4">
														...
														<s:textfield cssClass="form-control"
															...
															placeholder="Rate/Salary" tabindex="35" maxlength="10" />
														...
														<%-- <div class="col-sm-4">
																<label
															class="labelStylereq">Industry</label> <s:select
																cssClass="form-control SelectBoxStyles "
																value="%{consultantVTO.consult_industry}"
																name="consult_industry" id="consult_industry"
																headerKey="" headerValue="Select Industry"
																list="industry" onchange="industryValidate()"
																tabindex="37" />
																</div> --%>
																<div class="col-sm-4">
																<label class="labelStylereq">Referred By</label>
														<s:textfield cssClass="form-control"
															value="%{consultantVTO.consult_referredBy}"
															name="consult_referredBy" id="consult_referredBy"
															placeholder="Referred by" tabindex="36" maxlength="30" />
														...
														<span class="required"><label class="labelStylereq pref_country">Preferred Country</label>
														<s:select cssClass="form-control SelectBoxStyles" value="%{consultantVTO.consult_preferredCountry}" name="consult_preferredCountry" id="consult_preferredCountry" headerKey="-1" headerValue="Select Country" list="country" onchange="GetPStatesOfConsultantByPCountry('consult_preferredCountry','consult_preferredRegion','consult_preferredState','consult_error')" tabindex="38" />
														</span>
														</div>
													...
													<span class="required">
														...
														<span class="required"><label class="labelStylereq pref_state">Preferred State</label>
														<s:select cssClass=""
															value="%{consultantVTO.consult_preferredState}"
															name="consult_preferredState" multiple="true"
															id="consult_preferredState" headerKey="-1"
															list="preState"
															tabindex="40" /></span>
														...
														<s:select cssClass="form-control SelectBoxStyles"
															value="%{consultantVTO.consult_status}"
															name="consult_status" id="consult_status" headerKey=""
											...
											<s:if test="%{consultFlag!='vendor'}">
												...
												<s:hidden value="%{consultantVTO.consult_description}"
													id="consult_description" name="consult_description" />
												<s:hidden name="consult_jobTitle"
													value="%{consultantVTO.consult_jobTitle}"
													id="consult_jobTitle" />
												<s:hidden value="%{consultantVTO.consult_industry}"
													name="consult_industry" id="consult_industry"
													headerKey="-1" list="industry" />
												<s:hidden value="%{consultantVTO.consult_organization}"
													name="consult_organization" id="consult_organization"
													headerKey="-1" list="organization" />
												<s:hidden value="%{consultantVTO.consult_salary}"
													name="consult_salary" id="consult_salary" />
												<s:hidden value="%{consultantVTO.consult_experience}"
													name="consult_experience" id="consult_experience"
													headerKey="-1" list="experience" />
												<s:hidden value="%{consultantVTO.consult_workPhone}"
													name="consult_workPhone" id="consult_workPhone" />
												<s:hidden value="%{consultantVTO.consult_referredBy}"
													name="consult_referredBy" id="consult_referredBy" />
												<s:hidden value="%{consultantVTO.consult_status}"
													name="consult_status" id="consult_status" headerKey="-1"
													list="#@java.util.LinkedHashMap@{'Active':'Active','Inactive':'Inactive'}" />
												<s:hidden value="%{consultantVTO.consult_wcountry}"
													name="consult_wcountry" id="consult_wcountry"
													headerKey="-1" list="country" />
												<s:hidden value="%{consultantVTO.consult_preferredCountry}"
													name="consult_preferredCountry"
													id="consult_preferredCountry" headerKey="-1" list="country"
													onchange="ConsultantEditPreferredStateChange()" />
												<s:hidden value="%{consultantVTO.consult_preferredState}"
													name="consult_preferredState" id="consult_preferredState"
													headerKey="-1" list="preState" />
												<s:hidden value="%{consultantVTO.consult_preferredRegion}"
													name="consult_preferredRegion" id="consult_preferredRegion"
													headerKey="-1" list="regionName" />
											...
											<%-- <div class="col-sm-4 required">
												<label class="labelStylereq" style="margin: -0px;">Primary
													Skill</label>
												<s:select cssClass="form-control SelectBoxStyles"
													name="primarySkillValue" tabindex="30"
													id="primarySkillValue" list="reqCategory"
													value="%{consultantVTO.consultPrimarySkill}"
													onchange="AddConsultantSkillChange();" />
											</div>
											<div class="col-sm-6">

												<label class="labelStylereq skills"
												...
												<s:select cssClass="commentsStyle"
													...
													value="%{consultantVTO.skillSetList}" tabindex="42" />
												<s:hidden id="skillValues" name="skillValues" />
											</div> --%>
											
											<div class="col-sm-8 required">
										<label class="labelStylereq">Primary Skills</label>
										<s:select cssClass=""
											name="primarySkillValue" tabindex="42" id="primarySkillValue"
                                    ...
                                    <div class="col-sm-4" id="other" style="display:none">
										<span class="required"> <label class="labelStylereq">Other Primary Skills
												...
												id="consult_otherSkills" placeholder="Other Primary Skills" tabindex="43"
									...
									<div class="col-sm-8 required">
										...
										<s:select cssClass="commentsStyle"
											...
											list="skillValuesMap" multiple="true"
											onfocus="clearErrosMsgForGrouping()"
											value="%{consultantVTO.skillSetList}" tabindex="44" />
										<s:hidden id="skillValues" name="skillValues" />
									</div>
							     <%-- <s:hidden id="primaryHidden" name="primaryHidden" value="%{reqCategory}" /> 	
                                    <div class="col-sm-4" id="other" style="display:none">
										<span class="required"> <label class="labelStylereq">Other Primary Skills
												...
												name="consult_otherSkills"
												value="%{consultantVTO.consult_otherSkills}"
												id="consult_otherSkills" placeholder="Other Primary Skills" tabindex="44"
												onblur="return doSkillValidate()" />
									...
									<div class="col-sm-4" id="secondary" style="display:none">
										<span class="required"> <label class="labelStylereq">Other Secondary Skills
												...
												id="consult_otherSecSkills" placeholder="Other Secondary Skills" tabindex="45"
										...
										<span id="secErrMsg"></span>
											...
											<div class=" col-sm-12">
												<div class="form-group">
													...
													<s:textarea cssClass="form-control"
														value="%{consultantVTO.consult_comments}"
														id="consult_comments" placeholder="Comments"
														name="consult_comments" maxlength="500" tabindex="46"
														onkeydown="CommentsCheckCharacters('#consult_comments')" />
												...
												<div class="col-lg-12 ">
													...
													<div class="col-sm-4 pull-right ">
														<s:submit type="button" cssStyle="margin:12px;"
															...
															onclick="return ConsultDetails_valid()" value=""
															tabindex="47">
								...
								<div class="tab-pane fade" id="consult_Skillslide">
									<table id="consultskill_add">
										<div id="add_consultskill">
											<a href=""
												class="consultskilladd_popup_open btn add-recordBtn pull-right"
												onclick="removeDataAfterCloseOverlay()"
												style="margin-right: 0%">ADD NEW SKILL</a>
										</div>
									</table>

									<table id="consult_skilpagenav"
										class="CSSTable_task  responsive" border="5" cell-spacing="1"
									...
									<div id="consult_pageNavPosition" align="right"
										style="margin-right: 0vw"></div>
								</div>
								<%-- skill tab ends --%>
								<%-- security tab starts --%>
								<div class="tab-pane fade textfieldLabel"
									id="consult_security-info">
									<div class="container">
										<div class="col-sm-4" style="float: left">
											<span class="successInforesult"><securityinfo
													id="successInfo"></securityinfo></span>
											<div id="profileBox1">
												<center>
													<table>
														<s:textfield cssClass="form-control" id="consult_pan"
															label="SSN/PAN" maxLength="10"
															placeholder="ABCde1234F/123-12-1234"
															onkeyup="consult_panValidation()" />
														<s:textfield cssClass="form-control" id="consult_panname"
															label="Name on PAN" maxLength="40" placeholder="Ex.John"
															onkeyup="consult_nameValidation()" />
														<s:textfield cssClass="form-control" id="consult_bank"
															label="Bank Name" maxLength="20" placeholder="Ex.SBI/kvb"
															onkeyup="consult_banknameValidation()" />
														<s:textfield cssClass="form-control" id="consult_banknum"
															label="Bank A/C No." required="true" maxLength="20"
															placeholder="Ex.A1234d567891234567"
															onkeyup="consult_banAccknumValidation()" />
														<s:textfield cssClass="form-control" id="consult_hname"
															label="A/C H.Name" required="true" maxLength="25"
															placeholder="Ex.John"
															onkeyup="consult_holdnameValidation()" />
													</table>
												</center>
											</div>
										</div>
										<div class="col-sm-4" style="float: left">
											<div id="profileBox1">
												<center>
													<table>
														<s:textfield cssClass="form-control" id="consult_ifsc"
															label="IFSC Code" required="true" maxLength="11"
															placeholder="Ex.ABcd0123456"
															onkeyup="consult_ifscValidation()" />
														<s:textfield cssClass="form-control" id="consult_pf"
															label="PF No." required="true" maxLength="16"
															placeholder="Ex.Ab-12345-1234567"
															onkeyup="consult_pfValidation()" />
														<s:textfield cssClass="form-control" id="consult_uan"
															label="UAN No." required="true" maxLength="25"
															placeholder="Ex.123456" onkeyup="consult_uanValidation()" />
														<s:textfield cssClass="form-control" id="consult_pass"
															label="Passport NO." required="true" maxLength="15"
															placeholder="Ex.A12a3455"
															onkeyup="consult_passportnumValidation()" />
														<s:textfield cssClass="form-control dateImage"
															id="consult_passport" label="Passport Exp"
															required="true" placeholder="" value="%{docdatepicker}"
															tabindex="0"
															onkeypress="return consult_passportDateValidation();" />
														<s:submit id="updatebutton" value="Save"
								...
								<%-- activity tab starts --%>
								<div class="tab-pane fade textfieldLabel"
									id="consult_activities">
									<table id="consult-activities_add">
										<div id="add_consult-activities">
											<a href=""
												class="Activity_popup_open btn add-recordBtn pull-right"
												onclick="removeDataAfterActivityCloseOverlay()"
												style="margin-right: 0%">ADD NEW ACTIVITY</a>
										</div>
									</table>
												...
												<table>
													<div class="" id="addtsprofileBox">
														<tr>
															...
															<span class=" pull-right"><h5>
																	<a href="" class="Activity_popup_close"
																		onclick="removeActivityResultMessageAll()"><i
																		class="fa fa-times-circle-o fa-size"></i></a>&nbsp;
																</h5></span>
												</table>
											</div>
											<span><errorActivityUpdate></errorActivityUpdate></span>
											<form action="#" id="activityFrm" theme="simple"
												name="activityAddForm">
												<s:hidden id="consultId" value="%{consult_id}"
													name="consult_id" />
														...
														<div>
															<div class="inner-addtaskdiv-elements">
																<div class="col-sm-4 required">
																	...
																	<s:textfield id="add_Activity_name" name="activityName"
																		cssClass="form-control" theme="simple"
																		placeholder="Activity Name"
																		onfocus="removeActivityResultMessage()" />
																</div>
																<div class="col-sm-4">
																	<label class="labelStyle">Status</label>
																	<s:select id="add_Activity_status" value=""
																		name="activityStatus"
																		cssClass="SelectBoxStyles form-control"
																		headerKey="Created" headerValue="Created"
																		theme="simple" list="{'Created'}"
																		onfocus="removeActivityResultMessage()"
																		disabled="true" />
																</div>
																<div class="col-sm-4 required">
																	<label class="labelStyle">Activity Type</label>
																	<s:select id="add_activityType" value="-1"
																		name="activityType"
																		cssClass="SelectBoxStyles form-control" headerKey=""
																		headerValue="Select Type" theme="simple"
																		list="{'Call - Inbound','Call - Outbound','Email - Inbound','Email - Outbound','Notes'}"
																		onfocus="removeActivityResultMessage()" />
																...
																<div class="inner-addtaskdiv-elements">
																	...
																	<s:textarea name="activityDesc" id="add_Activity_desc"
																		placeholder="Enter Activity Description Here"
																		cssClass="areacss" onkeyup="checkCharacters(this)" />
																</div>
																<div class="inner-addtaskdiv-elements">
																	<label class="labelStyle">Comments</label>
																	<s:textarea name="activityComments"
																		id="add_Activity_comments"
																		placeholder="Enter Activity Comments Here"
																		cssClass="areacss" onkeyup="checkCharacters(this)" />
																</div>
																<div id="charNum"></div>
															</div>
															<div class="inner-addtaskbtndiv-elements">
																<s:reset cssClass="cssbutton " value="Clear"
																	theme="simple" />
																<s:submit cssClass="cssbutton task_popup_close"
																	value="AddActivity" theme="simple"
																	onclick="return addConsultActivity()" />
															</div>
											</form>
						...
						<s:form>
							<table id="consult_activity" class="CSSTable_task  responsive"
								border="5" cell-spacing="1"
								style="overflow-x: auto; overflow-y: hidden">
								<tr>
									<th>Activity Id</th>
									<th>Activity Name</th>
								...
								<tr>
									...
									<td><a
										onclick="populateActivityOverlay('<%=activity_id%>')" href="#"
										class="ActivityEdit_popup_open"> <%=activity_id%>
									</a></td>
									<td><%=activityName%></td>
									<td><%=activityType%></td>
								...
								%>
								<tr>
									<td colspan="7"><font style="color: red; font-size: 15px;">No
						...
						<div id="ActivityEdit_popup">
							<div id="ActivityEditBoxOverlay">
								...
								<div style="background-color: #3BB9FF">
									<table>
										<div class="" id="addtsprofileBox">
											<tr>
												<td style=""><h4>
														<font color="#ffffff">&nbsp;&nbsp;Edit
															Activity&nbsp;&nbsp; </font>
													</h4></td>
												<span class=" pull-right"><h5>
														<a href="" class="ActivityEdit_popup_close"
															onclick="removeActivityResultMessageAll()"><i
															class="fa fa-times-circle-o fa-size"></i></a>&nbsp;
													</h5></span>
									</table>
								...
								<form action="#" theme="simple" name="activityForm">
									...
									<span><errorActivityUpdate></errorActivityUpdate></span>
									<s:hidden id="Activity_Id" value="%{activityId}"
										name="activityId"></s:hidden>
									<s:hidden id="consultId" value="%{consult_id}"
										name="consult_id" />
									<div>
										...
										<div class="col-sm-12">
											...
											<div>
												<div class="inner-addtaskdiv-elements">
													<div class="col-sm-4 required">
														<label class="labelStyle">Name</label>
														<s:textfield id="Activity_name" name="activityName"
															value="%{activityName}" cssClass="form-control"
															theme="simple" placeholder="Activity Name"
															onfocus="removeActivityResultMessage()" />
													</div>
													<div class="col-sm-4">
														<label class="labelStyle">Status</label>
														<s:select id="Activity_status" value="%{activityStatus}"
															name="activityStatus"
															cssClass="SelectBoxStyles form-control" headerKey=""
															headerValue="Select Status" theme="simple"
															list="{'Not Started','Completed','Inprogress','Cancelled','Created','On Hold'}" />
													</div>
													<div class="col-sm-4 required">
														<label class="labelStyle">Activity Type</label>
														<s:select id="activityType" value="%{activityType}"
															name="activityType"
															cssClass="SelectBoxStyles form-control" headerKey=""
															headerValue="Select Type" theme="simple"
															list="{'Call - Inbound','Call - Outbound','Email - Inbound','Email - Outbound','Notes'}" />
													...
													<div class="inner-addtaskdiv-elements">
														<label class="labelStyle">Description</label>
														<s:textarea name="activityDesc" id="Activity_desc"
															value="%{activityDesc}"
															placeholder="Enter Activity Description Here"
															cssClass="areacss" onkeyup="checkCharacters(this)" />
													</div>
													<div class="inner-addtaskdiv-elements">
														<label class="labelStyle">Comments</label>
														<s:textarea name="activityComments" id="Activity_comments"
												...
												<div class="inner-addtaskbtndiv-elements">
													...
													<s:submit cssClass="cssbutton task_popup_close"
														...
														onclick="return editConsultActivityDetails()" />
												</div>
								</form>
	...
	<div class="tab-pane fade " id="consult_attach"
			...
			<div id="taskAttachOverlay">
				...
				<div class="overlayOrButton_color">
					<table>
						<tr>
							<td style=""><h4>
									<font color="#ffffff">&nbsp;&nbsp;Upload&nbsp;Attachments&nbsp;
									</font>
								</h4></td>
							<span class=" pull-right"><h5>
									<a id="consultAttachPopUpId" href=""
										class="consultAttachment_popup_close"
										onclick="attachPopJs();
				...
				<div>
					<br>
					<s:form action="addConsultAttachment" id="consultantAttachmentId"
						theme="simple" enctype="multipart/form-data" onsubmit="return consultAttachmentValidation();">
						<div>
							<div class="inner-addtaskdiv-elements">
								<div id="message"></div>
								<s:hidden name="downloadFlag" id="downloadFlag"
									value="%{downloadFlag}" />
								<s:hidden name="consultFlag" id="consultFlag"
									value="%{consultFlag}" />
								...
								<div class="col-sm-12 required">
									...
									<s:textfield cssClass="form-control" name="attachmentTitle"
										id="attachment_title" placeholder="Attachment Title"
										maxlength="30" />
								</div>
								<br> <br>
								...
								<div class="col-sm-12 required">
									...
									<s:select cssClass="form-control SelectBoxStyles" headerKey="0"
										headerValue="Select Attachment Type" name="attachmentType"
										id="attachment_type"
							...
							<center>
								<s:submit id="consultAttachUpload" type="button"
									cssClass="cssbutton fa fa-upload" value="Upload" theme="simple"
		...
		<a href="" class="consultAttachment_popup_open"
			onclick="return attachPopJs();"><button
		...
		<div class="col-lg-12">
			<s:if test='downloadFlag=="noResume"'>
				<span id="resume"><font style='color: red; font-size: 15px;'>No
						Attachment exists !!</font></span>
			</s:if>
			<s:if test='downloadFlag=="noFile"'>
				<span id="resume"><font style='color: red; font-size: 15px;'>File
						Not Found !!</font></span>
			</s:if>
			...
			<br> <label> Display <select id="con_paginationOption"
				class="disPlayRecordsCss" onchange="con_pagerOption()"
				style="width: auto">
					<option>10</option>
					<option>15</option>
					<option>25</option>
	...
	<div class="tab-pane fade" id="consult_personal">
		<table id="personalpagenav" class="CSSTable_task  responsive"
			border="5" cell-spacing="1"
			style="overflow-x: auto; overflow-y: hidden">
			<tr>
				<th>Experience In</th>
	...
	<div class="tab-pane fade textfieldLabel" id="consult_notes">
		<table id="notes_add">
			<div id="add_notes">
				<a href="" class="notesadd_popup_open btn add-recordBtn pull-right"
					onclick="removeDataAfterCloseOverlay()" style="margin-right: 0%">ADD
					NEW NOTES</a>
			</div>
		</table>
		<table id="notespagenav" class="CSSTable_task  responsive" border="5"
			cell-spacing="1" style="overflow-x: auto; overflow-y: hidden">
			<tr>
	...
	<div class="tab-pane fade textfieldLabel" id="consult_tech-review">
		<table id="tech-review_add">
			<div id="add_tech-review">
				<a href=""
					class="tech-reviewadd_popup_open btn add-recordBtn pull-right"
					onclick="removeDataAfterCloseOverlay()" style="margin-right: 0%">ADD
					NEW REVIEW</a>
			</div>
		</table>
		<table id="tech-reviewpagenav" class="CSSTable_task  responsive"
			border="5" cell-spacing="1"
			style="overflow-x: auto; overflow-y: hidden">
			<tr>
				<th>Forwarded To</th>
