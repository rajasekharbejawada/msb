...
function headingMessage(message)
{
    ...
    if (message.id == "detailsLi") {

        document.getElementById("headingmessage").innerHTML = "Requirement Details";
    }
    
    if (message.id == "vendorAssociationLi") {

        document.getElementById("headingmessage").innerHTML = 'Vendors<i  class="fa fa-angle-up" id="updownArrowAccount" onclick="toggleContentAccount(\'vendorSearchForm\')" style="margin-top: 0vw;position:absolute;color:#56a5ec"> </i>';
        document.getElementById('vendorAssociation').className = 'tab-pane fade in active ';
        document.getElementById('consultantList').className = 'tab-pane fade in ';
		getVendorAssociationDetails();
    }
    
    if (message.id == "consultantListLi") {
    ...
    if (message.id == "homeLi") {

        document.getElementById("headingmessage").innerHTML = "Task Details";
    }
    if (message.id == "profileLi") {

        document.getElementById("headingmessage").innerHTML = "Task Attachments";
    }
    if (message.id == "messagesLi") {

        document.getElementById("headingmessage").innerHTML = "Notes";
        doGetNotesDetails();
    }
    
    if (message.id == "editff") {

        document.getElementById("headingmessage").innerHTML = "Finder Fee Details";
    }
    if (message.id == "edit") {

        document.getElementById("headingmessage").innerHTML = "Contracts Details";
    }
    if (message.id == "Attachments") {

        document.getElementById("headingmessage").innerHTML = "Attachments";
        PagerOption_attch();
    }
    if (message.id == "RecreatedList") {

        document.getElementById("headingmessage").innerHTML = "Recreated List";
        getRecreatedList();
        pagerOption();
    }
...
function contactInfoValidation() {
    ...
    {
        //$("#addContactError").html("");
        $("#InsertContactInfo").html(" <font color='red'>Please enter valid Email Id.</font>");
...
function resultEmail(response) {
    if (response == "success") {
        $("#InsertContactInfo").html(" <font color='green'>Email Id is Available</font>");
        return true;
    }
    else {
        document.getElementById("ContactEmail").value = "";
        $("#InsertContactInfo").html("<font color='red'>Email Id  Already Exists !</font>");
        return false;
    }
}
                    ...
                    if (req.readyState == 4) {
                        ...
                        if (req.status == 200) {
                            ...
                            if (req.responseText == "success") {
                                ...
                                $("#validationMessage").show().delay(3000).fadeOut();
                                }
                                else
...
function changeCsrAccountStatus() {
    ...
    req.onreadystatechange = function() {
        if (req.readyState == 4) {
            ...
            if (req.status == 200) {
                document.getElementById("outputMessageOfUpdate").innerHTML = "<font color='green'>Status is updated</font>";
                accountSearch();
...
function invoceYear(evt) {
    ...
    if (iKeyCode > 31 && (iKeyCode < 48 || iKeyCode > 57))
    {
        ...
        if (rate != 4) {
            $("#invoiceValidation").html(" <font color='red'>Enter Numbers only</font>");
...
function invoceOverlayYear(evt) {
    ...
    if (iKeyCode > 31 && (iKeyCode < 48 || iKeyCode > 57))
    {
        //alert("enter only numbers ")
        if (rate != 4) {
            $("invoiceGenerarionMessage").html(" <font color='red'>Enter Numbers only</font>");
    ...
    if (response.length > 0) {
        for (var i = 0; i < eduList.length - 1; i++) {
            ...
            var Values = eduList[i].split("|");
            {
                ...
                if (Values[1] == 'SOA') {
                    row.append($("<td>SOW</td>"));
                }
                else if (Values[1] == 'MSA') {
                    row.append($("<td>MSA Document</td>"));
                }
                else if (Values[1] == 'OT') {
                    row.append($("<td>Other</td>"));
                }
...
function businessTypeChange() {
	...
	if (acc_businessType == "Private" || acc_businessType == "Women’s Business Enterprise (WBE)" ) {  
...
function officePhoneValidation(){
   ...
   if (officePhone=="")
   {
	  ...
	  $("#InsertContactInfo").html("");
      $("#Officephone").css("border", "1px solid green");
   }
}
