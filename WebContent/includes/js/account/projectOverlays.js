...
function assignProjectsValidation() {
    ...
    if (teamMemberStatusHidden == "Inactive") {
        ...
        req.onreadystatechange = function() {
            if (req.readyState == 4 && req.status == 200) {
                if (req.responseText == "Added Successfully") {
                    $("costCenter").html(" <font color='green'>Added successfully.</font>");
                    $("costCenter").show().delay(5000).fadeOut();
                }
                else {
                    $("costCenter").html(" <font color='red'>Not Added.</font>");
                }
...
function costCenterBudgetValidation(budgetAmt) {
    ...
    var endDateProject = Date.parse(edate);
    if (startDate == "") {
        $("costCenter").html(" <font color='red'>Please Enter Start Date.</font>");
        $("#startDate").css("border", "1px solid red");
        return false;
    }
    else {
    ...
    if (endDate == "") {
        $("costCenter").html(" <font color='red'>Please Enter End Date.</font>");
        $("#endDate").css("border", "1px solid red");
        return false;
    }
    else {
    ...
    if (budgetAmt == "") {
        $("costCenter").html(" <font color='red'>Please Enter Budget Amount.</font>");
