                ...
                <div id="homeMenuConsultant" class="panel-collapse collapse">
                    <div id="beforeparentTest" class="panel-body" >
                        <ul id="homeDisplay">
                           ...
                           <li><a id="requirementsVenConsultants" href="/<%=ApplicationConstants.CONTEXT_PATH%>/recruitment/consultant/getVenConRequirements.action" onClick="leftMenuToggleId(this,'homeAdmin');"><img src="<s:url value="/includes/images/icons/requirement.png"/>" height="15" width="15">&nbsp;Requirements</a></li>
                           <li><a id="techReviewsHomeVenConsultant" href="/<%=ApplicationConstants.CONTEXT_PATH%>/recruitment/consultant/getTechReviewDetails.action" onClick="leftMenuToggleId(this,'homeAdmin');"><img src="<s:url value="/includes/images/icons/review.png"/>" height="15" width="15">&nbsp;Tech&nbsp;Reviews</a></li>
                          <%--  <li><a id="vendorsListForConsultant" href="/<%=ApplicationConstants.CONTEXT_PATH%>/recruitment/consultantLogin/getVendorsListForConsultant.action" onClick="leftMenuToggleId(this,'homeAdmin');"><img src="<s:url value="/includes/images/icons/vendor_Copy.png"/>" height="15" width="15">&nbsp;Vendors&nbsp;List</a></li>  --%>
