...
<div class="row">
    ...
    <div class="col-sm-6 pull-left" style="color: white">Copyright <i class="fa fa-copyright"></i> <%GregorianCalendar cal = new GregorianCalendar();out.print(cal.get(Calendar.YEAR));%> ServicesBay. All rights reserved.</div>
    <div class="col-sm-6">
