                                        ...
                                        <div class="inner-reqdiv-elements">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4">       
                                                    ...
                                                    <s:select id="status" name="status"  cssClass="form-control SelectBoxStyles" tabindex="2" headerKey="DF" headerValue="All" list="#@java.util.LinkedHashMap@{'Active':'Active','Inactive':'Inactive'}"/>
                                                </div>
