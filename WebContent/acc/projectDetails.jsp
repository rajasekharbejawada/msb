                                    ...
                                    <div class="row" id="profileBox" style="margin-left: auto;margin-right: auto; margin-top: 5px">
                                        ...
                                        <div>
                                            <s:form action="updateProject" method="post" theme="simple" value="project">
                                                ...
                                                <div class="col-sm-3 required">
                                                    <label  >Status </label><s:select  id="project.project_status"  name="project.project_status" cssClass="form-control SelectBoxStyles "  list="#@java.util.LinkedHashMap@{'Active':'Active','Inactive':'Inactive','Completed':'Completed','Paused':'Paused'}"  headerValue="'%{project.project_status}'" cssStyle="margin-right:50px"/>
                                                </div>  
                                                <div class="col-sm-4">    
