                ...
                <div>
                    <div class="inner-addtaskdiv-elements">
                        <div>
                            ...
                            <div class="col-sm-4 required">  
                                <label>Name</label><s:textfield  cssClass="form-control" id="projectNamePopup" type="text" name="projectName" placeholder="Sub project Name" onchange="checkSubProjectName(this.value);" maxlength="30" onfocus="clearSubProjectFieldValues()"/>
                        </div>
                        ...
                        <s:hidden id="projectWorkedHrs"  value="0.0" name="projectWorkedHrs"/>
                    </div> 
                    <div class="inner-addtaskdiv-elements">
                        <div class="col-sm-12">
                    ...
                    <div class="inner-addtaskdiv-elements">
                        ...
                        <div class="inner-addtaskdiv-elements">
                            ...
                            <s:textarea  cssClass="form-control" id="projectReqSkillSetPopup" type="text" name="projectReqSkillSet" placeholder="Enter Skill Set Here" onkeydown="checkCharactersSkill(this)" onblur="removeMsg()" onfocus="clearSubProjectFieldValues()"/>
                        </div>
                        <div class="charNum" id="charNumSkill"></div>
                        <div class="inner-addtaskdiv-elements">
                            <label class="labelStyle">Description</label><s:textarea name="project_description" placeholder="Enter Sub project Description Here" id="project_descriptionPopup" cssClass="form-control" onkeydown="checkCharactersProjects(this)" onblur="removeMsg()" onfocus="clearSubProjectFieldValues()"/>
                        </div>
