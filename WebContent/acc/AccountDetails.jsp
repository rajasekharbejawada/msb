...
.main-login-form {
  ...
  .login-button1 {
    ...
    transition: all ease-in-out 500ms;
            ...
            .requirementPopup img{		            .requirementPopup img{
...
<body oncontextmenu="return false"
	onload="doOnLoadRequirement(), AccountTypeDropDown();
            attachmentsValidFromTo(); businessTypeChange();
												...
												<div class="">
													<div class="panel " style="margin-bottom: -8px">
														<div class="panel-body" id="panel-task-body">
															<div class="col-sm-12"
																style="float: unset; margin-top: -12px; margin-bottom: 5px">
																<s:if test="%{userType!='vendor'}">
																	<s:hidden name="nameFlag" id="nameFlag"
																		value="Customer" />
																...
																<s:url var="myUrl" action="viewAccount.action">
																	<s:param name="accountSearchID">
																		<s:property value="accountSearchID" />
																	</s:param>
																	<s:param name="accFlag">accDetails</s:param>
																</s:url>
																<s:a href='%{#myUrl}' id="accountName">
																	<s:property value="%{accountDetails.name}" />
																</s:a>
																<%
																	String typeOfUser = "";
																...
																%>
																<s:if
																	test="#session.primaryrole == 0 || #session.primaryrole == 1">
																	<span style="float: right;"><a
																		id="backButtonLink" href="searchAccountsBy.action"><img
																			src="<s:url value="/includes/images/backButton.png"/>"
																			height="25" width="25"></a></span>
																</s:if>
																<%--        //                                                                }
                                                                            --%>
															</div>
															...
															<ul class="active_details">
																<li class="dropdown"><a class=" active_details "
																	onclick="lockScreen();
                                                                                frameportion()"
																	data-toggle="dropdown" href="#"
																	title="Click Me For Menu"
																	style="background-color: #fff; width: 40px;"><img
																		src="<s:url value="/includes/images/toggleMenu.png"/>"
																		height="40" width="38"></a> <headingmess
																		id="headingmessage" class="accDetails">Account
																	Details</headingmess>
																	<ul class="active_details dropdown-menu  "
																		...
																		<s:if test="%{userType!='vendor'}">
																			<li class="  "><a aria-expanded="false"
																				...
																				id="accountdetailshead"
																				onclick="headingMessage(this);
                                                                                    unlockScreen();"
																				style="background-color: #fff; width: 40px;"><img
																					src="<s:url value="/includes/images/icons/accountEdit.png"/>"
																					height="15" width="15"><font
																					style="color: blue">&nbsp;Account Details</font></a></li>
																		</s:if>
																		<s:else>
																			<li class="  "><a aria-expanded="false"
																				href="#details" data-toggle="tab"
																				...
																				style="background-color: #fff; width: 40px;"><img
																					src="<s:url value="/includes/images/icons/accountEdit.png"/>"
																					height="15" width="15"><font
																					style="color: blue">&nbsp;Vendor Details</font></a></li>
																		</s:else>

																		<s:if
																			test="#session.primaryrole != 0 && #session.primaryrole != 2 && #session.primaryrole != 13">
																			<s:if test="%{userType!='vendor'}">
																				<li class=""><a aria-expanded="false"
																					href="#requirements" data-toggle="tab"
																					id="requirementshead"
																					onclick="getSearchRequirementsList(1);
                                                                                        headingMessage(this);
                                                                                        unlockScreen();
                                                                                        frameportion()"
																					style="background-color: #fff; width: 40px;"><img
																						...
																						height="15" width="15"><font
																						style="color: blue">Requirements</font></a></li>
																			</s:if>
																		</s:if>
																		<li class=""><a aria-expanded="false"
																			href="#contacts" data-toggle="tab" id="contactshead"
																			onclick="headingMessage(this);
                                                                                unlockScreen();
                                                                                frameportion()"
																			style="background-color: #fff; width: 40px;"><img
																				src="<s:url value="/includes/images/icons/contacts.png"/>"
																				height="15" width="15"><font
																				style="color: blue">&nbsp;Contacts</font></a></li>
																		<li class=""><a aria-expanded="false"
																			href="#VendorForms" data-toggle="tab"
																			id="vendorFormsHead"
																			onclick="headingMessage(this);
                                                                                unlockScreen();
                                                                                frameportion()"
																			style="background-color: #fff; width: 40px;"><img
																				src="<s:url value="/includes/images/icons/attachment.png"/>"
																				height="15" width="15"><font
																				style="color: blue">&nbsp;Attachments</font></a></li>
																		<%--<s:if test="%{userType!='vendor'}">
																			<s:if test="#session.primaryrole == 0">
																				<li class=""><a aria-expanded="false"
																					href="#subvendors" data-toggle="tab" id="vendors"
																					onclick="getVendors();
                                                                                        headingMessage(this);
                                                                                        unlockScreen();"
																					style="background-color: #fff; width: 40px;"><img
																						src="<s:url value="/includes/images/icons/vendor_Copy.png"/>"
																						height="15" width="15"><font
																						style="color: blue">&nbsp;Vendors</font></a></li>
																			</s:if>
																		...
																		<s:if test="%{accountDetails.accountType != 5}">
																			<li class=""><a aria-expanded="false"
																				href="#csrAccountsRef" data-toggle="tab"
																				id="csrAccounts"
																				onclick="headingMessage(this);
                                                                                    unlockScreen();"
																				style="background-color: #fff; width: 40px;"><img
																					src="<s:url value="/includes/images/icons/assignCsr.png"/>"
																					height="15" width="15"><font
																					style="color: blue">&nbsp;Assign CSR</font></a></li>
																		</s:if>
																		<%
																			}
																		%>
																		<li class=""><a aria-expanded="false"
																			href="#locations" data-toggle="tab" id="location"
																			onclick="headingMessage(this);
                                                                                unlockScreen();"
																			style="background-color: #fff; width: 40px;"><img
																				src="<s:url value="/includes/images/icons/location.png"/>"
																				height="15" width="15"><font
																				style="color: blue">&nbsp;Locations</font></a></li>
															...
															<div class="tab-content" style="padding: 0px">
																<div class="tab-pane fade in" id="details">
																	...
																	<div id="editMessage" style="display: none">
																		<font
																			style="color: green; font: bold; font-size: large">Account
																			updated successfully!</font>
																	</div>
																	<s:form action="ajaxAccountUpdate"
																		id="accountDetailsForm" theme="simple">
																		<s:hidden name="viewAccountID" id="viewAccountID"
																		...
																		<div class="panel-body" id="task-panel">
																			<div class="row">
																				...
																				<div class="row">
																					<div class="col-sm-12">
																						<div class="col-sm-8">
																							<div class="col-sm-6">
																								<s:if test="%{userType!='vendor'}">
																									<label style="color: #56a5ec;"
																										class="labelStyle2">Account Name </label>
																								</s:if>
																								<s:else>
																									<label style="color: #56a5ec;"
																										class="labelStyle2">Vendor Name </label>
																								</s:else>
																								<s:textfield type="text"
																									name="accountDetails.name"
																									cssClass="form-control" id="account_name"
																									value="%{accountDetails.name}" readonly="true" />
																								<span id="nameError" class="accDetailsError"></span>
																							</div>
																							<div class="col-sm-6">
																								<s:if test="%{userType!='vendor'}">
																									<label style="color: #56a5ec;"
																										class="labelStyle2">Account URL </label>
																								</s:if>
																								<s:else>
																									<label style="color: #56a5ec;"
																										class="labelStyle2">Vendor URL </label>
																								</s:else>
																								<s:textfield type="text"
																									name="accountDetails.url"
																									cssClass="form-control" id="account_url"
																									value="%{accountDetails.url}" readonly="true" />
																								<span id="urlError" class="accDetailsError"></span>
																							</div>

																							<div class="col-sm-6" style="display: none">
																								<s:hidden id="account_type"
																									name="accountDetails.accountType"
																									value="%{accountDetails.accountType}" />
																								<s:if test="%{userType!='vendor'}">
																									<label style="color: #56a5ec;"
																										class="labelStyle2">Account Type </label>
																								</s:if>
																								<s:else>
																									<label style="color: #56a5ec;"
																										class="labelStyle2">Account Type </label>
																							...
																							<div class="col-sm-6 required">
																								<label style="color: #56a5ec;"
																									class="labelStyle2">Status </label> <br>
																								<s:if
																									test="#session.primaryrole == 0 || #session.primaryrole == 1">
																									<s:select id="status"
																								...
																								<s:else>
																									<s:select id="status"
																										value="%{accountDetails.status}"
																										cssClass="SelectBoxStyles form-control"
																										headerKey="-1" headerValue="Status status"
																										required="true" theme="simple"
																										list="{'Active','Inactive'}"
																										onchange="accStatusValidate();"
																										disabled="true" />
																									<s:hidden name="accountDetails.status"
																										value="%{accountDetails.status}" />
																								</s:else>
																							...
																							<div class="col-sm-6">
																								<span> <label class="labelStyle2">Mail
																										Extension </label> <s:if
																										test="#session.primaryrole == 0 || #session.primaryrole == 1">
																										<s:textfield cssClass="form-control"
																											id="email_ext" maxLength="60"
																											name="accountDetails.emailExt"
																											value="%{accountDetails.emailExt}"
																											cssStyle="width:100%;"
																											onchange="getValidExtention()"
																											readonly="true" />
																									</s:if> <s:else>
																										<s:textfield cssClass="form-control"
																											id="email_ext" maxLength="60"
																											...
																											onchange="getValidExtention()"
																											readonly="true" />
																										<s:hidden name="accountDetails.emailExt"
																											value="%{accountDetails.emailExt}" />
																									</s:else> <span id="accountTypeValidation"
																						...
																						<div class="col-sm-4">
																							<div class="">
																								<s:url id="image" action="rImage"
																									...
																									<s:param name="path"
																										value="accountDetails.accLogo"></s:param>
																								</s:url>
																								<div class="imgLogo">
																									<a href="#"> <img
																										src="<s:property value="#image"/>"
																										id="imageLogo" class="imageupdate_popup_open"
																										onclick="openUploadFileDialogue()"
																										value="east" title="Change Image on Click"
																										alt="Logo" height="110px" width="220px">
																										<br> <font style="font-size: 10px;"
																										class="imageupdate_popup_open btn btn-xs btn-info "
																										onclick="openUploadFileDialogue()"
																				...
																				<s:hidden name="accLogoHidden" id="accLogoHidden"
																					value="%{accountDetails.accLogo}" />
																							...
																							<table>
																								<tr>
																									...
																									<span class=" pull-right"><h5>
																											<a href="#" class="imageupdate_popup_close"
																												onclick="openUploadFileDialogue()"><i
																							...
																							<div>
																								...
																								<div class="inner-addtaskdiv-elements">
																									...
																									<s:file name="file" id="file"
																										onchange="onChangeLogo()" style="width: 200px" />
																								</div>
																								<%--<s:submit cssClass="cssbutton task_popup_close" value="AddTask" theme="simple" onclick="addTaskFunction();" />--%>
																								<center>
																									<s:submit id="logoUpload" type="button"
																										cssClass="fa fa-upload cssbutton"
																										value="Upload" onclick="return logoUpload()"
																										theme="simple" />
																								</center>
																								<font color="red" style="font-size: 12px">&nbsp;NOTE
																									: Please Upload Transparent Logo</font><br>
																							</div>
																			...
																			<div class="row">
																				...
																				<div class="col-sm-12">
																					<div class="col-sm-4">
																						<label style="color: #56a5ec;" class="labelStyle2">Address
																							1 </label>
																						<s:textfield type="text" maxLength="100"
																							name="accountDetails.address1"
																							cssClass="form-control" id="account_address1"
																					...
																					<div class="col-sm-4">
																						...
																						<s:textfield type="text" maxLength="100"
																							...
																							cssClass="form-control" id="account_address2"
																							placeholder="Address 2"
																							value="%{accountDetails.address2}" />
																					</div>
																					<div class="col-sm-4">
																						<label style="color: #56a5ec;" class="labelStyle2">City
																						</label>
																						<s:textfield id="account_city" maxLength="20"
																							name="accountDetails.city" type="text"
																							cssClass="form-control" required="true"
																							placeholder="City" value="%{accountDetails.city}"
																					...
																					<div class="col-sm-4">
																						<label style="color: #56a5ec;" class="labelStyle2">Zip
																						</label>
																						<s:textfield id="account_zip" maxLength="11"
																							name="accountDetails.zip" type="text"
																					...
																					<s:if test="accountDetails.country==NULL">
																						<div class="col-sm-4">
																							<label style="color: #56a5ec;"
																								class="labelStyle2">Country </label> <br>
																							<s:select id="account_country" value="3"
																								name="accountDetails.country"
																								cssClass="SelectBoxStyles form-control"
																								theme="simple" list="countries"
																								onchange="javascript: getStates($('#account_country').val(),'#account_state'); accCountryValidate();" />
																					...
																					<div class="col-sm-4">
																						...
																						<s:select id="account_state"
																							value="%{accountDetails.state}"
																							name="accountDetails.state"
																							cssClass="SelectBoxStyles form-control"
																							headerKey="-1" headerValue="Select State"
																							theme="simple" list="states"
																							onchange="accStateValidate();" />
																						<span id="stateError" class="accDetailsError"></span>
																					</div>
																					<div class="col-sm-4">
																						<label style="color: #56a5ec;" class="labelStyle2">Phone
																						</label>
																						<s:textfield id="phone1" cssClass="form-control"
																							name="accountDetails.phone" type="text"
																					...
																					<div class="col-sm-4">
																						<label style="color: #56a5ec;" class="labelStyle2">Fax
																						</label>
																						<s:textfield id="fax" maxLength="15"
																							cssClass="form-control" name="accountDetails.fax"
																			...
																			<div class="row">
																				...
																				<div class="col-sm-12">
																					<div class="col-sm-4">
																						<label style="color: #56a5ec;" class="labelStyle2">Industry
																						</label> <br>
																						<s:select id="account_industry"
																							name="accountDetails.industry"
																							cssClass="SelectBoxStyles form-control"
																							headerKey="-1" headerValue="Select an industry"
																							type="text" value="%{accountDetails.industry}"
																							list="industries" />
																					...
																					<%--<div class="col-sm-4">
																						...
																						<s:textfield id="account_region" maxLength="20"
																							name="accountDetails.region" type="text"
																					...
																					<div class="col-sm-4">
																						...
																						<s:select cssClass="form-control SelectBoxStyles"
																							value="%{accountDetails.region}"
																							name="accountDetails.region" id="region"
																							headerKey="-1" headerValue="Select Region"
																							list="regionName" />
																					</div>
																					<div class="col-sm-4" style="display: none">
																						<label style="color: #56a5ec;" class="labelStyle2">Territory
																						</label>
																						<s:textfield id="account_territory" maxLength="20"
																							name="accountDetails.territory" type="text"
																							cssClass="form-control"
																					...
																					<div class="col-sm-4">
																						<label style="color: #56a5ec;" class="labelStyle2">No.
																							of Employees </label>
																					...
																					<div class="col-sm-4">
																						<label style="color: #56a5ec;" class="labelStyle2">Tax
																							ID </label>
																					...
																					<div class="col-sm-4">
																						<label style="color: #56a5ec;" class="labelStyle2">Stock
																							Symbol </label>
																						<%--------------------CURRENCY TYPE--------------------%>
																					...
																					<div class="col-sm-4">
																						<label style="color: #56a5ec;" class="labelStyle2">Revenue
																						</label>
																						<s:textfield id="account_revenue" maxLength="9"
																							cssClass="form-control"
																							name="accountDetails.revenue" type="text"
																							placeholder="Revenue"
																			...
																			<div class="row">
																				<div class="col-sm-12">
																					<div class="col-sm-12">
																						<label class="labelStyle" id="labelLevelStatusReq">Specialized
																							In </label>
																						<s:select cssClass="" name="skillCategoryValue"
																							id="skillCategoryValue" list="skillValuesMap"
																							multiple="true"
																							value="%{accountDetails.skillValueList}" />
																						<s:hidden id="skillValues"
																							name="accountDetails.skillValues" />

																					</div>
																				</div>
																			</div>
																			<div class="col-sm-4">
																				<label style="color: #56a5ec;" class="labelStyle2">Dun
																					& BradStreet No.</label> <br>
																				<s:textfield id="dunnbradStreetno" maxLength="80"
																					name="accountDetails.dunnbradStreetno" type="text"
																					cssClass="form-control"
																					value="%{accountDetails.dunnbradStreetno}"
																					placeholder="Dun & BradStreet No." />
																			</div>
																			<script type="text/javascript">
																				$(
																						"#dunnbradStreetno")
																			...
																			<div class="col-sm-4">
																				<span> <label class="labelStyle2">Business
																						...
																						value="%{accountDetails.businessType}"
																						list="#@java.util.LinkedHashMap@{'C-Corp':'C-Corp','S-Corp':'S-Corp','LLC':'LLC','DBA':'DBA'}"
																						tabindex="19" onchange="businessTypeChange();" />
																					<%--  list="#@java.util.LinkedHashMap@{'Private':'Private','WBE':'Women’s Business Enterprise (WBE)','MBE':'Minority Business Enterprise (MBE)','O':'Other'}"   --%>
																				</span>
																			</div>
																			<div class="col-sm-4">
																				<span> <label class="labelStyle2">Diversity
																				</label> <s:select cssClass="SelectBoxStyles form-control"
																						id="diversity" name="accountDetails.diversity"
																						value="%{accountDetails.diversity}"
																			...
																			<div class="col-sm-4">
																				<span> <label class="labelStyle2">Ownership
																				</label> <s:select cssClass="SelectBoxStyles form-control"
																						id="ownerShip" name="accountDetails.ownerShip"
																						value="%{accountDetails.ownerShip}"
																						list="#@java.util.LinkedHashMap@{'Private':'Private','Public':'Public'}"
																						tabindex="19" /> <%--  list="#@java.util.LinkedHashMap@{'Private':'Private','WBE':'Women’s Business Enterprise (WBE)','MBE':'Minority Business Enterprise (MBE)','O':'Other'}"   --%>
																				</span>
																			</div>

																			<div class="col-sm-4" id="businessTypeDescDiv"
																				style="display: none">
																				<span> <label class="labelStyle2">Description
																				</label> <s:textarea cssClass="form-control"
																						id="businessTypeDesc" type="text"
																						name="accountDetails.businessTypeDesc"
																						placeholder="Description" maxlength="200"
																						value="%{accountDetails.businessTypeDesc}"
																						tabindex="20" />
																				</span>
																			</div>
																			<div class="col-sm-4" id="minorityGroupDiv"
																				style="display: none">
																				<span> <label class="labelStyle2">Minority
																						Group </label> <s:select
																						cssClass="SelectBoxStyles form-control"
																						id="minorityGroup"
																						name="accountDetails.minorityGroup"
																						value="%{accountDetails.minorityGroup}"
																			...
																			<div class="col-sm-4">
																				<%--<span> <label class="labelStyle2">Staffing
																						...
																						cssClass="SelectBoxStyles form-control"
																						id="acc_staffingMode"
																						name="accountDetails.staffingMode"
																						value="%{accountDetails.staffingMode}"
																				...
																				<div class=" ">
																					<s:checkboxlist cssClass="checkbox-inline"
																						...
																						name="accountDetails.staffingMode"
																						value="%{accountDetails.staffingModeList}" />
																				</div>
																			...
																			<s:if test="%{userType=='vendor'}">
																				<div class="col-sm-4">
																					<div class=" ">
																						<label class="labelStyle2">Vendor
																					...
																					<div class="" style="margin-top: 3px">
																						<s:checkboxlist cssClass="checkbox-inline"
																							...
																							name="accountDetails.venSpecialization"
																							value="%{accountDetails.venSpecializationList}" />
																					</div>
																				</div>
																			</s:if>
																			<div class="row">
																				<div class="col-sm-12">
																					<div class="col-sm-12">
																						...
																						<s:textarea id="account_description"
																							...
																							cssClass="form-control" cssStyle="height:4em;"
																			...
																			<s:if test="%{userType=='vendor'}">
																				<div class="row">
																					...
																					<div class="col-sm-12">
																						<div class="col-sm-4">
																							<label style="color: #56a5ec;"
																								class="labelStyle2">Beneficiary Name</label> <br>
																							<s:textfield id="beneficiaryName" maxLength="80"
																						...
																						<div class="col-sm-4">
																							<label style="color: #56a5ec;"
																								class="labelStyle2">Bank Name </label> <br>
																							<s:textfield id="bankName" maxLength="80"
																								name="accountDetails.bankName" type="text"
																								cssClass="form-control"
																						...
																						<div class="col-sm-4">
																							<label style="color: #56a5ec;"
																								class="labelStyle2">Account No.</label>
																						...
																						<div class="col-sm-4">
																							<label style="color: #56a5ec;"
																								class="labelStyle2">Routing No.</label>
																							<s:textfield id="bankRoutingNumber"
																								maxLength="10"
																								name="accountDetails.bankRoutingNumber"
																								type="text" cssClass="form-control"
																								value="%{accountDetails.bankRoutingNumber}"
																								placeholder="Bank Routing Number" />
																						</div>
																						<div class="col-sm-4">
																							<label style="color: #56a5ec;"
																								class="labelStyle2">SWIFT/BIC code</label>
																							<s:textfield id="swiftBicCode" maxLength="10"
																								name="accountDetails.swiftBicCode" type="text"
																								cssClass="form-control"
																						...
																						<div class="col-sm-4">
																							<label style="color: #56a5ec;"
																								class="labelStyle2">Address</label>
																							<s:textfield id="bankAddress" maxLength="100"
																								name="accountDetails.bankAddress" type="text"
																								cssClass="form-control"
																						...
																						<div class="col-sm-4">
																							<label style="color: #56a5ec;"
																								class="labelStyle2">City</label>
																							<s:textfield id="bankCity" maxLength="50"
																								name="accountDetails.bankCity" type="text"
																								cssClass="form-control"
																								value="%{accountDetails.bankCity}"
																								placeholder="Bank City" />
																						</div>
																						<div class="col-sm-4">
																							<label style="color: #56a5ec;"
																								class="labelStyle2">Zip</label>
																							<s:textfield id="bankZip" maxLength="11"
																								name="accountDetails.bankZip" type="text"
																								cssClass="form-control"
																								value="%{accountDetails.bankZip}"
																			...
																			<div id="loadingAccount" class="loadingImg"
																				style="display: none">
																			...
																			<div class="row">
																				...
																				<div class="col-sm-12">
																					<div class="col-sm-2 pull-right">
																						<s:if
																							test="#session.primaryrole == 0 ||#session.primaryrole == 1 ||#session.primaryrole == 2 ||#session.primaryrole == 8 ">
																							<a id="detailsFormSubmit" href="#save"><button
																									type="button" style="margin: 5px 0px;"
																				...
																				<script>
																					$(
																							...
																							.on(
																									...
																									function() {
																										document
																												.getElementById('editMessage').style.display = "none";
																										...
																										document
																												.getElementById("skillValues").value = skillCategoryArry;
																										var v = document
																												.getElementById("skillValues").value;

																										var url = "ajaxAccountUpdate";
																										var validateAccount = true; //editAccountValidation();
																										if (validateAccount) {
																											document
																													.getElementById('loadingAccount').style.display = "block";
																											$
																													.ajax({
																														type : "POST",
																														url : url,
																														...
																														success : function(
																																data) {
																															document
																																	.getElementById('loadingAccount').style.display = "none";
																															document
																																	.getElementById('editMessage').style.display = "block";
																															$(
																																	"#editMessage")
																																	.fadeOut(
																																			5000);
																	...
																	<div id="loading_details" class="loadingImg"
																		style="display: none">
																		<span id="LoadingContent"> <img
																			src="<s:url value="/includes/images/Loader1.gif"/>"></span>
																	</div>
																...
																<div class="tab-pane fade in " id="softwares">
																	<div class="panel-body">
																		<div class="row">
																			<div class="col-sm-12">
																				<div class="row">
																					<div id="softwareDiv"></div>
																					<div style="float: right;">
																						<s:if test="%{roleId==1}">
																							<a href="#save" id="checkListButton"
																								onclick="javascript: saveSoftwaresAjax();">
																								<div class="details_button">UPDATE</div>
																							</a>
																						</s:if>
																		...
																		<div class="row">
																			<div class="col-sm-12">
																				<s:form action="updateAccTeam" theme="simple">
																					<label for="leftTitle" id="primaryAssign1">Primary
																						Assign</label>
																					<label id="primaryAssign2"> : </label>
																					<s:select id="accountindustry"
																						name="primaryAccount" cssClass="selectstyle"
																						headerKey="-1"
																						headerValue="Select an Account Team" type="text"
																						value="%{primaryAccount}" list="allAccTeam" />
																					...
																					<div class="row "
																						...
																						<div style="margin-left: 0px; overflow-x: auto">
																							<s:hidden name="accountSearchID"
																								id="accountSearchID" value="%{accountSearchID}"></s:hidden>
																							<s:optiontransferselect label="User Roles"
																								name="accTeam" leftTitle="Avilable Members"
																								rightTitle="Added Members" list="accTeamList"
																								headerKey="headerKey"
																						...
																						<s:if test="%{roleId==1}">
																							<s:submit cssClass="pull-right btn cssbutton"
																								value="Update" />
																						</s:if>
																						<s:elseif test="%{userSessionId== primaryAccount}">
																							<s:submit cssClass="pull-right btn cssbutton"
																	...
																	<div class="row">
																		...
																		<div class="col-sm-12" id="contactDiv">
																			...
																			<div class="inner-reqdiv-elements">
																				<div class="row">
																					<div class="col-sm-4">
																						<s:hidden name="accFlag" id="accFlag"
																							value="%{accFlag}" />
																						<label class="labelStylereq"
																							style="color: #56a5ec;">First Name </label>
																					...
																					<div class="col-sm-4">
																						<label class="labelStylereq"
																							style="color: #56a5ec;">Last Name </label>
																						<s:textfield id="lastNameContacts" name="lastName"
																							cssClass="form-control" theme="simple"
																							type="text" tabindex="2" placeholder="Last Name"
																							maxLength="30" />
																					</div>
																					<div class="col-sm-4">
																						<label class="labelStylereq"
																							style="color: #56a5ec;">Email Id </label>
																						<s:textfield id="emailContacts" name="email"
																							cssClass="form-control" theme="simple"
																							type="text" tabindex="3" placeholder="Email"
																							maxLength="60" />
																					</div>
																					...
																					<div class="col-sm-4">
																						<label class="labelStylereq"
																							style="color: #56a5ec;">Phone </label>
																						<s:textfield id="phoneContacts"
																							cssClass="form-control" name="phone" type="text"
																							placeholder="Phone #" tabindex="4" maxLength="15" />
																					</div>
																					<div class="col-sm-4">
																						<label class="labelStylereq"
																						...
																						<s:select id="statusContacts"
																							cssClass="SelectBoxStyles form-control"
																							name="status"
																							list="#@java.util.LinkedHashMap@{'Active':'Active','DF':'All','Registered':'Registered','Inactive':'Inactive'}"
																							headerKey="Active" tabindex="5"
																							placeholder="Status" />
																					</div>
																					<div class="col-sm-4">
																						...
																						<div
																							class="col-md-6 col-lg-6 pull-right contact_search"
																							style="width: 100px">
																							<label class="labelStylereq"
																							...
																							<s:submit type="button" id="contactSearch"
																								...
																								tabindex="7" value=""
																								onclick="getContactSearchResults()"
																								cssStyle="margin:5px 0px;">
																								<i class="fa fa-search"></i>&nbsp;Search</s:submit>
																						</div>
																						<div
																							class="col-md-6 col-lg-6 pull-right contact_add">
																							<label class="labelStylereq"
																								style="color: #56a5ec;"></label>
																							...
																							<a id="addContactLink"
																								href='setContacts.action?accountType=<s:property value="%{accountDetails.accountType}"/>&accountSearchID=<s:property value="%{accountSearchID}"/>'><button
																									class="add_searchButton form-control"
																									tabindex="6" style="margin: 5px 0px;">
																		...
																		<div class="inner-reqdiv-elements">
																			<div class="col-sm-12">
																				<s:form>
																					...
																					<br />
																					<label class="page_option"> Display <select
																						id="paginationOption_cnt" tabindex="8"
																						...
																						style="width: auto">
																							...
																							<option>25</option>
																							<option>50</option>
																					</select> Contacts per page
																					</label>
																					<div id="loadingContact" class="loadingImg"
																						style="display: none">
																						<span id="LoadingContent"> <img
																							src="<s:url value="/includes/images/Loader1.gif"/>"></span>
																					</div>
																					...
																					<div style="width: auto; height: auto">
																						<div id="editSpan" class="badge pull-right"
																...
																<div class="tab-pane fade in" id="VendorForms"
																	style="margin-top: 20px">
																	<div class="row">
																		<div class="col-sm-12" id="VendorFormstDiv">
																			...
																			<div class="inner-reqdiv-elements">
																				<div class="row">
																					<div class="col-sm-4">
																						<label class="labelStylereq"
																							style="color: #56a5ec;">Name</label>
																						<s:textfield cssClass="form-control "
																							id="attachmentTitle" type="dropdown"
																							name="attachmentTitle" placeholder="Name"
																							tabindex="1" value="" />
																					</div>
																					<div class="col-sm-4">
																						<label class="labelStylereq"
																							style="color: #56a5ec;">Valid&nbsp;From </label>
																						<div class="calImage">
																							<s:textfield cssClass="form-control "
																								id="validFrom" type="dropdown" name="validFrom"
																								tabindex="2" placeholder="Select Date"
																					...
																					<div class="col-sm-4">
																						<label class="labelStylereq"
																							style="color: #56a5ec;">Valid&nbsp;To </label>
																						<div class="calImage">
																							<s:textfield cssClass="form-control  "
																								id="validTo" type="dropdown" name="validTo"
																								tabindex="3" placeholder="Select Date"
																								onkeypress="return enterDateRepositoryAttachment();"
																								autocomplete="off"
																								onfocus="return removeFormErrorMsg();">
																								<i class="fa fa-calendar"></i>
																					...
																					<div class="col-sm-4">
																						<label class="labelStylereq"
																							style="color: #56a5ec;">Document&nbsp;Type
																						</label>
																						<s:select id="vendorDocs"
																							cssClass="SelectBoxStyles form-control"
																							tabindex="4" name="vendorDocs"
																							list="#@java.util.LinkedHashMap@{'All':'All','SOA':'SOW','MSA':'MSA Document','OT':'Other'}"
																							headerKey="DF" placeholder="Status" />
																					</div>

																					<s:hidden name="viewAccountID" id="viewAccountID"
																						value="%{accountSearchID}"></s:hidden>
																					<s:hidden name="acc_attachment_id"
																						id="acc_attachment_id"
																						value="%{acc_attachment_id}" />
																					<s:hidden name="attachment_id" id="attachment_id"
																						value="%{attachment_id}" />
																					<s:hidden id="vendorDocs" name="vendorDocs"
																						value="%{vendorDocs}" />
																					<div class="col-lg-2 pull-right">
																						...
																						<s:submit type="button" id="vendorFormSearch"
																							...
																							tabindex="6" value="Search"
																							onclick="getVendorFormDetails();"
																							cssStyle="margin:5px 0px;" />
																					</div>
																					<div class="col-lg-2 pull-right">
																						<label class="labelStylereq"
																							style="color: #56a5ec;"></label>
																						<button id="vendorFormAdd"
																							class="add_searchButton form-control addAttachment_popup_open"
																							tabindex="5"
																							onclick="return vendorFormOverlay();"
																			...
																			<div class="col-sm-12">
																				<s:form>
																					...
																					<s:if test='downloadFlag=="noFile"'>
																						<span id="resume"><font
																							style='color: red; font-size: 15px;'>File
																								Not Found !!</font></span>
																					</s:if>
																					<br />
																					<table id="vendorFormPageNav"
																						class="responsive CSSTable_task" border="5"
																						cell-spacing="2">
																					...
																					<br />
																					<label class="page_option"> Display <select
																						id="vpaginationOption" tabindex="7"
																						class="disPlayRecordsCss"
																						onchange="vpagerOption()" style="width: auto">
																							<option>10</option>
																							<option>15</option>
																							<option>25</option>
																							<option>50</option>
																					...
																					<div id="loadingAttachments" class="loadingImg"
																						style="display: none">
																						<span id="LoadingContent"> <img
																							src="<s:url value="/includes/images/Loader1.gif"/>"></span>
																					</div>
																...
																<div class="tab-pane fade in " id="requirements"
																	...
																	<div class="row">
																		<div class="col-sm-12" id="requirementDiv">
																			...
																			<s:hidden name="reqInAccTotalRecords"
																				id="reqInAccTotalRecords" cssClass="inputTextBlue"
																				theme="simple" />
																			...
																			<div class="inner-reqdiv-elements">
																				<div class="row">
																					...
																					<div class="col-sm-4">
																						<label class="labelStylereq"
																							style="color: #56a5ec">Skills</label>
																						<s:textfield cssClass="form-control  "
																							name="requirementSkill" id="requirementSkill"
																							placeholder="Skills" />
																					</div>
																					<div class="col-sm-4">
																						<s:if test="vendor=='yes'">
																							<label class="labelStylereq"
																								style="color: #56a5ec">Status</label>
																							<s:select id="requirementStatus"
																								name="requirementStatus"
																								cssClass="SelectBoxStyles form-control "
																								headerKey="-1" headerValue="Requirement Status"
																								theme="simple"
																								list="#@java.util.LinkedHashMap@{'R':'Released','C':'Closed'}" />
																						</s:if>
																						<s:else>
																							<label class="labelStylereq"
																								style="color: #56a5ec">Status</label>
																							<s:select id="requirementStatus"
																								...
																								headerKey="-1" headerValue="Requirement Status"
																								theme="simple"
																								list="#@java.util.LinkedHashMap@{'O':'Opened','R':'Released','C':'Closed'}" />
																						</s:else>
																					</div>

																					<div class="col-sm-4">
																						<label class="labelStylereq"
																							style="color: #56a5ec;">Start Date</label>
																						<div class="calImage">
																							<s:textfield cssClass="form-control"
																								name="reqStart" id="reqStart"
																								placeholder="From Date" tabindex="1"
																								onkeypress="return enterDateRepositoryReq();">
																								<i class="fa fa-calendar"></i>
																							</s:textfield>
																						</div>
																					</div>
																					<div class="col-sm-4">
																						<label class="labelStylereq"
																							style="color: #56a5ec;">End Date</label>
																						<div class="calImage">
																							<s:textfield cssClass="form-control"
																								name="reqEnd" placeholder="To Date" id="reqEnd"
																								tabindex="2"
																								onkeypress="return enterDateRepositoryReq();">
																								<i class="fa fa-calendar"></i>
																							</s:textfield>
																					...
																					<div class="col-sm-4">
																						<label class="labelStylereq "
																							style="color: #56a5ec;">Req.Category</label>
																						<s:select id="reqCategory" tabindex="3"
																							name="reqCategoryValue"
																							cssClass="SelectBoxStyles form-control"
																							headerKey="-1" headerValue="All" theme="simple"
																							list="%{reqCategory}" />
																					</div>
																					...
																					<div class="col-sm-4">
																						<div class="contact_add pull-right">
																							<label class="labelStylereq"
																								style="color: #56a5ec;"></label>
																							<s:submit type="button" id="reqListSearch"
																								cssClass="add_searchButton  form-control"
																								value=""
																								onclick="return getSearchRequirementsList(1)"
																								cssStyle="margin:5px 0px;">
																								<i class="fa fa-search"></i>&nbsp;Search</s:submit>
																						</div>
																					</div>
																		...
																		<div class="col-sm-12" style="align: center">
																			...
																			<s:form>
																				...
																				<br />
																				<div id="loadingReq" class="loadingImg"
																					style="display: none">
																					<span id="LoadingContent"> <img
																						src="<s:url value="/includes/images/Loader1.gif"/>"></span>
																				</div>
																				<label class="page_option"> Display <select
																					id="accpaginationOption" class="disPlayRecordsCss"
																					onchange="getSearchRequirementsList(1)"
																					style="width: auto">
																						<option>10</option>
																						<option>15</option>
																						<option>25</option>
																				...
																				<span id="reqInAccount_pageNation"></span>
																				<div align="right" id="reqPageNavPosition"
																					style="margin-right: 0vw; display: none"
																					class="pull-right"></div>

																				<script type="text/javascript">
																					var reqPag = new Pager(
																							'reqTableInAccount',
																							10);
																					reqPag
																							.init();
																...
																<div id="releaseVendorOverlay_popup">
																	<div id="releaseVendorBox" class="marginTasks">
																			...
																			<table>
																				<tr>
																					<td><h4 style="font-family: cursive">
																							<font class="titleColor">&nbsp;&nbsp;Select&nbsp;Vendor&nbsp;Details&nbsp;&nbsp;
																							</font>
																						</h4></td>
																					<span class="pull-right">
																						<h5>
																							&nbsp;&nbsp;&nbsp;&nbsp;<a href=""
																								class="releaseVendorOverlay_popup_close"
																								onclick="selectVendorsOverlayCloseForCSR();getSearchRequirementsList(1);"><i
																								class="fa fa-times-circle-o fa-size"></i></a>
																						</h5>
																					</span>
																			</table>
																		...
																		<div>
																			<table id="releaseReqTable" class="responsive"
																				border="0" cell-spacing="1"
																				style="overflow-x: auto; overflow-y: hidden; margin: 11px 3%; width: 94%;">
																				<tr style="color: #3478c6">
																					<th><div class="hb3">
																							<div style="text-align: left;">
																								<i class="fa fa-file-text" aria-hidden="true"></i>&nbsp;Vendor
																								List
																							</div>
																						</div></th>
																				</tr>
																			...
																			<%--- label style="margin: 2% 0 0 3%" class="pull-right">
																				Display: <select id="paginationOption_releaseReq"
																				class="disPlayRecordsCss"
																				onchange="releaseReqPagerOption();"
																				style="width: auto">
																					<option>10</option>
																					<option>15</option>
																					<option>20</option>
																			...
																			<div class="row" style="white-space: nowrap;position: relative;top: 23px;">
																				<div class="col-sm-12">
																					<div class="col-sm-6">
																						<s:checkbox cssClass="checkboxAlign"
																							name="allVendors" id="allVendors"
																							onclick="onClickHandlerForCSR(this)" />
																						&nbsp;&nbsp;
																						<s:label value="Release to all vendors"
																							cssClass="textLabel-i" />
																					</div>

																					<div
																						style="display: none; padding: 9px; width: 100px; margin: 0 12px 0 0;"
																						onclick="doReleaseRequirementForCSR()"
																						id="vendorReleaseButton"
																						class=" fa fa-arrow-circle-o-right btn btn-primary col-sm-6 pull-right">&nbsp;Release</div>
																				</div>
																			</div>
																			<div class="main-login-form">
																				<div class="login-group">
																					<div class="form-group1">
																						...
																						<p>* If the requirement is contract then
																							initially requirement will be released to Tier-1
																							Associated Vendors.</p>
																						<p>* If the requirement is permanent then
																							initially requirement will be released to
																							HeadHunters vendors Associated with customer.</p>
																						<p>* If you select all vendors check box then
																							the requirement will be released to all vendors
																			...
																			<input type="hidden" id="vendorsIdString"
																				name="vendorsIdString" /> <input type="hidden"
																				id="requirementId" name="requirementId" /> <input
																				type="hidden" id="orgId" name="orgId" /> <input
																				type="hidden" id="taxTerm" name="taxTerm" />
																		...
																		<div id="preskillBox" class="marginTasks">
																			<div class="backgroundcolor">
																				<table>
																					<tr>
																						<td><h4 style="font-family: cursive">
																								<font class="titleColor">&nbsp;&nbsp;Skill
																									Details&nbsp;&nbsp; </font>
																							</h4></td>
																						<span class="pull-right">
																							<h5>
																								&nbsp;&nbsp;&nbsp;&nbsp;<a href=""
																									class="preSkillOverlay_popup_close"
																									onclick="preSkillOverlay()"><i
																									class="fa fa-times-circle-o fa-size"></i></a>
																							</h5>
																						</span>
																				</table>
																			...
																			<div>
																				...
																				<s:textarea name="skillDetails" id="preSkillDetails"
																					disabled="true"
																		...
																		<div class="col-sm-12" id="csrAssignDiv">
																			...
																			<div class="inner-reqdiv-elements">
																				<div class="row">
																					<div class="col-sm-4">
																						<label class="labelStylereq"
																							style="color: #56a5ec">CSR</label>
																						<s:textfield cssClass="form-control " tabindex="1"
																							name="Name" id="csrName" placeholder="CSR"
																							maxLength="30" />
																					</div>
																					<div class="col-sm-4">
																						<label class="labelStylereq"
																							style="color: #56a5ec">Email</label>
																						<s:textfield cssClass="form-control  "
																							tabindex="2" name="Email" id="csrEmail"
																					...
																					<div class="col-sm-4">
																						...
																						<label class="labelStylereq"
																							style="color: #56a5ec">Phone</label>
																						<s:textfield cssClass="form-control  "
																							tabindex="3" name="csrPhone" id="csrPhone"
																					...
																					<div class="col-sm-4">
																						...
																						<label class="labelStylereq"
																							style="color: #56a5ec">Status</label>
																						<s:select id="csrStatus" name="csrStatus"
																							tabindex="4"
																							cssClass="SelectBoxStyles form-control "
																							value="Active" theme="simple"
																					...
																					<div class="col-sm-2 pull-right">
																						<label class="labelStylereq"
																							style="color: #56a5ec"></label>
																						<s:url var="csrUrl"
																							action="../acc/goAddintAccToCsr.action">
																							<s:param name="orgUserId">
																								<s:property value="accountSearchID" />
																							</s:param>
																						</s:url>
																						<s:a href='%{#csrUrl}' id="addAcctoCsr"
																							style="color: #0000FF;">
																							<s:submit type="button" tabindex="6"
																								cssStyle="margin:5px 0px;"
																								cssClass="add_searchButton form-control">
																					...
																					<div class="col-sm-2 pull-right">
																						<label class="labelStylereq"
																							style="color: #56a5ec"></label>
																						<s:submit id="csrSearchButton" type="button"
																							value="" cssStyle="margin:5px 0px;" tabindex="5"
																							cssClass="add_searchButton form-control"
																							onclick="getCsrDetailsTable()">
																							<i class="fa fa-search"></i>&nbsp;Search</s:submit>
																					</div>
																				</div>
																			</div>
																		...
																		<div class="inner-reqdiv-elements">
																			<div class="col-sm-12" style="align: center">
																				...
																				<s:form>
																					...
																					<br />
																					<div id="loading_csrDetails" class="loadingImg"
																						style="display: none">
																						<span id="LoadingContent"> <img
																							src="<s:url value="/includes/images/Loader1.gif"/>"></span>
																					</div>
																					<label class="page_option"> Display <select
																						id="csrpaginationOption" tabindex="7"
																						class="disPlayRecordsCss"
																						onchange="csrpagerOption()" style="width: auto">
																							<option>10</option>
																							<option>15</option>
																							<option>25</option>
																							<option>50</option>
																					</select> CSR's per page
																					</label>
																					<div align="right" id="csrDetailsTablepageNavi"
																						style="margin-right: 0vw; display: none"
																						class="pull-right"></div>

																					<script type="text/javascript">
																						var reqPager = new Pager(
																								'csrDetailsTable',
																								10);
																						reqPager
																								.init();
																				...
																				<div id="AddLocationOverlay">
																					<div class="overlayOrButton_color">
																						<table>
																							<tr>
																								<td><h4 style="">
																										<font color="#ffffff" id="locationHeading"
																											style="margin-left: 10px">&nbsp;&nbsp;Add
																											Location&nbsp;&nbsp; </font>
																									</h4></td>
																							</tr>
																							<span class=" pull-right"><h5>
																									<a href="" class="addLocation_popup_close"
																										onclick="addLocationOverlay();"><i
																										class="fa fa-times-circle-o fa-size"></i></a>
																								</h5></span>
																						</table>
																					</div>
																					<div id="VendorTierDiv">
																						...
																						<div class="row">
																							...
																							<div class="col-sm-4 required">
																								...
																								<s:textfield id="locationName"
																									cssClass="form-control" name="locationName"
																									placeholder="Name" value="" maxLength="80"
																									onblur="checkLoactionNameExistOrNot()" />
																								<s:hidden id="locationEditName"
																									name="locationEditName"></s:hidden>
																							</div>
																							<div class="col-sm-4">
																								<label class="labelStyleAddCon">Address1</label>
																								<s:textfield id="locationAddress1"
																									cssClass="form-control" name="locationAddress1"
																									placeholder="Address1" value="" maxLength="100" />
																							</div>
																							<div class="col-sm-4">
																								<label class="labelStyleAddCon">Address2</label>
																								<s:textfield id="locationAddress2"
																									cssClass="form-control" name="locationAddress2"
																									placeholder="Address2" value="" maxLength="100" />
																							</div>


																							<div class="col-sm-4 required">
																								<label class="labelStyleAddCon">Country</label>
																								<s:select id="locationCountry" headerKey=""
																									cssClass="SelectBoxStyles form-control"
																									name="locationCountry" list="countries"
																									value="3"
																									onchange="getStates($('#locationCountry').val(),'#locationState')" />
																							</div>
																							<div class="col-sm-4 required">
																								<label class="labelStyleAddCon">State</label>
																								<s:select id="locationState" headerKey=""
																									headerValue="Select State"
																									cssClass="SelectBoxStyles form-control"
																									name="locationState" list="{}" />
																							</div>
																							<div class="col-sm-4 required">
																								<label class="labelStyleAddCon">City</label>
																								<s:textfield id="locationCity"
																									cssClass="form-control" name="locationCity"
																									placeholder="City" value=" " maxLength="20" />
																							</div>


																							<div class="col-sm-4">
																								<label class="labelStyleAddCon">Phone</label>
																								<s:textfield id="locationPhone"
																									cssClass="form-control" name="locationPhone"
																									placeholder="Phone" value="" maxLength="15" />
																							</div>
																							<div class="col-sm-4">
																								<label class="labelStyleAddCon">Zip</label>
																								<s:textfield id="locationZip"
																									cssClass="form-control" name="locationZip"
																									placeholder="Zip" value="" maxLength="10" />
																							</div>
																							<div class="col-sm-4">
																								<label class="labelStyleAddCon">Fax</label>
																								<s:textfield id="locationFax"
																									cssClass="form-control" name="locationFax"
																									placeholder="Fax" value="" maxLength="15" />
																							</div>
																							<!--                                                                                        <div class="col-lg-4" id="statusLoc">
                                                                                                                                                                                            <label class="labelStyleAddCon">Status</label>
                                                                                                <%--<s:select id="locationStatus" cssClass="SelectBoxStyles form-control" name="locationStatus" list="#@java.util.LinkedHashMap@{'Active':'Active','Inactive':'Inactive'}"  />--%>
                                                                                            </div> -->
																						</div>
																						<div class="row">
																							<div class="col-sm-4" id="statusLoc">
																								<label class="labelStyleAddCon">Status</label>
																								<s:select id="locationStatus"
																									cssClass="SelectBoxStyles form-control"
																									name="locationStatus"
																									list="#@java.util.LinkedHashMap@{'Active':'Active','Inactive':'Inactive'}" />
																							</div>
																						...
																						<div class="row" style="margin-top: 5px"
																							id="addLoc">
																							<div class="col-lg-2 pull-right ">
																								<s:submit id="saveLocation" type="button"
																									cssClass="fa fa-plus-square add_searchButton form-control"
																									value="Save" style="margin:5px"
																									onclick="addorUpdateLocation('Add')" />
																							</div>
																							<div class="col-lg-2 pull-right">
																								<s:submit id="clearLocation" type="button"
																									cssClass=" add_searchButton form-control fa fa-eraser"
																									value="Clear" style="margin:5px"
																						...
																						<div class="row" style="margin-top: 5px"
																							id="updateLoc">
																							<div class="col-lg-2 pull-right ">
																								<s:submit id="addOrUpdateLocation" type="button"
																									cssClass=" add_searchButton form-control fa fa-refresh"
																									value="Update" style="margin:5px"
																									onclick="addorUpdateLocation('Edit')" />
																							</div>
																					...
																					<div class="row">
																						...
																						<div class="col-sm-4">
																							...
																							<s:textfield id="locationSearchName"
																								...
																								name="locationSearchName" type="text"
																								placeholder="Location Name " maxLength="80" />
																						</div>
																						<div class="col-sm-4">
																							...
																							<label class="labelStylereq"
																								style="color: #56a5ec;">City </label>
																							<s:textfield id="locationSearchCity"
																								cssClass="form-control" tabindex="2" type="text"
																								name="locationSearchCity" placeholder="city"
																								maxLength="20" value="" />
																						</div>
																						<div class="col-sm-4">
																							<label class="labelStylereq"
																						...
																						<div class="col-sm-4">
																							<label class="labelStylereq"
																								style="color: #56a5ec;">Country </label>
																							<s:select id="locationSearchCountry" tabindex="4"
																								cssClass="SelectBoxStyles form-control"
																								name="locationSearchCountry" list="countries"
																						...
																						<div class="col-sm-4">
																							<label class="labelStylereq"
																								style="color: #56a5ec;">State </label>
																							<s:select id="locationSearchState"
																								cssClass="SelectBoxStyles form-control"
																								tabindex="5" name="locationSearchState"
																								list="{}" headerKey="-1"
																								headerValue="Select State" placeholder="Status" />
																						</div>
																						<div class="col-sm-4">

																							<label class="labelStylereq"
																								style="color: #56a5ec">Status</label>
																							<s:select id="locationSearchStatus"
																								name="locationSearchStatus" tabindex="6"
																								cssClass="SelectBoxStyles form-control "
																								theme="simple"
																								list="#@java.util.LinkedHashMap@{'All':'All','Active':'Active','Inactive':'Inactive'}" />
																						...
																						<div class="col-sm-8 pull-right">
																							...
																							<div
																								class="col-sm-6 col-md-5 col-lg-4 pull-right">
																								<label class="labelStylereq contact_search"
																									style="color: #56a5ec;"></label>
																								<s:submit id="addLocationButton" type="button"
																									tabindex="8"
																									cssClass="addLocation_popup_open add_searchButton fa fa-location-arrow form-control bx-style"
																									onclick="addLocationOverlay();addorEditLocationOverlay('Add');clearLocationFields()"
																									value="Add Location" style="margin:5px;%" />

																							</div>
																							<div
																								class="col-sm-4  col-md-3 col-lg-3 pull-right">
																								<label class="labelStylereq"
																									style="color: #56a5ec;"></label>
																								<s:submit type="button"
																									id="searchLocationButton"
																									cssClass="add_searchButton fa fa-search form-control bx_style"
																									tabindex="7" value="Search"
																		...
																		<div class="inner-reqdiv-elements">
																			<div class="col-sm-12">
																				<s:form>
																					...
																					<br />
																					<label class="page_option"> Display <select
																						id="loc_paginationOption" tabindex="9"
																						class="disPlayRecordsCss"
																						onchange="Loc_pagerOption()" style="width: auto">
																							<option>10</option>
																							<option>15</option>
																							<option>25</option>
																							<option>50</option>
																					</select> Locations per page
																					...
																					<script type="text/javascript">
																						...
																						reqPager
																								.showPageNav(
																										'reqPager',
																										'locationDetailsTablepageNavi');
																						reqPager
																								.showPage(1);
																					</script>
																					<div id="loadingLocation" class="loadingImg"
																						style="display: none">
																						<span id="LoadingContent"> <img
																							src="<s:url value="/includes/images/Loader1.gif"/>"></span>
																					</div>
															...
															<div id="recSkillOverlay_popup">
																<div id="reqskillBox" class="marginTasks">
																				...
																				<span class="pull-right">
																					<h5>
																						&nbsp;&nbsp;&nbsp;&nbsp;<a href=""
																							...
																							onclick="requiredSkillOverlay()"><i
																							class="fa fa-times-circle-o fa-size"></i></a>
																					</h5>
																				</span>
																		</table>
																	...
																	<div>
																		...
																		<s:textarea name="skillDetails" id="reqSkillDetails"
																			disabled="true"
																			cssClass="form-control textareaSkillOverlay" />
																...
																<div id="attachmentBox" class="marginTasks">
																	<div class="backgroundcolor">
																		<table>
																			<tr>
																				<td><h4 style="font-family: cursive">
																						<font class="titleColor">&nbsp;&nbsp;Add
																							Attachment&nbsp;&nbsp; </font>
																					</h4></td>
																				<span class="pull-right">
																					<h5>
																						&nbsp;&nbsp;&nbsp;&nbsp;<a href=""
																							class="addAttachment_popup_close"
																							onclick="vendorFormOverlay();"><i
																							class="fa fa-times-circle-o fa-size"></i></a>
																					</h5>
																				</span>
																		</table>
																	...
																	<s:form action="addVendorFormAttachments"
																		theme="simple" enctype="multipart/form-data"
																		onsubmit="return accAttachmentValidation();">
																		<div>
																			...
																			<s:hidden name="userSessionId" id="userSessionId"
																				value="%{userSessionId}" />
																			<div class="inner-reqdiv-elements">
																				<div class="row">
																					<div class="col-sm-6 required">
																						<label>Name </label>
																						<s:textfield cssClass="form-control "
																							id="attachmentTitle" name="attachmentTitle"
																							placeholder="Name" value="" maxLength="200" />
																					</div>
																					<div class="col-sm-6">
																						...
																						<s:select id="vendorDocs_add"
																							cssClass="SelectBoxStyles form-control"
																							name="vendorDocs"
																							list="#@java.util.LinkedHashMap@{'SOA':'SOW','MSA':'MSA Document','OT':'Other'}" />
																					</div>

																					<div class="col-sm-6 required">
																						<label>Upload&nbsp;Attachment&nbsp;</label>
																						<s:file cssClass="form-control" name="file"
																							id="file"
																							onchange="return attachmentFileFormatValidation();"
																							onfocus="return removeFormErrorMsg();" />
																						<font style="color: blue"> Upload doc or
																							pdf or docx </font>
																					</div>
																					<div class="col-sm-6 required">
																						<label class="labelStylereq"
																							style="color: #56a5ec;">Validity </label>
																						<div class="calImage">
																							<s:textfield cssClass="form-control  "
																								id="validity" type="dropdown" name="validity"
																					...
																					<div class="col-sm-12">
																						<label class="labelStylereq"
																							style="color: #56a5ec;">Comments </label>
																						<s:textarea cssClass="form-control"
																							maxLength="250" id="attachmentComments"
																							name="attachmentComments" placeholder="Comments"
																							value=""
																							onkeyup=" CheckRemainingAttachCharacters(this)" />

																					</div>
																					<div class="charNum pull-left"
																						id="charRemainAttach"></div>
																				</div>
																			...
																			<div class="inner-reqdiv-elements">
																				<div class="row">
																					...
																					<div class="col-sm-3 pull-right">
																						<s:submit id="saveVendorForm"
																							cssStyle="margin:5px 0px;"
																							cssClass=" add_searchButton form-control col-sm-offset-10 btn cssbutton"
																							value="" type="button"
																							onclick="return addVendorFormDetails()">
																							<i class="fa fa-floppy-o"></i>&nbsp;Save</s:submit>
																					</div>
																				</div>
																			</div>
																...
																<div id="editAttachmentBox" class="marginTasks">
																	<div class="backgroundcolor">
																		<table>
																			<tr>
																				<td><h4 style="font-family: cursive">
																						<font class="titleColor">&nbsp;&nbsp;Edit
																							Attachment&nbsp;&nbsp; </font>
																					</h4></td>
																				<span class="pull-right">
																					<h5>
																						&nbsp;&nbsp;&nbsp;&nbsp;<a href=""
																							class="editAttachment_popup_close"
																							onclick="vendorFormOverlayEdit();"><i
																							class="fa fa-times-circle-o fa-size"></i></a>
																					</h5>
																				</span>
																		</table>
																	...
																	<s:form action="updateVendorFormAttachments"
																		theme="simple" enctype="multipart/form-data"
																		onsubmit="return checkAttachmentValidation();">
																		<div>

																			<s:hidden name="viewAccountID" id="viewAccountID"
																				value="%{accountSearchID}" />
																			<s:hidden name="attachment_id_edit"
																				id="attachment_id_edit" value="" />
																			<div class="inner-reqdiv-elements">
																				<div class="row">
																					<div class="col-lg-6 required">
																						<label class="labelStylereq"
																							style="color: #56a5ec;">Name </label>
																						<s:textfield cssClass="form-control"
																							placeholder="Name" id="editTitle"
																							name="editTitle" value="" maxLength="200" />
																					</div>
																					...
																					<div class="col-lg-6 required">
																						...
																						<div class="calImage">
																							<s:textfield cssClass="form-control  "
																								id="editValidity" name="editValidity"
																								type="dropdown"
																								onkeypress="return enterDateRepositoryAttachment();"
																								onfocus="return removeFormErrorMsg();"
																				...
																				<div class="row">
																					<div class="col-lg-12 ">
																						<label class="labelStylereq"
																							style="color: #56a5ec;">Comments </label>
																						<s:textarea cssClass="form-control "
																							id="editattachmentComments"
																							name="editattachmentComments"
																							placeholder="Comments" maxLength="250" value=""
																							onkeyup=" CheckRemainingEditAttachCharacters(this)" />

																					</div>
																					<div class="charNum pull-right"
																						id="charRemainEditAttach"></div>
																				</div>
																			</div>
																			<div class="inner-reqdiv-elements">
																				<div class="row">
																...
																<div id="preskillBox" class="marginTasks">
																	<div class="backgroundcolor">
																		<table>
																			<tr>
																				<td><h4 style="font-family: cursive">
																						<font class="titleColor">&nbsp;&nbsp;Preferred
																							Skill Details&nbsp;&nbsp; </font>
																					</h4></td>
																				<span class="pull-right">
																					<h5>
																						&nbsp;&nbsp;&nbsp;&nbsp;<a href=""
																							class="preSkillOverlay_popup_close"
																							onclick="preferredSkillOverlay()"><i
																							class="fa fa-times-circle-o fa-size"></i></a>
																					</h5>
																				</span>
																		</table>
																...
																<div id="recruiterBox" class="marginTasks">
																	<div class="backgroundcolor">
																		<table>
																			<tr>
																				<td><h4 style="font-family: cursive">
																						<font class="titleColor">&nbsp;&nbsp;Recruiter
																							contact Information&nbsp;&nbsp; </font>
																					</h4></td>
																				<span class="pull-right">
																					<h5>
																						&nbsp;&nbsp;&nbsp;&nbsp;<a href=""
																							class="recruiterOverlay_popup_close"
																							onclick="closeRequirementOverlay()"><i
																							class="fa fa-times-circle-o fa-size"></i></a>
																					</h5>
																				</span>
																		</table>
																	...
																	<div>
																		<center>
																			<table>
																				...
																				<s:textfield label="Phone"
																					cssClass="form-control margin"
																					id="recruiterPhoneOverlay" />
																			</table>
																		</center>
																	</div>
																	<font style="color: #ffffff">.....................
															...
															<div id="contactLoginOverlay_popup" style="width: 30%">
																<div id="contactLoginBox" class="marginTasks">
																			...
																			<tr>
																				<td><h4 style="font-family: cursive">
																						<font class="titleColor">&nbsp;&nbsp;
																							Contact Login Credentials&nbsp;&nbsp; </font>
																					</h4></td>
																				<span class="pull-right">
																					<h5>
																						&nbsp;&nbsp;&nbsp;&nbsp;<a href=""
																							class="contactLoginOverlay_popup_close"
																							onclick="contactOverlayLogin();
                                                                                        getContactSearchResults();"><i
																							class="fa fa-times-circle-o fa-size"></i></a>
																					</h5>
																				</span>
																		</table>
																	...
																	<div>
																		...
																		<div class="pull-left ">
																			<s:submit type="button"
																				cssClass="cssbutton contactLoginOverlay_popup_close fa fa-times"
																				style="margin:6px 30px" id="contactCancel"
																				onclick="contactOverlayLogin()" value="Cancel" />
																		</div>
																		<div class="pull-right" style="margin-right: 30px">

																			<s:submit type="button"
																				cssClass="cssbutton fa fa-paper-plane"
																				id="contactSend" value="Send"
																...
																<div id="csraccoutsoverlay" class="marginTasks">
																	<div class="backgroundcolor">
																		<table>
																			<tr>
																				<td><h4 style="font-family: cursive">
																						<font class="titleColor">&nbsp;&nbsp; CSR
																							Status&nbsp;&nbsp; </font>
																					</h4></td>
																				<span class="pull-right">
																					<h5>
																						&nbsp;&nbsp;&nbsp;&nbsp;<a href=""
																							class="csraccountspopup_close"
																							onclick="csraccountspopupclose()"><i
																							class="fa fa-times-circle-o fa-size"></i></a>
																					</h5>
																				</span>
																		</table>
																	...
																	<div>
																		...
																		<div class="inner-reqdiv-elements">
																			...
																			<s:select id="csrStatusOverlay"
																				name="csrStatusOverlay"
																				cssClass="SelectBoxStyles form-control "
																				theme="simple"
																				list="#@java.util.LinkedHashMap@{'Active':'Active','Inactive':'Inactive'}" />
																		...
																		<div class="col-sm-12">
																			...
																			<s:submit type="button"
																				cssClass="cssbutton fa fa-floppy-o"
																				id="csrSaveButton" value="Save"
																				onclick="csrStatusChange()" />
	...
	<script type="text/javascript">
		...
		if (flag == "proSearch") {
			...
			javascript: ajaxReplaceDiv('/getAccountProjects', '#projects',
					'accountID=' + orgId);
		}
		if (flag == "reqSearch") {
		...
		if (flag == "venSearch") {
			...
			document.getElementById("headingmessage").innerHTML = 'Vendor Tier'
					+ "'"
					+ 's <i  class="fa fa-angle-up" id="updownArrowAccount" onclick="toggleContentAccount(\'vendorDiv\')" style="margin-top: 0vw;position:absolute;color:#56a5ec"> </i> ';
...
// 			getVendors();
	...
	<script type="text/javascript">
		...
		function pagerOption() {
			...
			var paginationSize = document
					.getElementById("paginationOption_cnt").value;
	...
	<script type="text/javascript">
		...
		function Loc_pagerOption() {
			...
			var paginationSize = document
					.getElementById("loc_paginationOption").value;
			if (isNaN(paginationSize))
				recordPage = paginationSize;
			alert(recordPage)
...
<script type="text/javascript"
	...
	<script type="text/javascript">
		...
		function accpagerOption() {
			...
			recordPage = paginationSize;
			$('#reqTableInAccount').tablesPaginate({
				navigateType : 'navigator'
			}, recordPage,reqTableInAccount);
	...
	<script type="text/javascript">
		...
		function vendor_pagerOption() {
			var paginationSize = document
					.getElementById("vendor_paginationOption").value;
			if (isNaN(paginationSize)) {

			}
			recordPage = paginationSize;

			$('#vendorTierTable').tablePaginate({
				navigateType : 'navigator'
			}, recordPage);
