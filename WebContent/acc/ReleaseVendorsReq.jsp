...
<html>
 ...
 <script type="text/JavaScript" src="<s:url value="/includes/js/jquery.js"/>"></script>
    ...
    <body style="overflow-x: hidden" oncontextmenu="return false"  onload="getReqReleaseVendorsListForCsr();">
        <div id="wrap">
                ...
                <div class="row">
                    ...
                    <!-- Model popup -->
                        ...
                        <div class="col-sm-12 col-md-9 col-lg-9 right_content" style="background-color:#fff">
                            ...
                            <s:label value = "All Vendors" cssClass="textLabel-i"/>
                              </div>
                                                    ...
                                                    <div class="">
                                                        ...
                                                        <div class="col-sm-4 pull-right">
                                                                ...
                                                                <div class="col-sm-6 pull-right">
                                                                    ...
                                                                    <input type="button"  class="add_searchButton form-control " id="searchButton" value="search" tabindex="3" style="margin:-10px 0px;" onclick="getReleaseVendorsListForCsr()"/>
