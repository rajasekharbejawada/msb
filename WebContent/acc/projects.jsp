        ...
        <div id="addProject_popup" class="overlay" style="width:75%">
            <div id="addProjectOverlay">
                ...
                <div style="width:fit-content">
                        ...
                        <div>
                            <div class="inner-addtaskdiv-elements">
                              ...
                              <%--   <div class="col-sm-4">
                                 ...
                                 <s:hidden id="projectWorkedHrs"   name="projectWorkedHrs" value="0.0" />                    
                                <div class="col-sm-4 required "> 
                                    <label>Cost&nbsp;Center</label><s:select  id="costCenterName"  name="costCenterName" cssClass="form-control SelectBoxStyles "  list="%{costCenterNames}"  headerValue="Select Cost Center" headerKey="DF" cssStyle="margin-right:50px" onfocus="clearFieldValues()"/>
                                </div>

                                <div class="col-sm-12">
                                    <label class="" style="width: 150px;padding: 0;margin-left: 1px">Required&nbsp;Skill&nbsp;Set</label><s:textarea  cssClass="form-control" id="projectReqSkillSetPopup" type="text" name="projectReqSkillSet" placeholder="Enter Required Skill Set Here" value="%{projectReqSkillSet}" onkeydown="checkCharactersSkill(this)" onblur="removeMsg()" onfocus="clearFieldValues()"/>

                                    <div class="charNum" id="charNumSkill"></div>
                                </div>
                                <div class="col-sm-12">
                                    <label class="labelStyle">Description</label><s:textarea id="project_descriptionPopup" name="project_description" placeholder="Enter Project Description Here" cssClass="form-control" value="%{project_description}" onkeydown="checkCharactersProjects(this)" onblur="removeMsg()" onfocus="clearFieldValues()"/>
                    ...
                    <div  class="col-sm-12" style="text-align: right;margin-left:-19px">
                        ...
                        <s:submit type="button" id="addProjectButton" cssClass="cssbutton fa fa-plus-square" value="Save" theme="simple" onclick="addProjectValidation();addProject();"/>
                    </div>
                </div>
            </div>
        </div>
