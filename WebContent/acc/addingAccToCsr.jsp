                                        ...
                                        <div class="inner-reqdiv-elements">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4">
                                                    ...
                                                    <s:select id="csrStatus" name="csrStatus" cssClass="SelectBoxStyles form-control "   theme="simple" list="#@java.util.LinkedHashMap@{'Active':'Active','Inactive':'Inactive'}"  disabled="true" tabindex="3"/>
                                                </div>
