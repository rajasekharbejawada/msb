                                                                    ...
                                                                    <div class="inner-addtaskdiv-elements">
                                                                        ...
                                                                        <s:if test="%{projectFlag!='addMember'}">
                                                                            <div class="col-sm-4">
                                                                                ...
                                                                                <label>Status</label><s:select  id="teamMemberStatusPopup"  name="teamMemberStatus" cssClass="form-control SelectBoxStyles "  headerValue="Select status" theme="simple" list="{'Active','Inactive'}" value="%{account.teamMemberStatus}" tabindex="3" />
                                                                            </div>
                                                                        </s:if>
                                                                        <s:else>
