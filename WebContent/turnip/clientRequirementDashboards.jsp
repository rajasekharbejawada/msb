<%-- 
    Document   : clientRequirementDashboards
    Created on : 22 Sep, 2016, 6:45:19 PM
    Author     : Jitendra Singh Dhakar
--%>
...
<html>
    <head>
        ...
        <title>ServicesBay :: Client Requirement Page</title>
        ...
        <script>
            ...
            function vendorResourceDashboard(){
                ...
                pager = new Pager('clientResourceDashboardResults', paginationSize);
                pager.init();
    ...
    <body style="overflow-x: hidden" oncontextmenu="return false" onload="getClientResourceList(); getRegionResourcesList()">
        <div id="wrap">
                                ...
                                <div class="features_items">
                                            ...
                                            <div class="backgroundcolor" >
                                                <div class="panel-heading">
                                                    <h4 class="panel-title">
                                                        ...
                                                        <i id="updownArrow" onclick="toggleContent('customerDashboardForm')" class=""></i> 
                                                    </h4>
                                                </div>
                                            </div>
                                            <span> <br/></span>
                                                ...
                                                <s:form>
                                                    <s:hidden id="accountSearchID" value="%{id}" ></s:hidden>
                                                        <div class="emp_Content" id="emp_div" align="center" style="display: none"    >
                                                            <table id="clientResourceDashboardResults" class="responsive CSSTable_task" border="5">
                                                                <tbody>
                                                                    <tr>
                                                                    <%--<th>Req.Won</th>
                                                                        <th>Req.Lost</th> --%>
                                    ...
                                    <div class="col-sm-12" >
                                        <div class="col-lg-12 panel panel-default panel-heading">
                                            ...
                                            <s:hidden name="barColor" id="barColor"/>
                                            <div id="selectResourceRange" style="display:none" >
                                                <select id="resourceRange" class="disPlayRecordsCss" onchange="getClientResourceListByRange()" style="width: auto">
                                                </select>
                                            </div>
                                            <div id="clientResourceChart"></div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12" style="display: none" id="subClientDiv">
                                        <div class="col-lg-12 panel panel-default panel-heading">
                                            <i class="fa fa-bar-chart-o fa-fw"></i>Bar chart<div align="center"><span id="subClientTitle"></span></div>
                                            <br>
                                            <span id="subProjectsnorecords"></span>
                                            <div id="subClientRequirementChart"></div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12" >
                                        <div class="col-lg-12 panel panel-default panel-heading">
                                            <i class="fa fa-bar-chart-o fa-fw"></i>Bar Chart<div align="center"><span id="chartRegionTitle"></span></div>
                                            <div id="RegionResourceChart"></div>
                                        </div>
                                    </div>
        ...
        <script type="text/javascript">
            ...
            function pagerOption(){
                ...
                // alert(recordPage)
                $('#clientResourceDashboardResults').tablePaginate({navigateType:'navigator'},recordPage);
