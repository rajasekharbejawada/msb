...
<script type="text/JavaScript"
	src="<s:url value="/includes/js/Ajax/ajaxfileupload.js"/>"></script>
<script type="text/javascript"
	src="<s:url value="/includes/js/Ajax/TaskAjax.js"/>"></script>
<script type="text/javascript"
	src="<s:url value="/includes/js/Ajax/dashboard.js"/>"></script>
<script type="text/javascript"
...
<body onload="doOnLoad(); init(); getTaskType(); "
									...
									<div class="col-lg-14">
										<div class="panel panel-info">
											<div class="panel-heading" id="taskedit-heading">
												<font class="titleColor">&nbsp;&nbsp;&nbsp;Edit Task
												</font>
												<s:if test="myTask=='mytaskflag'">
													<span class="pull-right"><a
														href="doTasksSearch.action" id="editTaskSearchBackButtton"
														style="margin-right: 9px"><i class="fa fa-undo"></i></a></span>
												</s:if>
												<s:else>
													<span class="pull-right"><a
														href="doTeamTasksSearch.action"
														id="editTaskSearchBackButtton" style="margin-right: 9px"><i
                                            ...
                                            <br>
												<%-- <ul class="active_details">
													<li class="dropdown"><a class=" active_details "
														...
														<ul class="active_details dropdown-menu  "
															...
															<li class="  "><a aria-expanded="false"
																href="#messages" data-toggle="tab" id="messagesLi"
																onclick="headingMessage(this);
                                                                                    unlockScreen();"
																style="background-color: #fff; width: 40px; cursor: pointer;"><i
																	class="fa fa-sticky-note-o" style="color: #2081c1;">
																</i><font style="color: blue">&nbsp;Notes </font></a></li>
												...
												<div class="tab-content">
													<div class="tab-pane fade in active" id="home">
														...
														<form theme="simple">
															<div>
																<br> <span id="editTaskValidate"><editTask></editTask></span>
																<span><UpdateTaskInfo></UpdateTaskInfo></span>
																<div class="inner-reqdiv-elements">
																	<div class=" ">
																		<div class="col-sm-4 required">
																			<label class="labelStylereq" style="color: #56a5ec;">StartDate
																			</label>
																			<div class="calImage">
																				<s:textfield cssClass="form-control "
																					name="startDate" id="start_date"
																					value="%{tasksVto.start_date}" tabindex="1"
																					onkeypress="return enterTaskDateRepository(this)">
																					<i class="fa fa-calendar"></i>
																				</s:textfield>
																				<s:hidden name="taskid" value="%{taskid}"
																					id="taskid" />
																				<s:hidden id="addTaskPage" value="1"
																					name="addTaskPage" />
																			</div>
																		</div>
																		<div class="col-sm-4 required">
																			<label class="labelStylereq" style="color: #56a5ec;">EndDate
																			</label>
																			<div class="calImage">
																				<s:textfield cssClass="form-control " name="endDate"
																					id="end_date" value="%{tasksVto.end_date}"
																					tabindex="2"
																					onkeypress="return enterTaskDateRepository(this)">
																					<i class="fa fa-calendar"></i>
																				</s:textfield>
																		...
																		<div class="col-sm-4 ">
																			...
																			<s:select id="task_status" name="taskStatus"
																				cssClass="SelectBoxStyles form-control"
																				headerKey="-1" theme="simple" list="tasksStatusList"
																				tabindex="3" value="%{tasksVto.task_status}" />
																		</div>
																	</div>
																</div>
																<div class="inner-reqdiv-elements">
																	<div class=" ">
																		<div class="col-sm-4">
																			<label class="labelStylereq" style="color: #56a5ec;">Priority
																			</label>
																			<s:select id="taskPriority" name="priority"
																				cssClass="SelectBoxStyles form-control"
																				headerKey="M" headerValue="Medium" theme="simple"
																				tabindex="4"
																				list="#@java.util.LinkedHashMap@{'L':'Low','H':'High'}"
																				value="%{tasksVto.task_priority}" />
																		</div>
																		<div class="col-sm-4">
																			<label class="labelStylereq" style="color: #56a5ec;">Related
																				To </label>
																			<s:select id="taskRelatedTo" name="taskRelatedTo"
																				cssClass="SelectBoxStyles form-control"
																				headerKey="-1" theme="simple"
																				list="tasksRelatedToList"
																				onchange="changeTaskType();" tabindex="5"
																				value="%{tasksVto.task_related_to}" />
																			<s:hidden name="taskid" value="%{taskid}" id="taskid" />
																		</div>
																		<div class="col-sm-4" id="csrDiv">
																			<label class="labelStylereq" style="color: #56a5ec;">Projects
																			</label>
																			<s:select id="taskType" name="taskType"
																				cssClass="SelectBoxStyles form-control"
																				headerKey="-1" theme="simple"
																				list="%{tasksVto.typeMaps}"
																				value="%{tasksVto.task_prj_related_to}" tabindex="6"
																				onchange="changeProject();" />
																			<s:hidden name="taskProject"
																				value="%{tasksVto.task_prj_related_to}"
																				id="taskProject" />
																		</div>
																	</div>
																</div>
																<div class="inner-reqdiv-elements required">
																	<div class="col-sm-12">
																		...
																		<s:textfield name="taskName" id="task-textform"
																			placeholder="Enter Title Here"
																			cssClass="form-control"
																			value="%{tasksVto.task_title}" tabindex="7"
																			maxLength="60" />
																	</div>
																</div>
																<div class="inner-reqdiv-elements">
																	<div class="col-sm-12">
																		...
																		<s:textarea name="task_comments" id="task_comments"
																			placeholder="Enter Task Description Here"
																			cssClass="form-control"
																			value="%{tasksVto.task_comments}"
																			onkeypress="checkEditTaskDescription(this)"
																			tabindex="8" maxLength="60"
																			onblur="clearDescriptionSpan()" />
																	</div>
																</div>
																...
																<div class="inner-reqdiv-elements">
																	<div class="col-sm-13">
																		<s:if
																			test="#session.primaryrole==7 || #session.primaryrole==11">
																			<div class="col-sm-4">
																				<label class="labelStylereq" style="color: #56a5ec;">Primary
																					AssignTo </label>
																				<s:select id="primary_assign" disabled="true"
																					name="primaryAssign"
																					cssClass="SelectBoxStyles form-control"
																					headerKey="-1" theme="simple"
																					list="teamMemberNames" tabindex="9"
																					value="%{tasksVto.pri_assigned_to}" />
																				<s:hidden name="secondaryId" id="secondaryId"
																					value="%{tasksVto.sec_reportsId}" />
																				<s:hidden name="primaryId" id="primaryId"
																					value="%{tasksVto.pri_assigned_to}" />
																			</div>

																			<div class="col-sm-4">
																				<label class="labelStylereq" style="color: #56a5ec;">Secondary
																					AssignTo</label>
																				<s:textfield id="secondaryReport" disabled="true"
																					name="sec_assign_to"
																					placeholder="SecondaryAssignTo"
																					cssClass="form-control" theme="simple"
																					onkeyup="return getSecondaryAssignedNames();"
																					value="%{tasksVto.sec_assigned_to}"
																					autocomplete='off' tabindex="10" maxLength="30" />
																			</div>
																		</s:if>
																		<s:else>
																			<div class="col-sm-4">
																				<label class="labelStylereq" style="color: #56a5ec;">Primary
																					AssignTo </label>
																				<s:select id="primary_assign" name="primaryAssign"
																					cssClass="SelectBoxStyles form-control"
																					headerKey="-1" theme="simple"
																					list="teamMemberNames" tabindex="9"
																					value="%{tasksVto.pri_assigned_to}" />
																			...
																			<div class="col-sm-4">
																				<label class="labelStylereq" style="color: #56a5ec;">Secondary
																					AssignTo</label>
																				<s:hidden id="secondaryAssign"
																					value="%{tasksVto.sec_assigned_to}" />
																				<s:textfield id="secondaryReport"
																					name="sec_assign_to"
																					placeholder="SecondaryAssignTo"
																					cssClass="form-control" theme="simple"
																					onkeyup="return getSecondaryAssignedNames();"
																...
																<div class="col-sm-2 pull-right">
																	<s:submit type="button" cssStyle="margin:5px 0px;"
																		...
																		onclick="return doUpdateTaskInfo();">
														...
														<div id="taskAttachOverlay">
															<div class="overlayOrButton_color">
																<table>
																	<tr>
																		<td style=""><h4>
																				<font color="#ffffff">&nbsp;&nbsp;Task
																					Attachment Upload&nbsp;&nbsp; </font>
																			</h4></td>
																		<td style=""><span class=" pull-right"><h5>
																					<a href="" class="taskAttachments_popup_close"
																						onclick="attachementPopUp()"><i
															...
															<div>
																<br> <span id="upaloadMessages"></span>
																<s:form action="addAttachment" theme="simple"
																	enctype="multipart/form-data"
																	onsubmit="return attachmentUploadValidation();">
																	<div>
																		<div class="inner-addtaskdiv-elements">
																	   
																			<s:hidden id="downloadFlag" name="downloadFlag"
																				value="%{downloadFlag}" />
																		...
																		<center>
																			<s:submit type="button"
																				cssClass="cssbutton fa fa-upload" value="Upload"
																				theme="simple" />
																		</center>
																		<br>
																	</div>
													...
													<div class="tab-pane fade" id="profile"
														onload="getTaskAttachments.action">
																...
																<div class="row">
																	...
																	<div class="col-sm-9 padding-right">
																		<div class="features_items">
																			...
																			<!-- <h4 align="left">Task Attachments</h4> -->
																			...
																			<div class="logcontainer paginated" id="log_grid_1">
																				<div
																					class="logrow grid cs-style-7 log_grid_1_record"
																					id="mainAttachmentDiv">
																					<%
																						int c = 0;
																					...
																					<div class="logcol">
																						...
																						<figcaption>
																							<a
																								href="javascript:doDeactiveAttachment('<%=id%>')">
																								<img src="../../includes/images/close_trans.png"
																								height=25 width=25>
																							</a> <br> <br><%=file_name%><br> <br>
																							<button type="button" id="<%=id%>"
																								value="<%=file_path%>" onclick="doDownload('<%=id%>');">
																								<img src="../../includes/images/download.png"
																									height=65 width=65>
																							</button>
																						</figcaption>
																					</div>
																					...
																					<div class="logcol logclr">
																						<br> <font
																							style="color: red; font-size: 15px;">No
																							Records to display</font> <br> <br>&nbsp;&nbsp;<a
																							href="" id="addAttachmentPopUpButtton"
																							class="taskAttachments_popup_open"><button
																								type="button" onclick="attachementPopUp()">
																								<img
																									src="<s:url value="/includes/images/add3.png"/>"
																									height="65" width="65">
																							</button></a>
																					</div>
																					<%
														...
														<section id="generalForm">
															...
															<div class="" style="background-color: #fff">
																<div class="features_items">
																	<div class="">
																		<div class="" id="profileBox"
																			style="float: center; margin-top: 5px">
																			...
																			<div class="col-lg-12 ">
																				<s:form action="" theme="simple">
																					...
																					<div class="inner-reqdiv-elements">
																							...
																							<div>
																								<div class="col-sm-4">
																									<label class="labelStylereq "
																										style="color: #56a5ec;">Notes Name</label>
																									<s:textfield cssClass="form-control"
																										name="notes" id="notes_NameSearch"
																										placeholder="Notes" onclick="clearResultMsg()"
																										maxLength="60" tabindex="1" />
																								</div>
																								<div class="col-sm-1">

																									<s:hidden cssClass="form-control "
																										id="notes_id" name="notes_id"
																										placeholder="Notes_Id"
																										onclick="clearResultMsg()" maxLength="11" />
																								</div>
																								<div class="col-sm-4">
																									<div class="row">
																										<div class="col-sm-6 pull-right">
																											...
																											<s:submit type="button"
																												...
																												onclick="clearResultMsg();return getNotesDetailsBySearch()"
																												cssStyle="margin:5px 0px;" tabindex="2">
																												<i class="fa fa-search"></i>&nbsp;Search</s:submit>
																										</div>
																										<div class="col-sm-6 pull-right">
																											<label class="labelStylereq"
																												style="color: #56a5ec;"></label> <a href=""
																												class="Note_popup_open" id="addNotesOverlay"><button
																													type="button"
																													class="add_searchButton form-control"
																													value="" style="margin: 5px 0px;" 
																													onclick="clearNotesFields();" tabindex="3">
																						...
																						<div id="loadingTask" class="loadingImg"
																							style="display: none">
																			...
																			<div class="col-lg-12">
																				<div id="task_notes_populate"
																					style="padding-top: 8px; width: 100%"></div>
																				<div id="task_pageNavPosition" align="right"
																...
																<label class="page_option"> Display <select
																	id="paginationOption_T" class="disPlayRecordsCss"
																			...
																			<table>
																				<tr>
																					...
																					<span class=" pull-right"><h5>
																							<a href="" id="closeNoteOverlayButton"
																								class="Note_popup_close"
																								onclick="removeResultMsg()"><i
																								class="fa fa-times-circle-o fa-size"></i></a>&nbsp;
																						</h5></span>
																			</table>
																		</div>
																			...
																			<s:form action="" theme="simple"
																				...
																				<div>
																					...
																					<div class="inner-addtaskdiv-elements required">
																						<label style="color: #56a5ec;" class="task-label">&nbsp;Notes&nbspName&nbsp;</label>
																						<s:textfield name="noteNames" id="noteNamesadd"
																							placeholder="Notes Name" cssClass="form-control"
																							maxLength="60" />
																						<label style="color: #56a5ec;" class="task-label">&nbsp;Description&nbsp;</label>
																						<s:textarea name="noteComments"
																							id="noteCommentsadd" placeholder="Notes Description"
																							cssClass="form-control" />
																					</div>
																					<div class="col-lg-6"></div>
																					<div class="col-sm-3 pull-right">
																						<s:submit type="button" id="addNoteButton"
																							cssClass="add_searchButton form-control"
																							cssStyle="margin:5px 0px;" value=""
																							theme="simple" onclick="return addNotesDetails()">
																							<i class="fa fa-plus-square"></i>&nbsp;Save</s:submit>


																					</div>
																					<div class="col-sm-3 pull-right">
																						<s:reset type="button" id="resetClearButton"
																							cssClass="add_searchButton form-control fa fa-eraser "
																							cssStyle="margin:5px 0px;" value="Clear"
																							theme="simple" />
																					</div>
																		...
																		<div class="overlayOrButton_color">
																			<table>
																				<tr>
																					...
																					<span class=" pull-right"><h5>
																							<a href="" class="notes_popup_close"
																								onclick="removeResultMsg()"><i
																								class="fa fa-times-circle-o fa-size"></i></a>&nbsp;
																						</h5></span>
																			</table>
																				...
																				<div>
																					...
																					<form>
																						<div class="inner-addtaskdiv-elements required">
																							...
																							<s:textfield name="noteNames" id="noteNames"
																								cssClass="form-control" placeholder="Notes Name" maxLength="60" />
																							<label style="color: #56a5ec;" class="task-label">&nbsp;Description&nbsp;</label>
																							<s:textarea name="noteComments" id="noteComments" placeholder="Notes Description"
																								cssClass="form-control" />
																						</div>

																						<div class="col-sm-3 pull-right">
																							<s:submit type="button" id="updateTaskButton"
																								cssStyle="margin:5px 0px;"
																								cssClass="add_searchButton form-control"
																								value="" theme="simple"
																								onclick="return updateNoteDetails()">
...
<script type="text/javascript">
     // alert("alert in tabflag script");
		var flag = document.getElementById("tabFlag").value;
       //alert(flag);
       //console.log("flag value of tab");
		if (flag == "attachmentTab") {
			document.getElementById('profile').className = 'tab-pane fade in active';
			document.getElementById('home').className = 'tab-pane fade ';
			document.getElementById('messages').className = 'tab-pane fade ';
			headingMessage(profileLi);
		}
	</script>
	<script type="text/javascript"
