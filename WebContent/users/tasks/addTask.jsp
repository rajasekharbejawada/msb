                                        ...
                                        <div class="" id="profileBox" style="float: left; margin-top: 5px">
                                            ...
                                            <s:form action="addNewTask"  theme="simple" onsubmit="return addTaskValidation()"  enctype="multipart/form-data" >
                                                ...
                                                <div>
                                                    ...
                                                    <div class="inner-reqdiv-elements">
                                                        <div class="col-sm-12">
                                                            <label class="labelStylereq">Description</label><s:textarea name="task_comments" id="task_comments" placeholder="Enter Task Description Here" cssClass="form-control" onkeyup="checkTaskDescription(this)" onblur="clearDescriptionSpan()"/>
                                                        </div>
                                                    </div>
