                                        ...
                                        <div id="timesheetMisc_Overlay">
                                            ...
                                            <form action="#" theme="simple" >
                                                ...
                                                <div class="col-md-6 pull-right">
                                                    <button id="timesheetMiscellaneousGo"  type="button" style="margin: 5px 0px;"  class="add_searchButton form-control timesheetMisc_popup_close"  value="" onclick="return miscellaneousData()">&nbsp;Go&nbsp;&nbsp;<i class="fa fa-arrow-circle-o-right"></i></button>&nbsp; 
                                                </div>
                                            </form>
