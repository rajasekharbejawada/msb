                                                ...
                                                <s:form action="getAllTimeSheetsSearch" onsubmit="return checkTimesheetDateRange();" theme="simple" >
                                                    ...
                                                    <ul class="nav nav-pills">
                                                        ...
                                                        <div class="col-sm-4">
                                                            ...
                                                            <s:select id="status" name="status" cssClass="SelectBoxStyles form-control" headerKey="-1" headerValue="Select Status" theme="simple" list="#@java.util.LinkedHashMap@{'Active':'Active','Inactive':'Inactive'}" tabindex="5" />
                                                        </div>
