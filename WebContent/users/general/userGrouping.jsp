                                        ...
                                        <div class="inner-reqdiv-elements">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-3 required">
                                                    ...
                                                    <s:select id="usrCatType" name="usrCatType" cssClass="SelectBoxStyles form-control " headerKey="-1" headerValue="Select Status"  value="%{usrCatType}"  theme="simple" list="%{usrCategory}" onchange="getCategoryList()" onfocus="clearErrosMsgForGrouping()"/>
                                                </div>
                                                <s:if test="groupingId!=0">
                                                    <div class="col-sm-3 required">
                                                        <label class="labelStylereq" style="color:#56a5ec">Status</label>
                                                        <s:select id="usrStatus" name="usrStatus" cssClass="SelectBoxStyles form-control " headerKey="-1" headerValue="Select Status"  value="%{usrStatus}"  theme="simple" list="#@java.util.LinkedHashMap@{'Active':'Active','Inactive':'Inactive'}"  onfocus="clearErrosMsgForGrouping()" />
                                                    </div>  
                                                </s:if>
                                                <s:else>
