                                            ...
                                            <div class="inner-reqdiv-elements">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        ...
                                                        <s:select cssClass="SelectBoxStyles form-control" tabindex="1" name="status" id="status" list="#@java.util.LinkedHashMap@{'Active':'Active','Inactive':'Inactive'}" value="%{homeVto.status}"/>
                                                    </div>
                                            ...
                                            <div class="inner-reqdiv-elements">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <s:if test="homeRedirectActionId!=0">
                                                        <div class="col-sm-3">
                                                            <label class="labelStylereq" style="color: #56a5ec">Status</label>
                                                            <s:select cssClass="SelectBoxStyles form-control" tabindex="4" name="accountType" id="accountType" list="#@java.util.LinkedHashMap@{'Active':'Active','Inactive':'Inactive'}" value="%{homeVto.status}"/>
                                                        </div>
                                                    </s:if>
