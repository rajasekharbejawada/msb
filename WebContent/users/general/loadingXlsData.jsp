...
<html>
    ...
    <head>
        ...
        <title>ServiceBay :: Import Logger Page</title>
                                            ...
                                            <div class="backgroundcolor" >
                                                <div class="panel-heading">
                                                    <h4 class="panel-title">
                                                        ...
                                                        <font color="#ffffff">Import&nbsp;Logger</font>
                                                ...
                                                <s:form action="searchLogger" theme="simple" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-3">
                                                            ...
                                                            <s:select id="status" cssClass="form-control SelectBoxStyles " name="status" list="#@java.util.LinkedHashMap@{'DF':'Please Select','Success':'Success','Failed':'Failed'}"></s:select>
                                                            </div>  
