								...
								<div class="">
									<div class="features_items">
										...
										<div class="" id="profileBox"
											...
											<font id="resMessage" style="color: green; font-size: 12px;"><s:property
													value="#request.resultMessage" /></font> <span><resetMessage></resetMessage></span>
											<div class="password_box">
												<!--login form-->

												<form id="ResetPassword" action="resetMyPassword"
													...
													<div class="required">
														...
														<div class="col-lg-6 col-sm-6 req_margin">
															<s:password name="curPwd" cssClass="form-control"
																id="curPwd" placeholder="Current Password"
																required="true"
																pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}"
																onchange="matchCurrentPassword()"
														...
														<div class="col-lg-6 col-sm-6 req_margin">
															<s:password name="newpwd" cssClass="form-control"
																id="pwd1" placeholder="New Password" required="true"
																pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}"
																onchange="form.cnfrmpwd.pattern=this.value"
																title="Password must contain at least 6 characters, including UPPER/lowercase and numbers"
																tabindex="2" />
														</div>
														...
														<div class="col-lg-6 col-sm-6 req_margin">
															<s:password name="cnfrmpwd" cssClass="form-control"
																id="pwd2" placeholder="Confirm Password" required="true"
																pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}"
																oninvalid="setCustomValidity('Please enter the same Password as above')"
														...
														<div class="col-lg-4 col-sm-4 req_margin pull-right" style="margin-right:-10px">
															<%--
															 <div class="col-sm-5 req_margin pull-right">

																<div align="right">
																	<button id="reset" type="reset" value="Cancel"
																		tabindex="5"
																		class="cssbutton req_margin align_left  fa fa-times"
															...
															<button type="submit" id="submit" value="Submit"
																		tabindex="4"
																		class="cssbutton fa fa-check-circle-o">&nbsp;Submit</button>
