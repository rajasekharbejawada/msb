                            ...
                            <div class="col-sm-12 col-md-9 col-lg-9 right_content" style="background-color:#fff">
                               ...
                               <%--  <ul class="active_details" >
                                ...
                                <ul class="nav nav-tabs">
									<li class="active"><a aria-expanded="false" onclick=" getCustomerRequirementsDashBoard(); dashboardMessage(this);" id="customerBoard"  href="#Customer" data-toggle="tab"> Customer Dashboard</a>
									</li>
								<li class=""><a aria-expanded="false" onclick="getVendorRequirementsDashBoard(); dashboardMessage(this); " id="vendorBoard"  href="#Vendor" data-toggle="tab">Vendor Dashboard </a>
                               </li>                               
                                </ul>
                                <br>
