...
<script type="text/javascript">
	...
	function doOnLoad() {
		...
		var today = new Date();
		var maxPastDate = new Date(today.getFullYear() - 3, today.getMonth(),
				today.getDate());
									...
									<div class="" id="profileBox"
											...
											<div class="panel-heading">
												<h4 class="panel-title">
													...
													<font color="#ffffff">Vendor Search</font> <i
														id="updownArrow"
														onclick="toggleContent('vendorDashboardSearch')"
										...
										<div class="col-sm-12">
											<s:form theme="simple" id="vendorDashboardSearch">
												<s:hidden name="vendorFlag" id="vendorFlag"
													value="%{vendorFlag}" />
												<br>
												<div class="row">
													<div class="col-sm-4">
														<s:textfield cssClass="textbox" label="VendorName"
												...
												<div class="row">
													<div class="col-sm-4">
														<s:select id="VendorCountry" type="dropdown"
															...
															list="%{countryNames}" label="VendorCountry"
															headerKey="-1" headerValue="Vendor country "
															cssClass="selectBoxStyle" onchange="return getStates()" />
													</div>
													<div class="col-sm-4">
														<s:select id="VendorState" type="dropdown"
															name="VendorState" placeholder="State" list="{}"
															label="State" headerKey="-1" headerValue="Select State"
													...
													<div class="col-sm-4">
														<s:select id="vendorStatus" type="dropdown"
															...
															label="Status" headerKey="-1" headerValue="Select Status"
															cssClass="selectBoxStyle " />
													</div>
												</div>
												<br>
												<div class="row">
													...
													<div class="col-sm-4 pull-right">
														<s:submit type="button" cssClass="cssbutton_emps "
															value="Search" onclick="return getVendorSearchDetails()"
															cssStyle="margin:5px" />
													</div>
												</div>
										</div>
													...
													<table id="vendorSearchResults"
														...
														<tbody>
															...
															<s:iterator value="vendorListVto">
																...
																<tr>
																	<td><s:a href='%{#myUrl}'>
																			<s:property value="%{vendorName}"></s:property>
																		</s:a></td>
																	<td><s:a value="http://%{vendorUrl}">
																			<s:property value="%{vendorUrl}" />
																		</s:a></td>
