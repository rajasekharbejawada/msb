...
public class ConsultantVTO implements Serializable {
	...
	private List primarySkillSetList;
	private int otherFlag = 0;
	private String customerName;
	private String vendorName;
	private boolean customerNotify;
	private boolean vendorNotify;
	private String consultantExamToken;
	...
	public String getConsultantExamToken() {
		return consultantExamToken;
	}

	public void setConsultantExamToken(String consultantExamToken) {
		this.consultantExamToken = consultantExamToken;
	}
	...
	public List getPrimarySkillSetList() {
		return primarySkillSetList;
	}

	public void setPrimarySkillSetList(List primarySkillSetList) {
	...
	private String consultantImagePath;
	...
	public void setConsultantImagePath(String consultantImagePath) {
		this.consultantImagePath = consultantImagePath;
	}
	...
	public boolean isVendorNotify() {
		return vendorNotify;
	}

	public void setVendorNotify(boolean vendorNotify) {
		this.vendorNotify = vendorNotify;
	}
