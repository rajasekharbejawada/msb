...
public interface RecruitmentService {
   ...
   public int techReviewForward(RecruitmentAction recruitmentAction,String accToken,String validKey) throws ServiceLocatorException;
    ...
    public List getTechReviewDetails(RecruitmentAction aThis,int roleId,int userId,int orgId);

    public String getSearchTechReviewList(RecruitmentAction aThis,int roleId,int userId,int orgId) throws ServiceLocatorException;
    ...
    public ConsultantVTO getConsultantProfile(RecruitmentAction recruitmentAction,Map secondry) throws ServiceLocatorException;
    
    public List getVendorsListForConsultant(RecruitmentAction recruitmentAction,int consultantId) throws ServiceLocatorException;
    
    public ConsultantVTO updateConsultantProfile(RecruitmentAction recruitmentAction, int userSessionId) throws ServiceLocatorException;
    
    public List getVenConRequirements(HttpServletRequest httpServletRequest, RecruitmentAction aThis);

    public String getSubmittedListDetails(HttpServletRequest httpServletRequest, RecruitmentAction vendorAjaxHandler) throws ServiceLocatorException;
    
    public String searchSubmittedListDetails(HttpServletRequest httpServletRequest, RecruitmentAction vendorAjaxHandler) throws ServiceLocatorException;
