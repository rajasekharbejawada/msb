...
public class RecruitmentServiceImpl implements RecruitmentService {
	...
	public List getMyDefaultConsListDetails(RecruitmentAction recruitmentAction) throws ServiceLocatorException {
		...
		System.out.println(
				"********************RecruitmentServiceImpl :: getMyDefaultConsListDetails Method Start*********************");
		Connection connection = null;
		Statement statement = null;
		ResultSet resultSet = null;
		String queryString = "";
		...
		try {
			if ("Open".equalsIgnoreCase(recruitmentAction.getConsultantFlag())) {
				queryString = "SELECT c.usr_id AS consultant_id,CONCAT_WS(' ',c.first_name,c.middle_name,c.last_name) AS NAME,"
						+ " c.phone1,c.email1,cd.usr_id,cd.experience,cd.consultant_skills, cd.rate_salary ,c.cur_status "
						+ " FROM users c LEFT OUTER JOIN usr_details cd ON c.usr_id=cd.usr_id LEFT JOIN consultant_ven_rel cvr ON(cvr.consultantid=c.usr_id)"
						+ " WHERE type_of_user='CT' AND vendorid=" + recruitmentAction.getSessionOrgId() + "";

			} else {
				Map map = dataSourceDataProvider.getInstance()
						.getEmpConsultantTeamMap(recruitmentAction.getSessionOrgId());
				...
				if ("All".equalsIgnoreCase(recruitmentAction.getConsultantFlag())
						|| "Team".equalsIgnoreCase(recruitmentAction.getConsultantFlag())) {
					queryString = queryString + " and created_by in(" + retrunValue + ")";
				}
			}
			queryString = queryString + " ORDER BY usr_id desc LIMIT 100";
			System.out.println(
					"getMyDefaultConsListDetails::getMyDefaultConsListDetails::queryString helloooo -->" + queryString);
			connection = ConnectionProvider.getInstance().getConnection();
			statement = connection.createStatement();
			resultSet = statement.executeQuery(queryString);
			String joined = "Name" + "|" + "E-Mail" + "|" + "Experience" + "|" + "Skill Set" + "|" + "Rate/Salary" + "|"
					+ "Phone Number" + "|" + "Status" + "^";
			...
			while (resultSet.next()) {
				...
				System.out.println("div" + resultSet.getString("phone1") + "  " + resultSet.getString("email1") + "  "
						+ resultSet.getString("name") + "    " + resultSet.getString("consultant_skills"));
				conslist.add(cons);
				joined = cons.getConsult_name() + "|" + cons.getConsult_email() + "|" + cons.getYearExperience() + "|"
						+ cons.getConsult_skill() + "|" + cons.getConsult_salary() + "|" + cons.getConsult_phno() + "|"
						+ cons.getConsult_status() + "^";
		...
		System.out.println(
				"********************RecruitmentServiceImpl :: getMyDefaultConsListDetails Method End*********************");
		return conslist;
	}
	...
	public List getConsListDetails(RecruitmentAction recruitmentAction) throws ServiceLocatorException {
		...
		String queryString = "";
		String joined = "Name" + "|" + "E-Mail" + "|" + "Experience" + "|" + "Skill Set" + "|" + "Rate/Salary" + "|"
				+ "Phone Number" + "|" + "Status" + "^"; // for grid download
		String resultantString = joined;
		System.out.println(
				"********************RecruitmentServiceImpl :: getConsListDetails Method Start*********************");
		try {
			...
			queryString = "SELECT DISTINCT c.usr_id as consultant_id,CONCAT_WS(' ',c.first_name,c.middle_name,c.last_name) AS name,c.phone1,c.email1,cd.experience,cd.usr_id,cd.consultant_skills, cd.rate_salary,c.cur_status FROM users c LEFT OUTER JOIN"
					+ " usr_details cd ON c.usr_id=cd.usr_id " + "LEFT OUTER JOIN usr_address ca ON c.usr_id=ca.usr_id "
			...
			if ("All".equalsIgnoreCase(recruitmentAction.getConsultantFlag())
				...
				if (!"".equalsIgnoreCase(recruitmentAction.getEnameForRecruitment())) {
					...
					// "AND(t.task_created_by="+userLeavesAction.getTeamMember()+"
					// )";
			...
			if (recruitmentAction.getConsult_name() != null && !"".equals(recruitmentAction.getConsult_name())) {
				queryString = queryString + " and (c.first_name like'%" + recruitmentAction.getConsult_name().trim()
						+ "%' or c.middle_name like'%" + recruitmentAction.getConsult_name().trim()
						+ "%' or c.last_name like'%" + recruitmentAction.getConsult_name().trim() + "%') ";
			}
			...
			if (!"-1".equalsIgnoreCase(recruitmentAction.getConsult_status())
					&& recruitmentAction.getConsult_status() != null) {
			...
			if (!"-1".equalsIgnoreCase(recruitmentAction.getConsult_Country())
					&& recruitmentAction.getConsult_Country() != null) {
		...
		System.out.println(
				"********************RecruitmentServiceImpl :: getConsListDetails Method End*********************");
		return conslist;
	}
	...
	public String getRequirementDetails(RecruitmentAction recruitmentAction) throws ServiceLocatorException {
		...
		int i = 0;
		System.out.println(
				"********************RecruitmentServiceImpl :: getRequirementDetails Method Start*********************");
		Connection connection = null;
		Statement statement = null;
		ResultSet resultSet = null;
		String queryString = "";
		try {
			...
			resultSet = statement.executeQuery(queryString);
			while (resultSet.next()) {
				System.out.println(resultSet.getInt("requirement_id") + " " + resultSet.getString("req_name") + " "
						+ resultSet.getInt("no_of_resources") + " " + resultSet.getString("req_st_date") + " "
						+ resultSet.getString("req_status") + " " + resultSet.getString("req_skills"));
				resultString += resultSet.getInt("requirement_id") + "|" + resultSet.getString("req_name") + "|"
						+ resultSet.getInt("no_of_resources") + "|" + resultSet.getString("req_st_date") + "|"
						+ resultSet.getString("req_status") + "|" + resultSet.getString("req_skills") + "^";
			}
		...
		System.out.println(
				"********************RecruitmentServiceImpl :: getRequirementDetails Method End*********************");
		return resultString;
	}
	...
	public List getAllRequirementList(HttpServletRequest httpServletRequest, RecruitmentAction recruitmentAction) {
		...
		ResultSet resultSet = null;
		System.out.println(
				"********************RecruitmentServiceImpl :: getAllRequirementList Method Start*********************");
		try {
			String typeofusr = httpServletRequest.getSession(false).getAttribute(ApplicationConstants.TYPE_OF_USER)
					.toString();
			if (typeofusr.equalsIgnoreCase("VC")) {
				joined = "Job Id" + "|" + "Jog Title" + "|" + "Customer" + "|" + "Skills Set" + "|" + "Posted Date"
						+ "|" + "Status" + "^"; // for grid download
				resultantString = joined;
				queryString = "SELECT created_date,jdid,requirement_id,req_name,no_of_resources,req_skills,preferred_skills,req_st_date,req_status,req_contact1,req_contact2,req_created_by FROM acc_requirements LEFT OUTER JOIN req_ven_rel  ON requirement_id=req_id WHERE ven_id="
						+ recruitmentAction.getSessionOrgId()
						+ " AND  NOW() >= req_access_time AND  STATUS LIKE 'Active' AND  req_status LIKE 'R' ";
			} else {
				joined = "Job Id" + "|" + "Jog Title" + "|" + "Positions" + "|" + "Skills Set" + "|" + "Posted Date"
						+ "|" + "Status" + "|" + "Noof Submissions" + "^"; // for
																			// grid
																			// download
				resultantString = joined;
				queryString = "SELECT DISTINCT(requirement_id),req_created_by,created_date,req_created_date,tax_term,req_type,target_rate,jdid,req_name,no_of_resources,req_skills,preferred_skills,req_st_date,req_status,req_contact1,req_contact2,created_by_org_id,max_rate FROM acc_requirements LEFT OUTER JOIN req_ven_rel  ON requirement_id=req_id "
						+ " WHERE 1=1 AND req_status IN ('O','R','C','OR') and acc_id="
						+ recruitmentAction.getSessionOrgId();// + " GROUP BY
																// requirement_id
																// order by
																// req_name,FIELD(req_status,'O','R','C','F','I','H','W','S','L'),req_created_date
																// desc LIMIT
																// 100";
			...
			while (resultSet.next()) {
				...
				if (myDate != null) {
					requirementListVTO.setPostedDate(
							com.mss.msp.util.DateUtility.getInstance().convertDateToViewInDashFormat(myDate));
				} else {
					requirementListVTO.setPostedDate("---");
				}
				...
				requirementListVTO.setReqContactName1(com.mss.msp.util.DataSourceDataProvider.getInstance()
						.getFnameandLnamebyStringId(resultSet.getString("req_contact1")));
				requirementListVTO.setReqContactName2(com.mss.msp.util.DataSourceDataProvider.getInstance()
						.getFnameandLnamebyStringId(resultSet.getString("req_contact2")));
				requirementListVTO.setCreatedByName(com.mss.msp.util.DataSourceDataProvider.getInstance()
						.getFnameandLnamebyUserid(resultSet.getInt("req_created_by")));
				requirementListVTO.setNoOfSubmissions(com.mss.msp.util.DataSourceDataProvider.getInstance()
						.getNoOfSubmisions(resultSet.getInt("requirement_id"), 0));
				list.add(requirementListVTO);
				if (typeofusr.equalsIgnoreCase("VC")) {
					joined = requirementListVTO.getJdId() + "|" + requirementListVTO.getTitle() + "|"
							+ requirementListVTO.getCustomerName() + "|" + requirementListVTO.getReqSkillSet() + "|"
							+ requirementListVTO.getPostedDate() + "|" + requirementListVTO.getStatus() + "^";
					resultantString += joined;
				} else {
					joined = requirementListVTO.getJdId() + "|" + requirementListVTO.getTitle() + "|"
							+ requirementListVTO.getNoOfPosition() + "|" + requirementListVTO.getReqSkillSet() + "|"
							+ requirementListVTO.getPostedDate() + "|" + requirementListVTO.getStatus() + "|"
							+ requirementListVTO.getNoOfSubmissions() + "^";
					resultantString += joined;
				}
				recruitmentAction.setGridPDFDownload(queryString);
			}
		...
		System.out.println(
				"********************RecruitmentServiceImpl :: getAllRequirementList Method End*********************");
		return list;
	}
	...
	public int doAddConsultantDetails(RecruitmentAction recruitmentAction, int orgId) throws ServiceLocatorException {
		System.out.println(
				"********************RecruitmentServiceImpl :: doAddConsultantDetails Method Start*********************");
		StringBuffer stringBuffer = new StringBuffer();
		String queryString = "";
		Connection connection = null;
		System.out.println("------------------add consultant details ----------------------"
				+ recruitmentAction.getConsult_preferredRegion());
		CallableStatement callableStatement = null;
		int addResult = 0;
		...
		while (stk.hasMoreTokens()) {
			reqSkillsResultString += com.mss.msp.util.DataSourceDataProvider.getInstance()
					.getReqSkillsSet(Integer.parseInt(stk.nextToken()));
		}
		...
		try {
			if ("Y".equals(recruitmentAction.getConsult_available())) {
				availableDate = dateUtility.getInstance()
						.convertStringToMySQLDateInDash(recruitmentAction.getConsult_add_date());
			} else {
				availableDate = null;
			}
			...
			callableStatement.setString(41,
					com.mss.msp.util.DataUtility.encrypted(recruitmentAction.getConsult_ssnNo()));
			...
			callableStatement.setString(47, recruitmentAction.getPrimaryValues());
			System.out.println("in update primary skill values----------->" + recruitmentAction.getPrimaryValues());

			callableStatement.setString(48, recruitmentAction.getConsult_preferredRegion());
			callableStatement.setInt(49, recruitmentAction.getConsultwState());
			callableStatement.setString(50, recruitmentAction.getConsultwCity());
			callableStatement.setString(51, recruitmentAction.getConsult_otherSkills());
			callableStatement.setString(52, recruitmentAction.getConsult_otherSecSkills());

			callableStatement.setString(53, pwdSalt);
			callableStatement.setString(54, encPwd);
			isExceute = callableStatement.execute();
			addResult = callableStatement.getInt(55);
			System.out.println("Result in Add consultant" + addResult);
			if (addResult > 0) {
				MailManager.doComposeBodyForEmail(recruitmentAction.getConsult_email(),
						recruitmentAction.getConsult_fstname(), recruitmentAction.getConsult_lstname(),
						"serviceBayUserRegistration", plainPassword);
				// result ="success";
			}
		...
		System.out.println(
				"********************RecruitmentServiceImpl :: doAddConsultantDetails Method End*********************");
		return addResult;
	}
	 ...
	 * *****************************************************************************
	 */
	public ConsultantVTO getupdateConsultantDetails(RecruitmentAction recruitmentAction, Map map)
			throws ServiceLocatorException {
		System.out.println(
				"********************RecruitmentServiceImpl :: getupdateConsultantDetails Method Start*********************");
		...
		String queryString = "";
		try {
			Map csrApprovalDetails = DataSourceDataProvider.getInstance()
					.getCSRApprovalStatus(recruitmentAction.getRequirementId(), recruitmentAction.getConsult_id());
			if (csrApprovalDetails.size() > 0) {
				recruitmentAction.setCsrAppComments(csrApprovalDetails.get("comments").toString());
				recruitmentAction.setCsrAppStatus(csrApprovalDetails.get("status").toString());

			} else {
				recruitmentAction.setCsrAppComments("");
				recruitmentAction.setCsrAppStatus("");
			}
			queryString = "SELECT c.usr_id AS usr_consultant_id,c.job_title,c.preffered_country,c.preffered_region, "
					...
					+ "u.twitter_link,c.consultant_primary_skill, c.consultant_skills,c.other_skills,c.other_sec_skills,a.address,a.city,a.state,a.zip,a.country, "
					+ "a.phone,a.address2,a.address_flag,a.STATUS,ar.object_id, ar.acc_attachment_id, ar.object_type, ar.attachment_path, ar.attachment_name,u.type_of_user,c.visa,c.idprooftype,c.idproofattachment,c.city,c.state FROM users u JOIN usr_details c ON (u.usr_id = c.usr_id) "
			...
			while (resultSet.next()) {
				...
				if (resultSet.getString("dob") == null) {
					...
					consult.setConsult_dob(
							dateUtility.getInstance().convertToviewFormatInDash(resultSet.getString("dob")));
				}
				...
				if (resultSet.getString("preffered_state") != null) {
					...
					System.out.println("-------------------------" + consult.getConsult_preferredState());
				}
				...
				if (resultSet.getString("available_from") == null) {
					...
					consult.setConsult_favail(
							dateUtility.getInstance().convertToviewFormatInDash(resultSet.getString("available_from")));
				}
				...
				consult.setPrimaryValues(resultSet.getString("consultant_primary_skill"));
				System.out.println("primary skills--------------->" + resultSet.getString("consultant_primary_skill"));
				System.out.println("primary skills values--------------->" + consult.getPrimaryValues());
				String conPrimarySkill = resultSet.getString("consultant_primary_skill");
				System.out.println(conPrimarySkill);

				List primarySkillList = new ArrayList();

				if (conPrimarySkill != null && !"".equals(conPrimarySkill)) {
					StringTokenizer conPrimarySkillToken = new StringTokenizer(conPrimarySkill, ",");

					while (conPrimarySkillToken.hasMoreTokens()) {
						primarySkillList.add(conPrimarySkillToken.nextToken());
						// System.out.println(conPrimarySkillToken.nextToken());
						// com.mss.msp.util.DataSourceDataProvider.getInstance()
						// .getReqPrimarySkillsSet(Integer.parseInt(st.nextToken()));
					}
				}

				consult.setPrimarySkillSetList(primarySkillList);
				consult.setConsultwCity(resultSet.getString("c.city"));
				consult.setConsultwState(resultSet.getInt("c.state"));
				...
				System.out.println(
						"getupdateConsultantDetails::reqSkillsResultString----------->" + reqSkillsResultString);
				consult.setSkillSetList(list1);
				consult.setConsult_alterEmail(resultSet.getString("email2"));
				consult.setConsult_otherSkills(resultSet.getString("other_skills"));
				System.out.println("other skills ------>" + resultSet.getString("other_skills"));
				consult.setConsult_otherSecSkills(resultSet.getString("other_sec_skills"));
		...
		System.out.println(
				"********************RecruitmentServiceImpl :: getupdateConsultantDetails Method End*********************");
		return consult;
	}
	 ...
	 * *****************************************************************************
	 */
	public ConsultantVTO doupdateConsultantDetails(RecruitmentAction recruitmentAction, int userSessionId, int orgid)
			throws ServiceLocatorException {
		System.out.println(
				"********************RecruitmentServiceImpl :: doupdateConsultantDetails Method Start*********************");
		DateUtility dateUtility = new DateUtility();
		ConsultantVTO consult = new ConsultantVTO();
		Connection connection = null;
		CallableStatement callableStatement = null;
		...
		String str = recruitmentAction.getSkillValues();
		StringTokenizer stk = new StringTokenizer(str, ",");
		System.out.println("----------------------------------------" + recruitmentAction.getConsult_preferredRegion());
		System.out.println("------------prefstates are" + recruitmentAction.getPrefstateValues());
		String reqSkillsResultString = "";
		while (stk.hasMoreTokens()) {
			reqSkillsResultString += com.mss.msp.util.DataSourceDataProvider.getInstance()
					.getReqSkillsSet(Integer.parseInt(stk.nextToken()));
		...
		try {
			...
			callableStatement.setString(5,
					dateUtility.getInstance().convertStringToMySQLDateInDash(recruitmentAction.getConsult_dob()));
			...
			if ("Y".equals(recruitmentAction.getConsult_available())) {
				if (recruitmentAction.getConsult_favail() != null
						&& !"".equals(recruitmentAction.getConsult_favail())) {
					callableStatement.setString(24, dateUtility.getInstance()
							.convertStringToMySQLDateInDash(recruitmentAction.getConsult_favail()));
				} else {
			...
			System.out.println("in update primary skill values----------->" + recruitmentAction.getPrimaryValues());
			callableStatement.setString(48, recruitmentAction.getConsult_preferredRegion());
			callableStatement.setString(49, recruitmentAction.getConsultwCity());
			callableStatement.setInt(50, recruitmentAction.getConsultwState());
			callableStatement.setString(51, recruitmentAction.getConsult_otherSkills());
			callableStatement.setString(52, recruitmentAction.getConsult_otherSecSkills());
			callableStatement.registerOutParameter(53, Types.INTEGER);
			isExceute = callableStatement.execute();
			updatedRows = callableStatement.getInt(53);
			if (updatedRows > 0) {
		...
		System.out.println(
				"********************RecruitmentServiceImpl :: doupdateConsultantDetails Method End*********************");
		return consult;
	}
	 ...
	 *
	 * ForUse : getSubmittedListDetails() method is used to
	 *
	 * *****************************************************************************
	 */
	public String getSubmittedListDetails(HttpServletRequest httpServletRequest, RecruitmentAction recruitmentAction)
			throws ServiceLocatorException {
		System.out.println(
				"********************RecruitmentServiceImpl :: getSubmittedListDetails Method Start*********************");
		String resultString = "";
		String decryptedSSN = "";
		...
		try {
			...
			String typeofusr = httpServletRequest.getSession(false).getAttribute(ApplicationConstants.TYPE_OF_USER)
					.toString();
			int primaryRoleId = Integer.parseInt(
					httpServletRequest.getSession(false).getAttribute(ApplicationConstants.PRIMARYROLE).toString());
			if (typeofusr.equalsIgnoreCase("VC")) {
				queryString = "SELECT Distinct(c.usr_id) AS consultant_id,r.jdid,ud.experience,"
						+ "CONCAT_WS(' ',c.first_name,c.middle_name,c.last_name) AS NAME,c.phone1,aat.acc_attachment_id,"
						+ "c.email1,rc.STATUS,rc.reqId,rc.con_skill AS consultant_skills,rc.createdbyOrgId as created_by_org_id,"
						+ "rc.rate_salary,r.acc_id,rc.created_Date,rc.Comments,rc.customercomments,ud.ssn_number,rc.vendorcomments,a.account_name,rc.csr_status,rc.reqId "
						+ " FROM req_con_rel rc " + "LEFT OUTER JOIN users c ON (rc.consultantId=c.usr_id) "
						...
						+ "LEFT OUTER JOIN accounts a ON(a.account_id=r.acc_id)";
				queryString = queryString + " WHERE";

				// if(primaryRoleId !=1){
				queryString = queryString + " rc.createdbyOrgId=" + recruitmentAction.getSessionOrgId() + " AND";
				// }
				queryString = queryString
						+ " aat.STATUS LIKE 'Active' AND ((aat.object_type='E' OR aat.object_type='CSA') AND aat.req_id = rc.reqId) ORDER BY r.jdid LIMIT 100";
			} else {
				queryString = "SELECT Distinct(c.usr_id) AS consultant_id,ud.experience,r.jdid,"
						+ "CONCAT_WS(' ',c.first_name,c.middle_name,c.last_name) AS NAME,c.phone1,aat.acc_attachment_id,"
						+ "c.email1,rc.reqId,rc.STATUS,rc.con_skill AS consultant_skills,rc.createdbyOrgId as created_by_org_id,"
						+ "rc.rate_salary,r.acc_id,rc.created_Date,rc.Comments,rc.customercomments,ud.ssn_number,rc.vendorcomments,a.account_name,rc.csr_status "
						+ " FROM req_con_rel rc " + "LEFT OUTER JOIN users c ON (rc.consultantId=c.usr_id) "
						+ "LEFT OUTER JOIN usr_details ud ON (ud.usr_id=c.usr_id)  "
						+ "LEFT OUTER JOIN acc_requirements r ON (r.requirement_id=rc.reqId) "
						+ "LEFT OUTER JOIN acc_rec_attachment aat ON (c.usr_id=aat.object_id) "
						+ "LEFT OUTER JOIN accounts a ON(a.account_id= rc.createdbyOrgId)";
				queryString = queryString + " WHERE";
				if (primaryRoleId != 1) {
					queryString = queryString + " r.acc_id =" + recruitmentAction.getSessionOrgId() + " AND";
				} else {
					String customerIds = DataSourceDataProvider.getInstance()
							.customersOrgIdsForCSR(recruitmentAction.getUserSessionId());
					queryString = queryString + " r.acc_id IN(" + customerIds + ") AND ";
				}
				queryString = queryString
						+ " aat.STATUS LIKE 'Active' AND ((aat.object_type='E' OR aat.object_type='CSA') AND aat.req_id = rc.reqId) ORDER BY r.jdid DESC LIMIT 100";
			}
			System.out.println("getSubmittedListDetails::query=========by nag=======" + queryString);
			statement = connection.createStatement();
			resultSet = statement.executeQuery(queryString);
			while (resultSet.next()) {
				String postedDate = "";
				...
				resultString += resultSet.getString("consultant_id") + "|" + resultSet.getString("name") + "|"
						+ resultSet.getString("email1") + "|" + resultSet.getString("consultant_skills") + "|"
						+ resultSet.getString("phone1") + "|" + resultSet.getString("status") + "|"
						+ resultSet.getString("acc_attachment_id") + "|"
						+ com.mss.msp.util.DataSourceDataProvider.getInstance().getOrganizationName(
								resultSet.getInt("created_by_org_id"))
						+ "|" + resultSet.getString("rate_salary") + "|" + resultSet.getInt("created_by_org_id") + "|"
						+ resultSet.getInt("acc_id") + "|" + postedDate + "|" + resultSet.getString("Comments") + "|"
						+ resultSet.getString("customercomments") + "|" + decryptedSSN + "|"
						+ resultSet.getString("rc.vendorcomments") + "|" + queryString + "|"
						+ resultSet.getString("experience") + "|" + resultSet.getString("a.account_name") + "|"
						+ resultSet.getString("r.jdid") + "|" + resultSet.getString("rc.csr_status") + "|"
						+ resultSet.getString("rc.reqId") + "|" + recruitmentAction.getRoleId() + "^";

				// + resultSet.getString("experience") + "|" +
				// resultSet.getString("a.account_name") + "|" +
				// resultSet.getString("r.jdid") + "|" +
				// resultSet.getString("rc.csr_status") + "|" +
				// resultSet.getString("rc.reqId")+ "^";
		...
		System.out.println(
				"********************RecruitmentServiceImpl :: getSubmittedListDetails Method End*********************");
		return resultString;
	}
	 ...
	 * Author :Tasneem <tshaik@miraclesoft.com>
	 *
	 * ForUse : searchSubmittedListDetails() searching.
	 *
	 *
	 * *****************************************************************************
	 */
	public String searchSubmittedListDetails(HttpServletRequest httpServletRequest, RecruitmentAction recruitmentAction)
			throws ServiceLocatorException {
		System.out.println(
				"********************RecruitmentServiceImpl :: searchSubmittedListDetails Method Start*********************");
		DateUtility dateUtility = new DateUtility();
		String startdate = "";
		String endDate = "";
		...
		try {
			...
			int primaryRoleId = Integer.parseInt(
					httpServletRequest.getSession(false).getAttribute(ApplicationConstants.PRIMARYROLE).toString());
			if (typeofusr.equalsIgnoreCase("VC")) {
				queryString = " SELECT Distinct(c.usr_id) as consultant_id,r.jdid,rc.reqId,cd.experience,CONCAT_WS(' ',c.first_name,c.middle_name,c.last_name) AS NAME, "
						+ "c.phone1,acc_attachment_id,c.email1,rc.status,rc.con_skill AS consultant_skills,rc.createdbyOrgId AS created_by_org_id,rc.rate_salary,rc.created_Date,rc.csr_status,"
						+ "rc.Comments,r.acc_id,rc.customercomments,cd.ssn_number,rc.vendorcomments,a.account_name  FROM users c LEFT OUTER JOIN "
						+ "usr_details cd ON (c.usr_id=cd.usr_id) LEFT OUTER JOIN req_con_rel rc"
						+ " ON (c.usr_id=rc.consultantId) " + " LEFT OUTER JOIN acc_requirements r "
						+ "LEFT OUTER JOIN accounts a ON (a.account_id= r.acc_id)"
						+ "ON (requirement_id=reqId) LEFT OUTER JOIN acc_rec_attachment aat ON (c.usr_id=object_id) WHERE";
				// if(primaryRoleId !=1){
				queryString = queryString + " rc.createdbyOrgId=" + recruitmentAction.getSessionOrgId() + " AND";
				// }
				queryString = queryString
						+ " aat.STATUS='active' AND ((aat.object_type='E' OR aat.object_type='CSA') AND aat.req_id = rc.reqId)";
				...
				queryString = " SELECT Distinct(c.usr_id) as consultant_id,rc.reqId,r.jdid,cd.experience,CONCAT_WS(' ',c.first_name,c.middle_name,c.last_name) AS NAME, "
						+ "c.phone1,acc_attachment_id,c.email1,rc.status,rc.con_skill AS consultant_skills,rc.createdbyOrgId AS created_by_org_id,rc.rate_salary,rc.created_Date,rc.csr_status,"
						+ "rc.Comments,r.acc_id,rc.customercomments,cd.ssn_number,rc.vendorcomments,a.account_name  FROM users c LEFT OUTER JOIN "
						+ "usr_details cd ON (c.usr_id=cd.usr_id) LEFT OUTER JOIN req_con_rel rc"
						+ " ON (c.usr_id=rc.consultantId) "
						+ " LEFT OUTER JOIN accounts a ON(a.account_id= rc.createdbyOrgId)"
						+ " LEFT OUTER JOIN acc_requirements r "
						+ "ON (requirement_id=reqId) LEFT OUTER JOIN acc_rec_attachment aat ON (c.usr_id=object_id) WHERE";
				if (primaryRoleId != 1) {
					queryString = queryString + " r.acc_id =" + recruitmentAction.getSessionOrgId() + " AND";
				} else {
			...
			if (recruitmentAction.getVendorName() != null && !"".equals(recruitmentAction.getVendorName())) {
				queryString = queryString + " AND a.account_name LIKE '%" + recruitmentAction.getVendorName().trim()
						+ "%' ";
			}
			if (!"".equals(recruitmentAction.getSubmittedFrom()) && !"".equals(recruitmentAction.getSubmittedEnd())) {
				startdate = dateUtility.getInstance()
						.convertStringToMySQLDateInDash(recruitmentAction.getSubmittedFrom());
				endDate = dateUtility.getInstance().convertStringToMySQLDateInDash(recruitmentAction.getSubmittedEnd());
				queryString = queryString + " AND rc.created_date between '" + startdate + "' AND '" + endDate + "'";
			}
			if (!"-1".equalsIgnoreCase(recruitmentAction.getConsultStatus())) {
				queryString = queryString + " and rc.status = '" + recruitmentAction.getConsultStatus() + "'";
			}
			/*
			 * if (recruitmentAction.getConsult_phno() != null &&
			 * !"".equals(recruitmentAction.getConsult_phno())) { queryString =
			 * queryString + " and c.phone1 like'%" +
			 * recruitmentAction.getConsult_phno().trim() + "%' ";
			 * 
			 * }
			 */
			/*
			 * if (recruitmentAction.getConsult_skill() != null &&
			 * !"".equals(recruitmentAction.getConsult_skill())) { queryString =
			 * queryString + " and rc.con_skill like'%" +
			 * recruitmentAction.getConsult_skill().trim() + "%' ";
			 * 
			 * }
			 */
			/*
			 * if (recruitmentAction.getConsult_ssnNo() != null &&
			 * !"".equals(recruitmentAction.getConsult_ssnNo())) { queryString =
			 * queryString + " and cd.ssn_number ='" +
			 * com.mss.msp.util.DataUtility.encrypted(recruitmentAction.
			 * getConsult_ssnNo().trim()) + "' "; } if
			 * (recruitmentAction.getYearExperience() != null &&
			 * !"".equals(recruitmentAction.getYearExperience())) { queryString
			 * = queryString + " and cd.experience ='" +
			 * recruitmentAction.getYearExperience().trim() + "' "; }
			 */
			queryString = queryString + " ORDER BY r.jdid DESC LIMIT 100";
			System.out.println("searchSubmittedListDetails::query================" + queryString);
			statement = connection.createStatement();
			resultSet = statement.executeQuery(queryString);
			while (resultSet.next()) {
				if (resultSet.getString("ssn_number") != null
				...
				resultString += resultSet.getString("consultant_id") + "|" + resultSet.getString("name") + "|"
						...
						+ "|" + resultSet.getString("Comments") + "|" + resultSet.getString("customercomments") + "|"
						+ decryptedSSN + "|" + resultSet.getString("vendorcomments") + "|" + queryString + "|"
						+ resultSet.getString("experience") + "|" + resultSet.getString("a.account_name") + "|"
						+ resultSet.getString("r.jdid") + "|" + resultSet.getString("rc.csr_status") + "|"
						+ resultSet.getString("rc.reqId") + "^";
				// System.out.println("resultString By search
				// ---->"+resultString);
			}
		} catch (SQLException ex) {
			ex.printStackTrace();
		...
		System.out.println(
				"********************RecruitmentServiceImpl :: searchSubmittedListDetails Method End*********************");
		return resultString;
	}
	 ...
	 * *****************************************************************************
	 */
	public String getConsultantListDetails(HttpServletRequest httpServletRequest, RecruitmentAction recruitmentAction)
			throws ServiceLocatorException {
		System.out.println(
				"********************RecruitmentServiceImpl :: getConsultantListDetails Method Start*********************");
		String resultString = "";
		String decryptedSSN = "";
		...
		try {
			...
			if (typeofusr.equalsIgnoreCase("VC")) {
				queryString = "SELECT Distinct(c.usr_id) AS consultant_id,ud.experience,"
						...
						+ "LEFT OUTER JOIN acc_requirements r ON (r.requirement_id=rc.reqId) "
						+ "LEFT OUTER JOIN acc_rec_attachment aat ON (c.usr_id=aat.object_id) ";
				queryString = queryString + " WHERE rc.reqId=" + recruitmentAction.getRequirementId()
						+ " AND rc.createdbyOrgId=" + recruitmentAction.getSessionOrgId()
						+ " AND  aat.STATUS LIKE 'Active' AND ((aat.object_type='E' OR aat.object_type='CSA') AND aat.req_id = "
						+ recruitmentAction.getRequirementId() + ") LIMIT 100";
			} else {
				queryString = "SELECT Distinct(c.usr_id) AS consultant_id,ud.experience,"
						+ "CONCAT_WS(' ',c.first_name,c.middle_name,c.last_name) AS NAME,c.phone1,aat.acc_attachment_id,"
						+ "c.email1,rc.STATUS,rc.con_skill AS consultant_skills,rc.createdbyOrgId as created_by_org_id,"
		...
		System.out.println(
				"********************RecruitmentServiceImpl :: getConsultantListDetails Method End*********************");
		return resultString;
	}
	 ...
	 * *****************************************************************************
	 */
	public String searchConsultantListDetails(HttpServletRequest httpServletRequest,
			RecruitmentAction recruitmentAction) throws ServiceLocatorException {
		System.out.println(
				"********************RecruitmentServiceImpl :: searchConsultantListDetails Method Start*********************");
		String resultString = "";
		String queryString = "";
		String decryptedSSN = "";
		...
		try {
			...
			if (typeofusr.equalsIgnoreCase("VC")) {
				queryString = " SELECT Distinct(c.usr_id) as consultant_id,cd.experience,CONCAT_WS(' ',c.first_name,c.middle_name,c.last_name) AS NAME, "
						...
						+ "ON (requirement_id=reqId) LEFT OUTER JOIN acc_rec_attachment aat ON (c.usr_id=object_id) WHERE reqId='"
						+ recruitmentAction.getRequirementId()
						+ "' AND aat.STATUS='active' AND ((aat.object_type='E' OR aat.object_type='CSA') AND aat.req_id ='"
						+ recruitmentAction.getRequirementId() + "')";
				if (recruitmentAction.getVen_id() == 0) {
					queryString = queryString + " AND rc.createdbyOrgId=" + recruitmentAction.getSessionOrgId() + " ";
				} else {
			...
			if (recruitmentAction.getConsult_ssnNo() != null && !"".equals(recruitmentAction.getConsult_ssnNo())) {
				queryString = queryString + " and cd.ssn_number ='"
						+ com.mss.msp.util.DataUtility.encrypted(recruitmentAction.getConsult_ssnNo().trim()) + "' ";
			}
			if (recruitmentAction.getYearExperience() != null && !"".equals(recruitmentAction.getYearExperience())) {
				queryString = queryString + " and cd.experience ='" + recruitmentAction.getYearExperience().trim()
						+ "' ";
		...
		System.out.println(
				"********************RecruitmentServiceImpl :: searchConsultantListDetails Method End*********************");
		return resultString;
	}
	...
	public int addConsultAttachmentDetails(RecruitmentAction recruitmentaction) {
		System.out.println(
				"********************RecruitmentServiceImpl :: addConsultAttachmentDetails Method Start*********************");
		StringBuffer stringBuffer = new StringBuffer();
		int addResult = 0;
		boolean isExceute = false;
		Connection connection = null;
		...
		try {
			...
			callableStatement.setString(2, recruitmentaction.getAttachmentType());
			...
			callableStatement.setString(6, recruitmentaction.getAttachmentTitle());
			callableStatement.registerOutParameter(7, Types.INTEGER);
			isExceute = callableStatement.execute();
			addResult = callableStatement.getInt(7);
		} catch (Exception sqe) {
			sqe.printStackTrace();
		} finally {
			try {
		...
		System.out.println(
				"********************RecruitmentServiceImpl :: addConsultAttachmentDetails Method End*********************");
		return addResult;
	}
	...
	public String getActivityDetails(int consultantId) throws ServiceLocatorException {
		System.out.println(
				"********************RecruitmentServiceImpl :: getActivityDetails Method Start*********************");
		...
		try {
			queryString = " SELECT actvity_id,object_id,object_type,activity_name,actvity_type,activity_relation,activity_created_date,"
					+ "activity_created_by,activity_desc,activity_comments,activity_status FROM acc_rec_activities WHERE activity_relation='acc' and object_id= "
					+ consultantId;
			connection = ConnectionProvider.getInstance().getConnection();
			statement = connection.createStatement();
			...
			while (resultSet.next()) {
				...
				resultString += userActivity.getActivityId() + "|" + userActivity.getActivityName() + "|"
						...
						+ dsdp.getFnameandLnamebyUserid(Integer.parseInt(userActivity.getActivityCratedBy())) + '|'
						+ userActivity.getActivityDesc() + '|' + userActivity.getActivityComments() + '|'
		...
		System.out.println(
				"********************RecruitmentServiceImpl :: getActivityDetails Method End*********************");
		return resultString;
	}
	...
	public int doAddConsultantActivityDetails(RecruitmentAction recruitmentAction) throws ServiceLocatorException {
		System.out.println(
				"********************RecruitmentServiceImpl :: doAddConsultantActivityDetails Method Start*********************");
		String queryString = "";
		int resultInt = 0;
		Connection connection = null;
		PreparedStatement preparedStatement = null;
		...
		System.out.println(
				"********************RecruitmentServiceImpl :: doAddConsultantActivityDetails Method End*********************");
		return resultInt;
	}
	...
	public int doEditConsultantActivityDetails(RecruitmentAction recruitmentAction) {
		System.out.println(
				"********************RecruitmentServiceImpl :: doEditConsultantActivityDetails Method Start*********************");
		...
		System.out.println(
				"********************RecruitmentServiceImpl :: doEditConsultantActivityDetails Method End*********************");
		return resultInt;
	}
	...
	public String getConsultantActivityDetailsbyActivityId(RecruitmentAction recruitmentAction) {
		System.out.println(
				"********************RecruitmentServiceImpl :: getConsultantActivityDetailsbyActivityId Method Start*********************");
		ArrayList consultActivitylist = new ArrayList();
		StringBuffer stringBuffer = new StringBuffer();
		String queryString = "";
		String resultMsg = "";
		...
		ResultSet resultSet = null;
		try {
			queryString = "SELECT actvity_id,activity_name,actvity_type,activity_created_date,activity_desc,activity_comments,activity_status,activity_relation FROM acc_rec_activities where actvity_id="
					+ recruitmentAction.getActivityId();
			connection = ConnectionProvider.getInstance().getConnection();
			statement = connection.createStatement();
			resultSet = statement.executeQuery(queryString);
			while (resultSet.next()) {
		...
		System.out.println(
				"********************RecruitmentServiceImpl :: getConsultantActivityDetailsbyActivityId Method End*********************");
		return resultMsg;
	}
	 ...
	 **************************************
	 */
	public List getLoginUserRequirementList(HttpServletRequest httpServletRequest,
			RecruitmentAction recruitmentAction) {
		System.out.println(
				"********************RecruitmentServiceImpl :: getLoginUserRequirementList Method Start*********************");
		ArrayList<RequirementListVTO> list = new ArrayList<RequirementListVTO>();
		StringBuffer stringBuffer = new StringBuffer();
		String queryString = "";
		String joined = "";
		...
		try {
			String typeofusr = httpServletRequest.getSession(false).getAttribute(ApplicationConstants.TYPE_OF_USER)
					.toString();
			int sessionusrPrimaryrole = Integer.parseInt(
					httpServletRequest.getSession(false).getAttribute(ApplicationConstants.PRIMARYROLE).toString());
			if (typeofusr.equalsIgnoreCase("VC")) {
				joined = "Job Id" + "|" + "Jog Title" + "|" + "Customer" + "|" + "Skills Set" + "|" + "Posted Date"
						+ "|" + "Status" + "^"; // for grid download
				...
				queryString = "SELECT account_name,r.created_date,req_created_date,tax_term,req_type,target_rate,jdid,requirement_id,req_name,no_of_resources,req_skills,preferred_skills,req_st_date,req_status,req_contact1,req_contact2,created_by_org_id,max_rate"
						...
						+ "WHERE ven_id=" + recruitmentAction.getSessionOrgId()
						+ " AND  NOW() >= req_access_time AND  r.STATUS LIKE 'Active' "
						+ "AND  (req_status = 'R' OR req_status = 'OR')";
				if (sessionusrPrimaryrole != 3 && sessionusrPrimaryrole != 2 && sessionusrPrimaryrole != 13
						&& sessionusrPrimaryrole != 1) {
					if (httpServletRequest.getSession(false)
							.getAttribute(ApplicationConstants.USER_CATEGORY_LIST) != null) {
						queryString += " and req_category IN (" + httpServletRequest.getSession(false)
								.getAttribute(ApplicationConstants.USER_CATEGORY_LIST).toString() + ") ";
					}
				}
				queryString = queryString + " order by jdid desc LIMIT 30";
			} else {
				joined = "Job Id" + "|" + "Jog Title" + "|" + "Positions" + "|" + "Skills Set" + "|" + "Posted Date"
						+ "|" + "Status" + "|" + "Noof Submissions" + "^"; // for
																			// grid
				...
				if (recruitmentAction.getTypeOfUser() == 3) {
					queryString = "SELECT DISTINCT(requirement_id),account_name,r.created_date,req_created_date,tax_term,req_type,target_rate,jdid,req_name,no_of_resources,req_skills,preferred_skills,req_st_date,req_status,req_contact1,req_contact2,created_by_org_id,max_rate FROM acc_requirements LEFT OUTER JOIN req_ven_rel r ON requirement_id=req_id LEFT OUTER JOIN accounts a ON account_id= created_by_org_id "
							+ " WHERE 1=1 AND  req_created_by=" + recruitmentAction.getUserSessionId() + " and acc_id="
							+ recruitmentAction.getSessionOrgId()
							+ "  GROUP BY requirement_id order by jdid desc LIMIT 30";
				} else if (recruitmentAction.getTypeOfUser() == 13 || recruitmentAction.getTypeOfUser() == 2) {
					queryString = "SELECT DISTINCT(requirement_id),account_name,r.created_date,req_created_date,tax_term,req_type,target_rate,jdid,req_name,no_of_resources,req_skills,preferred_skills,req_st_date,req_status,req_contact1,req_contact2,created_by_org_id,max_rate FROM acc_requirements LEFT OUTER JOIN req_ven_rel r  ON requirement_id=req_id LEFT OUTER JOIN accounts a ON account_id= created_by_org_id "
							+ " WHERE 1=1 AND acc_id=" + recruitmentAction.getSessionOrgId()
							+ "  GROUP BY requirement_id order by jdid desc LIMIT 30";
				} else {
					queryString = "SELECT DISTINCT(requirement_id),account_name,r.created_date,req_created_date,tax_term,req_type,target_rate,jdid,req_name,no_of_resources,req_skills,preferred_skills,req_st_date,req_status,req_contact1,req_contact2,created_by_org_id,max_rate FROM acc_requirements LEFT OUTER JOIN req_ven_rel r ON requirement_id=req_id LEFT OUTER JOIN accounts a ON account_id= created_by_org_id "
							+ " WHERE 1=1 " + "and acc_id=" + recruitmentAction.getSessionOrgId();
					...
					queryString = queryString + " GROUP BY requirement_id order by jdid desc LIMIT 30";
				}
			}
		...
		System.out.println(
				"********************RecruitmentServiceImpl :: getLoginUserRequirementList Method End*********************");
		return list;
	}
	...
	public List getCurrentStatus(RecruitmentAction recruitmentAction) {
		System.out.println(
				"********************RecruitmentServiceImpl :: getCurrentStatus Method Start*********************");
		...
		ResultSet resultSet = null;
		try {
			queryString = "SELECT * FROM acc_rec_attachment WHERE object_type='CV' AND object_id="
					+ recruitmentAction.getUserSessionId() + " AND status='Active' ORDER BY STATUS LIMIT 10";
			connection = ConnectionProvider.getInstance().getConnection();
			statement = connection.createStatement();
			resultSet = statement.executeQuery(queryString);
			while (resultSet.next()) {
				...
				cons.setDate_of_attachment(
						dateUtility.getInstance().convertDateToViewInDashformat(resultSet.getDate("opp_created_date")));
		...
		System.out.println(
				"********************RecruitmentServiceImpl :: getCurrentStatus Method End*********************");
		return conslist;
	}
	...
	public List getConsultantStatus(RecruitmentAction recruitmentAction) {
		System.out.println(
				"********************RecruitmentServiceImpl :: getConsultantStatus Method Start*********************");
		...
		ResultSet resultSet = null;
		try {
			queryString = "SELECT rcl.reqId, ar.req_name, ar.req_skills, rcl.status,rcl.applied_date FROM req_con_rel rcl JOIN acc_requirements ar ON(rcl.reqId = ar.requirement_id) WHERE consultantId="
					+ recruitmentAction.getUserSessionId() + " ORDER BY STATUS LIMIT 10";
			connection = ConnectionProvider.getInstance().getConnection();
			statement = connection.createStatement();
			resultSet = statement.executeQuery(queryString);
			while (resultSet.next()) {
				...
				consultantListVTO.setCreatedDate(com.mss.msp.util.DateUtility.getInstance()
						.convertDateToViewInDashformat(resultSet.getDate("applied_date")));
		...
		System.out.println(
				"********************RecruitmentServiceImpl :: getConsultantStatus Method End*********************");
		return consStatus;
	}
	 ...
	 * *****************************************************************************
	 */
	public int techReviewForward(RecruitmentAction recruitmentAction, String accToken, String validKey)
			throws ServiceLocatorException {
		...
		try {
			if ("checked".equals(recruitmentAction.getChecked())) {
				if (!"".equals(recruitmentAction.getReviewAlertDate())) {
					reviewAlertDate = dateUtility.getInstance().convertStringToMySQLDateInDashWithTimeWithOutSeconds(
							recruitmentAction.getReviewAlertDate());
				} else {
					reviewAlertDate = " ";
				}
			}
			...
			if (!"".equals(recruitmentAction.getInterviewDate())) {
				callableStatement.setString(4, com.mss.msp.util.DateUtility.getInstance()
						.convertStringToMySQLDateInDashWithTimeWithOutSeconds((recruitmentAction.getInterviewDate())));
			} else {
	 ...
	 **************************************
	 */
	public List getTechReviewDetails(RecruitmentAction recruitmentAction, int roleId, int userId, int orgId) {
		System.out.println(
				"********************RecruitmentServiceImpl :: getTechReviewDetails Method Start*********************");
		ArrayList<ConsultantVTO> list = new ArrayList<ConsultantVTO>();
		StringBuffer stringBuffer = new StringBuffer();
		String queryString = "";
		String accountId = String.valueOf(orgId);
		Connection connection = null;
		Statement statement = null;
		ResultSet resultSet = null;
		...
		try {
			if (roleId == 11) {
				queryString = "SELECT ct.id,acr.jdid,ct.consultant_id,ct.req_id,c.org_id,r.acc_attachment_id,CONCAT(c.first_name,'.',c.last_name) AS consultant_name,a.account_name,c.email1,c.phone1,ct.review_type,ct.forwarded_date,ct.STATUS,ct.scheduled_date,ct.scheduled_time,ct.zone,ct.ven_notify "
						+ "FROM con_techreview ct " + "LEFT OUTER JOIN users c ON(c.usr_id=ct.consultant_id) "
						...
						+ "LEFT OUTER JOIN acc_requirements acr ON(acr.requirement_id=ct.req_id) "
						+ "LEFT OUTER JOIN accounts a ON (acr.acc_id=a.account_id) " + "WHERE  rcr.created_By=" + userId
						+ " AND r.STATUS='active' AND ct.cust_notify=1 ORDER BY forwarded_date  DESC LIMIT 50";
			} else if (roleId == 16) {
				queryString = "SELECT ct.id,acr.jdid,ct.consultant_id,ct.req_id,c.org_id,r.acc_attachment_id, "
						+ "CONCAT(c.first_name,'.',c.last_name) AS consultant_name,a.account_name,c.email1,c.phone1,ct.review_type,ct.forwarded_date,ct.STATUS, "
						+ "ct.scheduled_date,ct.scheduled_time,ct.zone "
						+ "FROM con_techreview ct LEFT OUTER JOIN users c ON(c.usr_id=ct.consultant_id) "
						+ "LEFT OUTER JOIN acc_rec_attachment r ON(r.object_id=c.usr_id AND r.req_id = ct.req_id) "
						+ "LEFT OUTER JOIN req_con_rel rcr ON(ct.consultant_id=rcr.consultantId AND rcr.reqId=ct.req_id) "
						+ "LEFT OUTER JOIN acc_requirements acr ON(acr.requirement_id=ct.req_id) "
						+ "LEFT OUTER JOIN accounts a ON (acr.acc_id=a.account_id) " + "WHERE  rcr.consultantId="
						+ userId + "  ORDER BY forwarded_date  DESC LIMIT 50 ";
			} // AND ct.ven_notify=1 //,ct.cust_notify
			else if (roleId == 1) {
				queryString = "SELECT rcr.vendorcomments,CONCAT(c.first_name,'.',c.last_name) AS NAME,ct.forwarded_date,ct.forwarded_by,"
						...
						+ "c.usr_id,r.acc_attachment_id,ct.status,ct.req_id,ct.review_type,ct.id,c.office_phone,ct.scheduled_date,ct.scheduled_time,ct.zone,acr.jdid,acr.acc_id,ct.cust_notify,a.account_name as cname,b.account_name as vname "
						+ "FROM con_techreview ct " + "LEFT OUTER JOIN users c ON(c.usr_id=ct.consultant_id)"
						+ "LEFT OUTER JOIN acc_rec_attachment r ON(r.object_id=c.usr_id AND r.req_id = ct.req_id) "
						+ "LEFT OUTER JOIN users u ON(u.usr_id=ct.forwarded_by) "
						+ "LEFT OUTER JOIN req_con_rel rcr ON(ct.consultant_id=rcr.consultantId AND rcr.reqId=ct.req_id)"
						+ "LEFT OUTER JOIN acc_requirements acr ON(ct.req_id=acr.requirement_id)"
						+ "LEFT OUTER JOIN accounts a ON (acr.acc_id=a.account_id) "
						+ "LEFT OUTER JOIN accounts b ON(rcr.createdbyOrgId=b.account_id) ";

				String accList = com.mss.msp.util.DataSourceDataProvider.getInstance()
						.customersOrgIdsForCSR(recruitmentAction.getUserSessionId());
				queryString += " where r.STATUS ='Active' AND acr.acc_id IN(" + accList
						+ ") ORDER BY forwarded_date  DESC LIMIT 50";

			} else {
				queryString = "SELECT rcr.vendorcomments,CONCAT(c.first_name,'.',c.last_name) AS NAME,ct.forwarded_by,ct.forwarded_date,CONCAT(u.first_name,'.',u.last_name)AS fbyName,c.email1,c.phone1,c.usr_id,r.acc_attachment_id,ct.status,ct.req_id,ct.review_type,ct.id,c.office_phone,ct.scheduled_date,ct.scheduled_time,ct.zone,acr.jdid,acr.acc_id,ct.cust_notify "
						+ "FROM con_techreview ct " + "LEFT OUTER JOIN users c ON(c.usr_id=ct.consultant_id) "
						+ "LEFT OUTER JOIN acc_rec_attachment r ON(r.object_id=c.usr_id AND r.req_id = ct.req_id) "
						+ "LEFT OUTER JOIN users u ON(u.usr_id=ct.forwarded_by) "
						+ "LEFT OUTER JOIN req_con_rel rcr ON(ct.consultant_id=rcr.consultantId AND rcr.reqId=ct.req_id)"
						+ "LEFT OUTER JOIN acc_requirements acr ON(acr.requirement_id=ct.req_id)"
						+ "WHERE ct.forwarded_to=" + recruitmentAction.getUserSessionId()
						+ " AND r.STATUS='active' ORDER BY forwarded_date  DESC LIMIT 50";
			}
			...
			resultSet = statement.executeQuery(queryString);
			if (roleId == 11 || roleId == 16) {
				while (resultSet.next()) {

					ConsultantVTO consultantVTO = new ConsultantVTO();
					consultantVTO.setConTechReviewId(resultSet.getInt("id"));
					consultantVTO.setJdId(resultSet.getString("acr.jdid"));
					consultantVTO.setConsult_id(resultSet.getInt("ct.consultant_id"));
					consultantVTO.setRequirementId(resultSet.getInt("req_id"));
					consultantVTO.setAccountSearchID(accountId);
					consultantVTO.setResumeId(resultSet.getString("acc_attachment_id"));

					consultantVTO.setConsult_name(resultSet.getString("consultant_name"));
					consultantVTO.setCustomerName(resultSet.getString("a.account_name"));
					...
					consultantVTO.setForwardedDate(com.mss.msp.util.DateUtility.getInstance()
							.convertToviewFormatInDash(resultSet.getString("forwarded_date")));
					consultantVTO.setStatus(resultSet.getString("status"));
					if (resultSet.getString("scheduled_date") != null) {
						consultantVTO.setScheduledDate(com.mss.msp.util.DateUtility.getInstance()
								.convertToviewFormatInDash(resultSet.getString("scheduled_date")));
					} else {
					...
					consultantVTO.setConsultantExamToken(
							DataSourceDataProvider.getInstance().getTechreviewToken(resultSet.getInt("id")));
					if (roleId == 11) {
						if (resultSet.getBoolean("ct.ven_notify")) {
							consultantVTO.setVendorNotify(true);
						} else {
							consultantVTO.setVendorNotify(false);
						}
				...
				while (resultSet.next()) {
					...
					consultantVTO.setJdId(resultSet.getString("acr.jdid"));
					consultantVTO.setAccountSearchID(resultSet.getString("acr.acc_id"));

					consultantVTO.setVendorcomments(resultSet.getString("vendorcomments"));
					if (resultSet.getBoolean("ct.cust_notify")) {
						consultantVTO.setCustomerNotify(true);
					} else {
						consultantVTO.setCustomerNotify(false);
					}
					consultantVTO.setCustomerName(resultSet.getString("cname"));
					consultantVTO.setVendorName(resultSet.getString("vname"));
					list.add(consultantVTO);
				}
			} else {
				while (resultSet.next()) {
		...
		System.out.println(
				"********************RecruitmentServiceImpl :: getTechReviewDetails Method End*********************");
		return list;
	}
	 ...
	 * *****************************************************************************
	 */
	public String getSearchTechReviewList(RecruitmentAction recruitmentAction,int roleId,int userId,int orgId) throws ServiceLocatorException {
		System.out.println(
				"********************RecruitmentServiceImpl :: getSearchTechReviewList Method Start*********************");
		DateUtility dateUtility = new DateUtility();
		StringBuffer stringBuffer = new StringBuffer();
		String queryString = "";
		String resultString = "";
		String startdate = "";
		String endDate = "";
		boolean cust_notify=false;
		boolean ven_notify=false;
		...
		try {
			if(roleId==11)
			{	
			queryString = "SELECT ct.id,acr.jdid,ct.consultant_id,ct.req_id,c.org_id,r.acc_attachment_id,CONCAT(c.first_name,'.',c.last_name) AS NAME,a.account_name,c.email1,c.phone1,ct.review_type,ct.forwarded_date,ct.STATUS,ct.scheduled_date,ct.scheduled_time,ct.zone,ct.review_type,ct.cust_notify,ct.ven_notify "
						 + "FROM con_techreview ct " + "LEFT OUTER JOIN users c ON(c.usr_id=ct.consultant_id) " 
						 + "LEFT OUTER JOIN acc_rec_attachment r ON(r.object_id=c.usr_id AND r.req_id = ct.req_id) " 
						 + "LEFT OUTER JOIN req_con_rel rcr ON(ct.consultant_id=rcr.consultantId AND rcr.reqId=ct.req_id) "
						 + "LEFT OUTER JOIN acc_requirements acr ON(acr.requirement_id=ct.req_id) "
						 + "LEFT OUTER JOIN accounts a ON (acr.acc_id=a.account_id) "
						 + "WHERE  rcr.created_By="+ userId
						 + " AND r.STATUS='active' AND ct.cust_notify=1";
			}
			else if(roleId==16)
			{	
				queryString= "SELECT ct.id,acr.jdid,ct.consultant_id,ct.req_id,c.org_id,r.acc_attachment_id, "
			...
			queryString = "SELECT rcr.vendorcomments,CONCAT(c.first_name,'.',c.last_name) AS NAME,ct.forwarded_date,ct.forwarded_by,"
					+ "CONCAT(u.first_name,'.',u.last_name)AS fbyName,c.email1,c.phone1,"
					+ "c.usr_id,r.acc_attachment_id,ct.status,ct.req_id,ct.review_type,ct.id,c.office_phone,ct.scheduled_date,ct.scheduled_time,ct.review_type,ct.zone,acr.jdid,acr.acc_id,ct.cust_notify,a.account_name as cname,b.account_name as vname "
					+ "FROM con_techreview ct " + "LEFT OUTER JOIN users c ON(c.usr_id=ct.consultant_id)"
					+ "LEFT OUTER JOIN acc_rec_attachment r ON(r.object_id=c.usr_id AND r.req_id = ct.req_id) "
					+ "LEFT OUTER JOIN users u ON(u.usr_id=ct.forwarded_by) "
					+ "LEFT OUTER JOIN req_con_rel rcr ON(ct.consultant_id=rcr.consultantId AND rcr.reqId=ct.req_id)"
			...
			String 	accList=com.mss.msp.util.DataSourceDataProvider.getInstance().customersOrgIdsForCSR(recruitmentAction.getUserSessionId());
			queryString+=" where r.STATUS ='Active' AND acr.acc_id IN("+accList+")";					
			}
			else
			{
			queryString = "SELECT rcr.vendorcomments,CONCAT(c.first_name,'.',c.last_name) AS NAME,ct.forwarded_date,ct.forwarded_by,"
					+ "CONCAT(u.first_name,'.',u.last_name)AS fbyName,c.email1,c.phone1,"
					+ "c.usr_id,r.acc_attachment_id,ct.status,ct.req_id,ct.review_type,ct.id,c.office_phone,ct.scheduled_date,ct.scheduled_time,ct.zone,ct.review_type,acr.jdid,acr.acc_id,ct.cust_notify "
					+ "FROM con_techreview ct " + "LEFT OUTER JOIN users c ON(c.usr_id=ct.consultant_id)"
					+ "LEFT OUTER JOIN acc_rec_attachment r ON(r.object_id=c.usr_id AND r.req_id = ct.req_id) "
					+ "LEFT OUTER JOIN users u ON(u.usr_id=ct.forwarded_by) "
					+ "LEFT OUTER JOIN req_con_rel rcr ON(ct.consultant_id=rcr.consultantId AND rcr.reqId=ct.req_id)"
			...
			if (!"".equals(recruitmentAction.getReviewStartDate())
					&& !"".equals(recruitmentAction.getReviewEndDate())) {
				startdate = dateUtility.getInstance()
						.convertStringToMySQLDateInDash(recruitmentAction.getReviewStartDate());
				endDate = dateUtility.getInstance()
						.convertStringToMySQLDateInDash(recruitmentAction.getReviewEndDate());
			...
			if (!"-1".equalsIgnoreCase(recruitmentAction.getInterviewType())) {
				queryString = queryString + " and ct.review_type = '" + recruitmentAction.getInterviewType() + "'";
			}
			...
			while (resultSet.next()) {
				if (resultSet.getString("scheduled_date") != null) {
					scheduledDate = com.mss.msp.util.DateUtility.getInstance()
							.convertToviewFormatInDash(resultSet.getString("scheduled_date"));
				} else {
					scheduledDate = "";
				}
				if(roleId==11||roleId==16)
				{
					if(roleId==11)
					{	
					if(resultSet.getBoolean("ven_notify"))
					{
						ven_notify=true;
					}
					else
					{
						...
						ven_notify=false;
				resultString += resultSet.getString("ct.consultant_id") + "|" + resultSet.getString("NAME") + "|"
						...
						+ "|" + resultSet.getString("acc_attachment_id") + "|" + "--"
						+ "|" + resultSet.getString("status") + "|" + resultSet.getString("req_id") + "|"
						+ resultSet.getString("ct.review_type") + "|" + resultSet.getInt("ct.id") + "|" + scheduledDate
						+ "|" + resultSet.getString("scheduled_time") + "|" + resultSet.getString("zone") + "|"
						+ " "  + "|" + resultSet.getString("acr.jdid") + "|" + orgId + "|"+ roleId + "|" + ven_notify + "|" +"^";
				}
				else if(roleId==1)
				{	
					if(resultSet.getBoolean("cust_notify"))
					{
						cust_notify=true;
					}
					else
				...
				resultString += resultSet.getString("usr_id") + "|" + resultSet.getString("NAME") + "|"
						+ resultSet.getString("email1") + "|" + resultSet.getString("phone1") + "|"
						+ resultSet.getString("fbyName") + "|"
						+ dateUtility.getInstance().convertToviewFormatInDash(resultSet.getString("forwarded_date"))
						+ "|" + resultSet.getString("acc_attachment_id") + "|" + resultSet.getString("forwarded_by")
						+ "|" + resultSet.getString("status") + "|" + resultSet.getString("req_id") + "|"
						+ resultSet.getString("ct.review_type") + "|" + resultSet.getInt("ct.id") + "|" + scheduledDate
						+ "|" + resultSet.getString("scheduled_time") + "|" + resultSet.getString("zone") + "|"
						+ resultSet.getString("vendorcomments") + "|" + resultSet.getString("acr.jdid") + "|" + resultSet.getString("acr.acc_id") + "|" + roleId + "|" + cust_notify + "|" + resultSet.getString("cname") + "|" + resultSet.getString("vname") + "|"+ "^";
				}
				...
				resultString += resultSet.getString("usr_id") + "|" + resultSet.getString("NAME") + "|"
						...
						+ resultSet.getString("ct.review_type") + "|" + resultSet.getInt("ct.id") + "|" + scheduledDate
						+ "|" + resultSet.getString("scheduled_time") + "|" + resultSet.getString("zone") + "|"
						+ resultSet.getString("vendorcomments") + "|" + resultSet.getString("acr.jdid") + "|" + resultSet.getString("acr.acc_id") + "|" + roleId + "|" + cust_notify + "|" + "^";
				}
		...
		System.out.println(
				"********************RecruitmentServiceImpl :: getSearchTechReviewList Method End*********************");
		return resultString;
	}
	...
	public String getConsultDetailsOnOverlay(RecruitmentAction recruitmentAction) throws ServiceLocatorException {
		System.out.println(
				"********************RecruitmentServiceImpl :: getConsultDetailsOnOverlay Method Start*********************");
		StringBuffer stringBuffer = new StringBuffer();
		String queryString = "";
		String resultString = "";
		String jobTitle = " ";
		...
		try {
			if (!"Online".equals(recruitmentAction.getReviewType())
					&& !"Psychometric".equals(recruitmentAction.getReviewType())) {
				queryString = "SELECT CONCAT(c.first_name,'.',c.last_name) AS NAME,c.email1,c.phone1,cd.job_title,rcr.con_skill,"
						...
						+ recruitmentAction.getConsultantId() + " AND ar.STATUS='active' AND cr.id="
						+ recruitmentAction.getContechId() + " AND rcr.reqId=" + recruitmentAction.getReq_Id();
			} else {
				queryString = "SELECT CONCAT(c.first_name,'.',c.last_name) AS NAME,so.techreviewid,so.consultantid,cr.id,cr.STATUS,so.option1,so.option2,so.option3,so.option4,so.option5,so.option6,so.option7,so.option8,so.option9,so.option10,c.email1,so.createddate,c.phone1,cd.job_title,so.eid,so.examstatus,se.completed_ts,cr.note,cr.comments  FROM sb_onlineexam so"
						...
						+ recruitmentAction.getContechId() + "";
			}
			...
			while (resultSet.next()) {
				if (!"Online".equals(recruitmentAction.getReviewType())
					...
					resultString = resultSet.getString("NAME") + "|" + resultSet.getString("email1") + "|"
							...
							+ "|" + resultSet.getString("con_skill") + "|" + resultSet.getString("review_type") + "|"
							+ resultSet.getString("tech_skills") + "|" + resultSet.getString("domain_skills") + "|"
							+ resultSet.getString("commmunication_skills") + "|" + resultSet.getString("cr.comments")
							+ "|" + resultSet.getString("cr.note") + "|" + resultSet.getString("interview_lacation")
							+ "^";
				} else {
					if (resultSet.last()) {
						...
						resultString = resultSet.getString("NAME") + "|" + resultSet.getString("job_title") + "|"
								...
								+ resultSet.getString("so.examstatus") + "|" + date + "|" + resultSet.getString("note")
		...
		System.out.println(
				"********************RecruitmentServiceImpl :: getConsultDetailsOnOverlay Method End*********************");
		return resultString;
	}
	...
	public int saveTechReviewResults(RecruitmentAction recruitmentAction) throws ServiceLocatorException {
		System.out.println(
				"********************RecruitmentServiceImpl :: saveTechReviewResults Method Start*********************");
		StringBuffer stringBuffer = new StringBuffer();
		String queryString = "";
		int resultString = 0;
		Connection connection = null;
		...
		try {
			queryString = "UPDATE con_techreview ct left outer join req_con_rel rc on(rc.consultantId=ct.consultant_id) "
					+ "SET ct.tech_skills=" + recruitmentAction.getTechSkill() + " ," + "ct.domain_skills="
					+ recruitmentAction.getDomainSkill() + " ," + "ct.commmunication_skills="
					+ recruitmentAction.getComSkill() + " ," + "ct.rating=" + recruitmentAction.getRating() + " ,"
					+ "ct.comments='" + recruitmentAction.getConsultantComments() + "' ," + "ct.STATUS='"
					+ recruitmentAction.getFinalTechReviewStatus() + "' ," + "ct.review_type='"
					+ recruitmentAction.getInterviewType() + "' ," + "ct.techie_title='"
					+ recruitmentAction.getTechTitle() + "' ," + "rc.STATUS='"
					+ recruitmentAction.getFinalTechReviewStatus() + "'," + "rc.customercomments='"
					+ recruitmentAction.getConsultantComments() + "' ," + "rc.modified_By='"
					+ recruitmentAction.getUserSessionId() + "'," + "rc.modified_date='"
					+ com.mss.msp.util.DateUtility.getInstance().getCurrentMySqlDate() + "'," + "rc.tech_review_date='"
					+ com.mss.msp.util.DateUtility.getInstance().getCurrentMySqlDate() + "'," + "rc.tech_review_by='"
					+ recruitmentAction.getUserSessionId() + "' " + "WHERE ct.consultant_id="
					+ recruitmentAction.getConsultId() + " AND ct.req_id=" + recruitmentAction.getRequirementId() + " "
					+ "AND rc.consultantId=" + recruitmentAction.getConsultId() + " AND rc.reqId="
					+ recruitmentAction.getRequirementId() + " " + "AND ct.forwarded_to="
					+ recruitmentAction.getUserSessionId() + " AND ct.id=" + recruitmentAction.getContechId();
			connection = ConnectionProvider.getInstance().getConnection();
			statement = connection.createStatement();
		...
		System.out.println(
				"********************RecruitmentServiceImpl :: saveTechReviewResults Method End*********************");
		return resultString;
	}
	...
	public int doDeleteConsultantAttachment(RecruitmentAction recruitmentAction) throws ServiceLocatorException {
		System.out.println(
				"********************RecruitmentServiceImpl :: doDeleteConsultantAttachment Method Start*********************");
		int deletedRows = 0;
		Connection connection = null;
		Statement statement = null;
		String queryString = "update acc_rec_attachment set status='Inactive' WHERE acc_attachment_id="
				+ recruitmentAction.getAcc_attachment_id();
		...
		System.out.println(
				"********************RecruitmentServiceImpl :: doDeleteConsultantAttachment Method End*********************");
		return deletedRows;
	}
	...
	public int updateConsultAttachmentDetails(RecruitmentAction recruitmentaction) {
		System.out.println(
				"********************RecruitmentServiceImpl :: updateConsultAttachmentDetails Method Start*********************");
		StringBuffer stringBuffer = new StringBuffer();
		String queryString = "";
		int addResult = 0;
		boolean isExceute = false;
		...
		System.out.println(
				"********************RecruitmentServiceImpl :: updateConsultAttachmentDetails Method End*********************");
		return addResult;
	}
	...
	public List getTechReviewSearchDetails(RecruitmentAction recruitmentAction) {
		System.out.println(
				"********************RecruitmentServiceImpl :: getTechReviewSearchDetails Method Start*********************");
		ArrayList<ConsultantVTO> list = new ArrayList<ConsultantVTO>();
		StringBuffer stringBuffer = new StringBuffer();
		String queryString = "";
		Connection connection = null;
		...
		try {
			queryString = "SELECT forwarded_to_name1,forwarded_to1,id,review_type,forwarded_to,consultant_id,req_id,scheduled_date,forwarded_to_name,comments,techie_title,STATUS,rating,forwarded_by,forwarded_date FROM con_techreview WHERE consultant_id="
					+ recruitmentAction.getConsult_id() + " AND req_id=" + recruitmentAction.getRequirementId();
			connection = ConnectionProvider.getInstance().getConnection();
			statement = connection.createStatement();
			resultSet = statement.executeQuery(queryString);
			while (resultSet.next()) {
				ConsultantVTO consultantVTO = new ConsultantVTO();
				if (resultSet.getString("scheduled_date") != null) {
					consultantVTO.setDateOfReview(com.mss.msp.util.DateUtility.getInstance()
				...
				consultantVTO.setForwardedBy(DataSourceDataProvider.getInstance()
						.getFnameandLnamebyUserid(resultSet.getInt("forwarded_by")));
				consultantVTO.setForwardedDate(
						DateUtility.getInstance().convertToviewFormatInDash(resultSet.getString("forwarded_date")));
				list.add(consultantVTO);
			}
		} catch (Exception sqe) {
		...
		System.out.println(
				"********************RecruitmentServiceImpl :: getTechReviewSearchDetails Method End*********************");
		return list;
	}
	...
	public int userMigration(RecruitmentAction recruitmentAction) throws ServiceLocatorException {
		System.out.println(
				"********************RecruitmentServiceImpl :: userMigration Method Start*********************");
		int resultString = 0;
		...
		System.out
				.println("********************RecruitmentServiceImpl :: userMigration Method End*********************");
		return resultString;
	}
	 ...
	 * *****************************************************************************
	 */
	public int doAddVendorFormDetails(RecruitmentAction recruitmentAction, int orgId, String typeOfAccount)
			throws ServiceLocatorException {
		System.out.println(
				"********************RecruitmentServiceImpl :: doAddVendorFormDetails Method Start*********************");
		StringBuffer stringBuffer = new StringBuffer();
		String queryString = "";
		int addResult = 0;
		boolean isExceute = false;
		...
		try {
			...
			preparedStatement.setString(7, com.mss.msp.util.DateUtility.getInstance()
					.convertStringToMySQLDateInDash(recruitmentAction.getValidity()));
			preparedStatement.setString(8, StringUtils.capitalize(recruitmentAction.getAttachmentTitle()));
		...
		System.out.println(
				"********************RecruitmentServiceImpl :: doAddVendorFormDetails Method End*********************");
		return addResult;
	}
	 ...
	 * *****************************************************************************
	 */
	public int doUpdateVendorFormDetails(RecruitmentAction recruitmentAction, int attachment_id)
			throws ServiceLocatorException {
		System.out.println(
				"********************RecruitmentServiceImpl :: doUpdateVendorFormDetails Method Start*********************");
		StringBuffer stringBuffer = new StringBuffer();
		Connection connection = null;
		PreparedStatement preparedStatement = null;
		String queryString = "";
		...
		try {
			connection = ConnectionProvider.getInstance().getConnection();
			queryString = "UPDATE acc_rec_attachment SET validity=?,comments=?,attachment_title=?  WHERE acc_attachment_id="
					+ attachment_id;
			connection = ConnectionProvider.getInstance().getConnection();
			preparedStatement = connection.prepareStatement(queryString);
			preparedStatement.setString(1, com.mss.msp.util.DateUtility.getInstance()
					.convertStringToMySQLDateInDash(recruitmentAction.getEditValidity()));
			preparedStatement.setString(2, recruitmentAction.getEditattachmentComments());
			preparedStatement.setString(3, StringUtils.capitalize(recruitmentAction.getEditTitle()));
			addResult = preparedStatement.executeUpdate();
		} catch (Exception sqe) {
			sqe.printStackTrace();
		} finally {
		...
		System.out.println(
				"********************RecruitmentServiceImpl :: doUpdateVendorFormDetails Method End*********************");
		return addResult;
	}
	 ...
	 * *****************************************************************************
	 */
	public List getVendorRequirementsDashboard(HttpServletRequest httpServletRequest,
			RecruitmentAction recruitmentAction) {
		System.out.println(
				"********************RecruitmentServiceImpl :: getVendorRequirementsDashboard Method Start*********************");
		ArrayList<RequirementListVTO> list = new ArrayList<RequirementListVTO>();
		StringBuffer stringBuffer = new StringBuffer();
		String queryString = "";
		Connection connection = null;
		...
		try {
			String typeofusr = httpServletRequest.getSession(false).getAttribute(ApplicationConstants.TYPE_OF_USER)
					.toString();
			queryString = "SELECT acc_id,account_name,jdid,requirement_id,req_name,no_of_resources,target_rate,max_rate FROM accounts a JOIN acc_requirements ar ON ar.acc_id=a.account_id LEFT OUTER JOIN req_ven_rel r ON requirement_id=req_id WHERE ven_id="
					+ recruitmentAction.getOrgid()
					+ " AND  NOW() >= req_access_time AND  r.STATUS LIKE 'Active' AND  ar.req_status = 'OR' order by requirement_id desc LIMIT 3 ";
			connection = ConnectionProvider.getInstance().getConnection();
			statement = connection.createStatement();
			resultSet = statement.executeQuery(queryString);
			while (resultSet.next()) {
				...
				requirementListVTO.setTitle(resultSet.getString("req_name"));
				requirementListVTO.setNoOfPosition(resultSet.getString("no_of_resources"));
				requirementListVTO.setOrgId(Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.ORG_ID).toString()));
				requirementListVTO.setTargetRate(
						String.valueOf((resultSet.getDouble("target_rate") + resultSet.getDouble("max_rate")) / 2));
				requirementListVTO.setRequirementMaxRate(resultSet.getString("max_rate"));
				requirementListVTO.setCustomerName(resultSet.getString("account_name"));
				list.add(requirementListVTO);
			}
		...
		System.out.println(
				"********************RecruitmentServiceImpl :: getVendorRequirementsDashboard Method End*********************");
		return list;
	}

	public ConsultantVTO getConsultantProfile(RecruitmentAction recruitmentAction, Map map)
			throws ServiceLocatorException {
		System.out.println(
				"********************RecruitmentServiceImpl :: getConsultantProfile Method Start*********************");
		ConsultantVTO consult = new ConsultantVTO();
		DateUtility dateUtility = new DateUtility();
		...
		try {
			queryString = "SELECT c.usr_id AS usr_consultant_id,c.job_title,c.usr_industry,c.preffered_country,c.preffered_region,"
					+ " c.preffered_state,c.referred_by,c.experience,c.rate_salary,c.available_from, "
					+ " c.available,c.education,c.relocation,c.comments,c.ssn_number,u.email1,u.email2, "
					+ " u.first_name,u.last_name,u.middle_name,u.dob,u.living_country, "
					+ " u.working_country,u.phone2,u.phone1,u.cur_status ,u.linkedin_link, u.facebook_link, "
					+ " u.twitter_link,u.image_path,c.consultant_primary_skill, c.consultant_skills,a.address,a.city,a.state,a.zip,a.country, "
					+ " u.twitter_link,c.consultant_primary_skill, c.consultant_skills,c.other_skills,c.other_sec_skills,a.address,a.city,a.state,a.zip,a.country, "
					+ " a.phone,a.address2,a.address_flag,a.STATUS,ar.object_id, ar.acc_attachment_id, "
					+ " ar.object_type, ar.attachment_path, ar.attachment_name,u.type_of_user,c.visa,c.idprooftype,c.idproofattachment,c.city,c.state "
					+ " FROM users u JOIN usr_details c ON (u.usr_id = c.usr_id) "
					+ " JOIN usr_address a ON (u.usr_id = a.usr_id) JOIN acc_rec_attachment ar ON(ar.object_id=u.usr_id)"
					+ " WHERE u.usr_id =?  AND object_type= 'CV'";
			...
			while (resultSet.next()) {
				...
				if ((!"".equals(resultSet.getString("image_path"))) && (resultSet.getString("image_path") != null)) {

					consult.setConsultantImagePath(resultSet.getString("image_path"));
				} else {
					consult.setConsultantImagePath(Properties.getProperty("Profile.GENERALIMAGE").toString());
				}
				...
				if (resultSet.getString("consultant_skills") != null) {
					...
					System.out
							.println("getConsultantProfile::reqSkillsResultString----------->" + reqSkillsResultString);
					consult.setSkillSetList(list1);
				}
				consult.setConsult_alterEmail(resultSet.getString("email2"));
				consult.setConsult_otherSkills(resultSet.getString("other_skills"));
			...
			Map csrDetails = DataSourceDataProvider.getInstance()
					.getCSRApprovalStatus(recruitmentAction.getRequirementId(), recruitmentAction.getConsult_id());
			if (csrDetails.size() > 0) {
				consult.setCsrAppComments(csrDetails.get("comments").toString());
				consult.setCsrAppStatus(csrDetails.get("status").toString());
			}
		...
		System.out.println(
				"********************RecruitmentServiceImpl :: getConsultantProfile Method End*********************");
		return consult;
	}

	public List getVendorsListForConsultant(RecruitmentAction recruitmentAction, int consultantId)
			throws ServiceLocatorException {

		System.out.println(
				"********************RecruitmentServiceImpl :: getVendorsListForConsultant Method Start*********************");
		ArrayList<Account> vendorList = new ArrayList<Account>();
		...
		try {
			...
			statesMap = DataSourceDataProvider.getInstance().getAllStates();

			queryString = "SELECT account_id,account_name,account_url,acc_industry_type,acc_zip,acc_state,acc_country,business_type,staffing_mode,acc_category_specilization FROM accounts acc LEFT JOIN acc_address accadd ON(accadd.acc_id=account_id) LEFT JOIN acc_basic_info abasic ON (abasic.acc_id=account_id) LEFT JOIN org_rel ON(account_id=related_org_Id) WHERE acc_type=5 AND accadd.is_primary=1 ";

			if (recruitmentAction.getVenName() != null && !"".equals(recruitmentAction.getVenName())) {
				queryString = queryString + " AND account_name like'%" + recruitmentAction.getVenName() + "%' ";
			}
			if (recruitmentAction.getVenUrl() != null && !"".equals(recruitmentAction.getVenUrl())) {
				queryString = queryString + " AND account_url like'%" + recruitmentAction.getVenUrl() + "%' ";
			}
			if (recruitmentAction.getVenZip() != null && !"".equals(recruitmentAction.getVenZip())) {
				queryString = queryString + " AND acc_zip like'%" + recruitmentAction.getVenZip() + "%' ";
			}

			if (recruitmentAction.getVendorState() != 0 && recruitmentAction.getVendorState() != -1) {
				queryString = queryString + " AND acc_state =" + recruitmentAction.getVendorState() + " ";
			}
			if (recruitmentAction.getVendorCountry() != 0 && recruitmentAction.getVendorCountry() != -1) {
				queryString = queryString + " AND acc_country =" + recruitmentAction.getVendorCountry() + " ";
			}
			if (recruitmentAction.getVendorIndustry() != 0 && recruitmentAction.getVendorIndustry() != -1) {
				queryString = queryString + " AND acc_industry_type =" + recruitmentAction.getVendorIndustry() + " ";
			}

			queryString = queryString + " LIMIT 50";

			System.out.println("getVendorsListForConsultant--queryString->" + queryString);
			...
			while (resultSet.next()) {
				...
				vendorAccount.setId(resultSet.getInt("account_id"));
				vendorAccount.setName(resultSet.getString("account_name"));
				vendorAccount.setUrl(resultSet.getString("account_url"));

				// System.out.println("Vendor
				// state-->"+resultSet.getString("acc_state"));

				if (resultSet.getString("acc_state") != null && !"".equals(resultSet.getString("acc_state"))) {

					// String s =
					// statesMap.get(resultSet.getString("acc_state"));
					// System.out.println("Vendor state in
					// if-->"+resultSet.getString("acc_state"));
					vendorAccount.setVendorState(((String) (statesMap.get(resultSet.getString("acc_state")))));

				} else {
					// System.out.println("Vendor state in
					// else-->"+resultSet.getString("acc_state"));
					vendorAccount.setVendorState("");
				}
				// System.out.println("Vendor state--after
				// processing-->"+vendorAccount.getVendorState());
				vendorAccount.setVenSpecialization(resultSet.getString("acc_category_specilization"));
				// vendorAccount.setCountry(resultSet.getString("acc_country"));
				vendorAccount.setBusinessType(resultSet.getString("business_type"));
				vendorAccount.setStaffingMode(resultSet.getString("staffing_mode"));

				String status = DataSourceDataProvider.getInstance()
						.consultantVendorAssociationCheck(vendorAccount.getId(), consultantId);
				if (status != null && !"".equals(status)) {
					vendorAccount.setConsultVenAssociateFlag("yes");
					vendorAccount.setStatus(status);
				} else {
					vendorAccount.setConsultVenAssociateFlag("no");
					vendorAccount.setStatus("--");
				}
		...
		System.out.println(
				"********************RecruitmentServiceImpl :: getVendorsListForConsultant Method End*********************");
		return vendorList;
	}
	 ...
	 * Author :
	 *
	 * ForUse : updateConsultantProfile() method is used to
	 *
	 * *****************************************************************************
	 */
	public ConsultantVTO updateConsultantProfile(RecruitmentAction recruitmentAction, int userSessionId)
			throws ServiceLocatorException {
		System.out.println(
				"********************RecruitmentServiceImpl :: updateConsultantProfile Method Start*********************");
		DateUtility dateUtility = new DateUtility();
		ConsultantVTO consult = new ConsultantVTO();
		Connection connection = null;
		CallableStatement callableStatement = null;
		...
		try {
			...
			callableStatement = connection.prepareCall(
					"{CALL updateConsultantDetails(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}");
			System.out.println("updateConsultantProfile :: procedure name : updateConsultantDetails ");
			callableStatement.setString(1, recruitmentAction.getConsult_email());
			callableStatement.setString(2, recruitmentAction.getConsult_fstname());
			callableStatement.setString(3, recruitmentAction.getConsult_lstname());
			callableStatement.setString(4, recruitmentAction.getConsult_midname());
			if (recruitmentAction.getConsult_dob() != null && !"".equals(recruitmentAction.getConsult_dob())) {
				callableStatement.setString(5,
						dateUtility.getInstance().convertStringToMySQLDateInDash(recruitmentAction.getConsult_dob()));
			} else {
				callableStatement.setString(5, recruitmentAction.getConsult_dob());
			}
			...
			callableStatement.setInt(35, userSessionId);
			callableStatement.setString(36, recruitmentAction.getReqSkillSet());
			callableStatement.setString(37, "Active");
			callableStatement.setString(38, recruitmentAction.getConsult_alterEmail());
			callableStatement.setString(39,
					com.mss.msp.util.DataUtility.encrypted(recruitmentAction.getConsult_ssnNo()));
			callableStatement.setString(40, recruitmentAction.getConsult_referredBy());
			...
			callableStatement.setString(45, null);
			callableStatement.setString(46, recruitmentAction.getConsultantIdProof());
			callableStatement.setString(47, recruitmentAction.getPrimaryValues());
			System.out.println("in update primary skill values----------->" + recruitmentAction.getPrimaryValues());
			...
			callableStatement.setString(52, recruitmentAction.getConsult_otherSecSkills());
			callableStatement.registerOutParameter(53, Types.INTEGER);
			System.out.println(recruitmentAction.getConsultwCity());
			isExceute = callableStatement.execute();
			updatedRows = callableStatement.getInt(53);
			if (updatedRows > 0) {
				recruitmentAction.setUpdateMessage("success");
	 ...
	 **************************************
	 */
	public List getVenConRequirements(HttpServletRequest httpServletRequest, RecruitmentAction recruitmentAction) {
		System.out.println(
				"********************RecruitmentServiceImpl :: getVenConRequirements Method Start*********************");
		ArrayList<RequirementListVTO> list = new ArrayList<RequirementListVTO>();
		StringBuffer stringBuffer = new StringBuffer();
		String queryString = "";
		String joined = "";
		...
		try {
			...
			queryString = "SELECT jdid,requirement_id,req_name,tax_term,req_skills FROM acc_requirements LEFT OUTER JOIN req_con_rel r ON requirement_id=reqId WHERE createdbyOrgId="
					+ recruitmentAction.getSessionOrgId() + "  AND consultantId=" + recruitmentAction.getUserSessionId()
					+ "";

			if (recruitmentAction.getJdId() != null && !"".equals(recruitmentAction.getJdId())) {
				queryString = queryString + " AND jdid like'%" + recruitmentAction.getJdId() + "%' ";
			}
			if (recruitmentAction.getJobTitle() != null && !"".equals(recruitmentAction.getJobTitle())) {
				queryString = queryString + " AND req_name like'%" + recruitmentAction.getJobTitle() + "%' ";
			}
			if (recruitmentAction.getSkillValues() != null && !"".equals(recruitmentAction.getSkillValues())) {
				queryString = queryString + " AND req_skills like'%" + recruitmentAction.getSkillValues() + "%' ";
			}

			/*
			 * if (sessionusrPrimaryrole != 3 && sessionusrPrimaryrole != 2 &&
			 * sessionusrPrimaryrole != 13 && sessionusrPrimaryrole != 1) { if
			 * (httpServletRequest.getSession(false)
			 * .getAttribute(ApplicationConstants.USER_CATEGORY_LIST) != null) {
			 * queryString += " and req_category IN (" +
			 * httpServletRequest.getSession(false)
			 * .getAttribute(ApplicationConstants.USER_CATEGORY_LIST).toString()
			 * + ") "; } }
			 */
			queryString = queryString + " order by jdid desc LIMIT 30";
			// }
			System.out.println("getVenConRequirements::queryString     -->" + queryString);
			connection = ConnectionProvider.getInstance().getConnection();
			statement = connection.createStatement();
			resultSet = statement.executeQuery(queryString);
			while (resultSet.next()) {
				/*
				 * String status = ""; if
				 * (resultSet.getString("req_status").equalsIgnoreCase("O")) {
				 * status = "Opened"; } else if
				 * (resultSet.getString("req_status").equalsIgnoreCase("R")) {
				 * status = "Released"; } else if
				 * (resultSet.getString("req_status").equalsIgnoreCase("OR")) {
				 * status = "Open for Resume"; } else if
				 * (resultSet.getString("req_status").equalsIgnoreCase("C")) {
				 * status = "Closed"; } else if
				 * (resultSet.getString("req_status").equalsIgnoreCase("F")) {
				 * status = "Forecast"; } else if
				 * (resultSet.getString("req_status").equalsIgnoreCase("I")) {
				 * status = "Inprogess"; } else if
				 * (resultSet.getString("req_status").equalsIgnoreCase("H")) {
				 * status = "Hold"; } else if
				 * (resultSet.getString("req_status").equalsIgnoreCase("W")) {
				 * status = "Withdrawn"; } else if
				 * (resultSet.getString("req_status").equalsIgnoreCase("S")) {
				 * status = "Won"; } else if
				 * (resultSet.getString("req_status").equalsIgnoreCase("L")) {
				 * status = "Lost"; }
				 */
				RequirementListVTO requirementListVTO = new RequirementListVTO();
				requirementListVTO.setJdId(resultSet.getString("jdid"));
				...
				requirementListVTO.setTitle(resultSet.getString("req_name"));
				/*
				 * requirementListVTO.setNoOfPosition(resultSet.getString(
				 * "no_of_resources")); Date myDate =
				 * resultSet.getDate("created_date"); if (myDate != null) {
				 * requirementListVTO.setPostedDate(
				 * com.mss.msp.util.DateUtility.getInstance().
				 * convertDateToViewInDashFormat(myDate)); } else {
				 * requirementListVTO.setPostedDate("---"); }
				 */
				// String preSkills = resultSet.getString("preferred_skills");
				requirementListVTO.setReqSkillSet(resultSet.getString("req_skills"));
				requirementListVTO.setTaxTerm(resultSet.getString("tax_term"));
	 ...
	 * Author :
	 *
	 * ForUse : addConsultBackgroundAttachmentDetails() method is used to
	 *
	 * *****************************************************************************
	 */
	public int addConsultBackgroundAttachmentDetails(RecruitmentAction recruitmentaction) {
		System.out.println(
				"********************RecruitmentServiceImpl :: addConsultBackgroundAttachmentDetails Method Start*********************");
		StringBuffer stringBuffer = new StringBuffer();
		int addResult = 0;
		boolean isExceute = false;
		Connection connection = null;
		...
		try {
			...
			String fpath = recruitmentaction.getFilePath();
			recruitmentaction.setFilePath(fpath);
			callableStatement = connection.prepareCall("{CALL addConsultantBackgroundAttachment(?,?,?,?,?,?,?,?)}");
			System.out
					.println("addConsultAttachmentDetails :: procedure name : addConsultBackgroundAttachmentDetails ");
			callableStatement.setInt(1, recruitmentaction.getConsult_id());
			callableStatement.setString(2, recruitmentaction.getAttachmentType());
			callableStatement.setString(3, recruitmentaction.getConsultAttachmentFileName());
			callableStatement.setString(4, recruitmentaction.getFilePath());
			callableStatement.setInt(5, recruitmentaction.getUserSessionId());
			callableStatement.setString(6, recruitmentaction.getAttachmentTitle());
			callableStatement.setInt(7, recruitmentaction.getCurrent_requirementId());
			callableStatement.registerOutParameter(8, Types.INTEGER);
			isExceute = callableStatement.execute();
			addResult = callableStatement.getInt(8);
		} catch (Exception sqe) {
			sqe.printStackTrace();
		} finally {
			try {
	...
	public List getRateCardList(RecruitmentAction recruitmentAction) throws ServiceLocatorException{
		System.out.println(
				"********************RecruitmentServiceImpl :: getRateCardList Method Start*********************");
		ArrayList<RateCardVTO> rateCardList = new ArrayList<RateCardVTO>();
		StringBuffer stringBuffer = new StringBuffer();
		String queryString = "";
		...
		try {
			...
			queryString = "SELECT id,orgid,jobtitle,minrate,maxrate,comments,createddate FROM orgratecards where orgid="+ recruitmentAction.getSessionOrgId() + "";

			
			if (recruitmentAction.getJobTitle() != null && !"".equals(recruitmentAction.getJobTitle())) {
				queryString = queryString + " AND jobtitle like'%" + recruitmentAction.getJobTitle() + "%' ";
			}
			if (recruitmentAction.getMinRate() != null && !"".equals(recruitmentAction.getMinRate())) {
				queryString = queryString + " AND minrate like'%" + recruitmentAction.getMinRate() + "%' ";
			}
			if (recruitmentAction.getMaxRate() != null && !"".equals(recruitmentAction.getMaxRate())) {
				queryString = queryString + " AND maxrate like'%" + recruitmentAction.getMaxRate() + "%' ";
			}

			
			queryString = queryString + " order by createddate desc";
			
			System.out.println("getRateCardList::queryString     -->" + queryString);
			...
			while (resultSet.next()) {
				...
				RateCardVTO rateCardVTO = new RateCardVTO();
				
				//id,orgid,jobtitle,minrate,maxrate,comments,createddate
				rateCardVTO.setRateCardId(resultSet.getInt("id"));
				rateCardVTO.setJobTitle(resultSet.getString("jobtitle"));
				rateCardVTO.setMinRate(resultSet.getString("minrate"));
				rateCardVTO.setMaxRate(resultSet.getString("maxrate"));
				rateCardVTO.setComments(resultSet.getString("comments"));
				rateCardVTO.setCreatedDate(resultSet.getString("createddate"));
				
				
				rateCardList.add(rateCardVTO);
		...
		System.out.println(
				"********************RecruitmentServiceImpl :: getRateCardList Method End*********************");
		return rateCardList;
	}
