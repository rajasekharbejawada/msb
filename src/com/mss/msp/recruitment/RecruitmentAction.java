...
public class RecruitmentAction extends ActionSupport implements ServletRequestAware, ServletResponseAware {
	...
	private int orgid;
	/*
	 * acr ---- requirement acc ---- consultant ac ---- account
	 */
	...
	private String consultwCity;
	private int consultwState;
	private String vendorName;
	private int roleId;
	
	private List<RateCardVTO> rateCardVTO;
	...
	public List<RateCardVTO> getRateCardVTO() {
		return rateCardVTO;
	}

	public void setRateCardVTO(List<RateCardVTO> rateCardVTO) {
		this.rateCardVTO = rateCardVTO;
	}
	...
	public int getConsultwState() {
		return consultwState;
	}

	public void setConsultwState(int consultwState) {
		this.consultwState = consultwState;
	}

	public String getConsultwCity() {
		return consultwCity;
	}

	public void setConsultwCity(String consultwCity) {
		this.consultwCity = consultwCity;
	}
	...
	private String reqPrimarySkillSet;
	// jagan
	...
	private String vendorCountryStateFlag;
	private String venUrl;
	private String venZip;
	private int vendorCountry;
	private int vendorState;
	private int vendorIndustry;
	private List<Account> vendorsList;

	private String attachmentType;

	private Map consultantWState;
	private String tabFlag;

	private String consult_otherSkills;
	private String consult_otherSecSkills;
	private String primaryValues;
	private String consultantAppStatus;
	private String csrAppStatus;
	private String csrAppComments;
	private String submittedFrom;
	private String submittedEnd;
	private String consultStatus;

	
	private String backgroundAttachmentTitle;
	private String backgroundAttachmentType;
	private File consultBackgroundAttachment;
	private String consultBackgroundAttachmentFileName;
	private int current_requirementId;
	...
	public int getCurrent_requirementId() {
		return current_requirementId;
	}

	public void setCurrent_requirementId(int current_requirementId) {
		this.current_requirementId = current_requirementId;
	}

	public String getBackgroundAttachmentTitle() {
		return backgroundAttachmentTitle;
	}

	public void setBackgroundAttachmentTitle(String backgroundAttachmentTitle) {
		this.backgroundAttachmentTitle = backgroundAttachmentTitle;
	}

	public String getBackgroundAttachmentType() {
		return backgroundAttachmentType;
	}

	public void setBackgroundAttachmentType(String backgroundAttachmentType) {
		this.backgroundAttachmentType = backgroundAttachmentType;
	}

	public File getConsultBackgroundAttachment() {
		return consultBackgroundAttachment;
	}

	public void setConsultBackgroundAttachment(File consultBackgroundAttachment) {
		this.consultBackgroundAttachment = consultBackgroundAttachment;
	}

	public String getConsultBackgroundAttachmentFileName() {
		return consultBackgroundAttachmentFileName;
	}

	public void setConsultBackgroundAttachmentFileName(String consultBackgroundAttachmentFileName) {
		this.consultBackgroundAttachmentFileName = consultBackgroundAttachmentFileName;
	}
	...
	public void setSubmittedEnd(String submittedEnd) {
		this.submittedEnd = submittedEnd;
	}

	public String getConsult_otherSecSkills() {
		return consult_otherSecSkills;
	}

	public void setConsult_otherSecSkills(String consult_otherSecSkills) {
		this.consult_otherSecSkills = consult_otherSecSkills;
	}
	...
	public Map getConsultantWState() {
		return consultantWState;
	}

	public String getConsult_otherSkills() {
		return consult_otherSkills;
	}

	public void setConsult_otherSkills(String consult_otherSkills) {
		this.consult_otherSkills = consult_otherSkills;
	}

	public void setConsultantWState(Map consultantWState) {
		this.consultantWState = consultantWState;
	}
	...
	public String getVenZip() {
		return venZip;
	}

	public void setVenZip(String venZip) {
		this.venZip = venZip;
	}

	public List<Account> getVendorsList() {
		return vendorsList;
	}

	public void setVendorsList(List<Account> vendorsList) {
	...
	public void setVendorState(int vendorState) {
		this.vendorState = vendorState;
	}

	public String getVendorCountryStateFlag() {
		return vendorCountryStateFlag;
	}

	public void setVendorCountryStateFlag(String vendorCountryStateFlag) {
		this.vendorCountryStateFlag = vendorCountryStateFlag;
	}
	...
	public String doAddConsultantForReq() {
		resultMessage = LOGIN;
		System.out.println(
				"********************RecruitmentAction :: doAddConsultantForReq Method Start*********************");
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			try {
				if ("added".equalsIgnoreCase(getResultFlag())) {
					addActionMessage("Consultant added Successfully");
				}
				SessionMap<String, Object> session = (SessionMap<String, Object>) ActionContext.getContext()
						.getSession();
		...
		System.out.println(
				"********************RecruitmentAction :: doAddConsultantForReq Method End*********************");
	...
	public String getMyConsultantSearch() {
		resultMessage = LOGIN;
		System.out.println(
				"********************RecruitmentAction :: getMyConsultantSearch Method Start*********************");
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			try {
				setSessionOrgId(Integer.parseInt(
		...
		System.out.println(
				"********************RecruitmentAction :: getMyConsultantSearch Method End*********************");
		return resultMessage;
	}
	...
	public String doAddConsultant() {
		System.out
				.println("********************RecruitmentAction :: doAddConsultant Method Start*********************");
		try {
			...
			setReqCategory(dataSourceDataProvider.getInstance().getReqPrimarySkillsCategory());
			...
			// Map skillsmap = (Map) session.get("skillsmap");
			setSkillValuesMap(dataSourceDataProvider.getInstance().getReqSkillsCategory(1));
	...
	public String getRequirementDetails() {
		resultType = LOGIN;
		System.out.println(
				"********************RecruitmentAction :: getRequirementDetails Method Start*********************");
		try {
		...
		System.out.println(
				"********************RecruitmentAction :: getRequirementDetails Method End*********************");
		return null;
	}
	...
	public String getAllRequirementList() {
		resultMessage = LOGIN;
		System.out.println(
				"********************RecruitmentAction :: getAllRequirementList Method Start*********************");
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			try {
				setSessionOrgId(Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.ORG_ID).toString()));
				setReqCreatedByMap(com.mss.msp.util.DataSourceDataProvider.getInstance()
						.GetProjectManagersListByOrgId(this.getSessionOrgId()));
				...
				/*
				 * requirementlistVTO =
				 * ServiceLocator.getRecruitmentService().getAllRequirementList(
				 * httpServletRequest,this); if (requirementlistVTO.size() == 0)
		...
		System.out.println(
				"********************RecruitmentAction :: getAllRequirementList Method End*********************");
		return resultMessage;
	}
	...
	public String addNewConsultant() {
		...
		int addresult = 0;
		System.out
				.println("********************RecruitmentAction :: addNewConsultant Method Start*********************");
		try {
			if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString() != null) {
				if (getFileFileName() == null) {
					...
					createPath.mkdirs();
					/*
					 * here it takes the absolute path and the name of the file
	...
	public String getupdateConsultantDetails() {
		resultMessage = LOGIN;
		System.out.println(
				"********************RecruitmentAction :: getupdateConsultantDetails Method Start*********************");
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			int userid = Integer.parseInt(
					httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString());
			if (getConsultFlag().equalsIgnoreCase("consultant")) {
				setConsult_id(Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
			...
			try {
				...
				// Map skillsmap = (Map) session.get("skillsmap");
				setSkillValuesMap(dataSourceDataProvider.getInstance().getReqSkillsCategory(1));
				consultantVTO = ServiceLocator.getRecruitmentService().getupdateConsultantDetails(this,
						getSkillValuesMap());
				setPermanentState(
						DataSourceDataProvider.getInstance().getPermanentStates(consultantVTO.getConsult_Country()));
				setCurrentState(
						DataSourceDataProvider.getInstance().getPermanentStates(consultantVTO.getConsult_CCountry()));
				// setPreState(DataSourceDataProvider.getInstance().getStatesOfCountryBasedOnRegion(consultantVTO.getConsult_preferredRegion(),consultantVTO.getConsult_preferredCountry()));
				setPreState(DataSourceDataProvider.getInstance().getStatesMapOfCountryBasedOnRegion(
						consultantVTO.getConsult_preferredRegion(), consultantVTO.getConsult_preferredCountry()));
				setReqCategory(dataSourceDataProvider.getInstance().getReqPrimarySkillsCategory());
				setRegionName(dataSourceDataProvider.getInstance().getRegionName());
				setConsultantWState(
						DataSourceDataProvider.getInstance().getPermanentStates(consultantVTO.getConsult_wcountry()));
				setConsultantAppStatus(getConsultantAppStatus());
				resultMessage = SUCCESS;
			} catch (Exception ex) {
				httpServletRequest.getSession(false).setAttribute("errorMessage:", ex.toString());
				resultMessage = ERROR;
		...
		System.out.println(
				"********************RecruitmentAction :: getupdateConsultantDetails Method End*********************");
		return resultMessage;
	}
	...
	public String getCurrentStatus() {
		resultMessage = LOGIN;
		System.out
				.println("********************RecruitmentAction :: getCurrentStatus Method Start*********************");
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			try {
				setOrgid(Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.ORG_ID).toString()));
				setUserSessionId(Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
	...
	public String doupdateConsultantDetails() {
		resultMessage = LOGIN;
		System.out.println(
				"********************RecruitmentAction :: doupdateConsultantDetails Method Start*********************");
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			if (getConsultFlag().equalsIgnoreCase("consultant")) {
			} else if (getConsultFlag().equalsIgnoreCase("vendor")) {
				setConsultFlag("vendor");
			...
			try {
				int orgId = Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.ORG_ID).toString());
				userSessionId = Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString());
				...
				consultantVTO = ServiceLocator.getRecruitmentService().doupdateConsultantDetails(this, userSessionId,
						orgId);
		...
		System.out.println(
				"********************RecruitmentAction :: doupdateConsultantDetails Method End*********************");
		return resultMessage;
	}
	...
	public String getDefaultConsultantListDetails() {
		resultType = LOGIN;
		System.out.println(
				"********************RecruitmentAction :: getDefaultConsultantListDetails Method Start*********************");
		...
		try {
			if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
				...
				setSessionOrgId(Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.ORG_ID).toString()));
				consultantList = ServiceLocator.getRecruitmentService().getConsultantListDetails(httpServletRequest,
						this);
				httpServletResponse.setHeader("Cache-Control", "no-cache, no-store, must-revalidate");
				httpServletResponse.setHeader("Pragma", "no-cache");
				httpServletResponse.setDateHeader("Expires", 0);
		...
		System.out.println(
				"********************RecruitmentAction :: getDefaultConsultantListDetails Method End*********************");
		return null;
	}
	...
	public String getConsultantListDetailsBySearch() {
		resultType = LOGIN;
		System.out.println(
				"********************RecruitmentAction :: getConsultantListDetailsBySearch Method Start*********************");
		String consultantList = "";
		try {
			if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
				setUserSessionId(Integer.parseInt(
				...
				setSessionOrgId(Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.ORG_ID).toString()));
				consultantList = ServiceLocator.getRecruitmentService().searchConsultantListDetails(httpServletRequest,
						this);
				httpServletResponse.setHeader("Cache-Control", "no-cache, no-store, must-revalidate");
				httpServletResponse.setHeader("Pragma", "no-cache");
				httpServletResponse.setDateHeader("Expires", 0);
		...
		System.out.println(
				"********************RecruitmentAction :: getConsultantListDetailsBySearch Method End*********************");
		return null;
	}
...
>>>>>>> branch 'develop' of https://github.com/MiracleCodeRepo/servicesbayrepo.git
	 *
<<<<<<< HEAD
	 * ForUse : getDefaultSubmittedList() Default.
=======
	 * ForUse : getDefaultSubmittedList() 
	 *
>>>>>>> branch 'develop' of https://github.com/MiracleCodeRepo/servicesbayrepo.git
	 *
	 *
	...
	public String getDefaultSubmittedList() {
		resultType = LOGIN;
		System.out.println(
				"********************RecruitmentAction :: getDefaultSubmittedList Method Start*********************");
		String consultantList = "";
		try {
			if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
				setUserSessionId(Integer.parseInt(
				...
				consultantList = ServiceLocator.getRecruitmentService().getSubmittedListDetails(httpServletRequest,
						this);
		...
		System.out.println(
				"********************RecruitmentAction :: getDefaultSubmittedList Method End*********************");
		return null;
	}
...
>>>>>>> branch 'develop' of https://github.com/MiracleCodeRepo/servicesbayrepo.git
	 *
	 * ForUse : getSubmittedSearch() searching.
	 *
	 *
	 * *****************************************************************************
	 */
	public String getSubmittedSearch() {
		resultType = LOGIN;
		System.out.println(
				"********************RecruitmentAction :: getSubmittedSearch Method Start*********************");
		String consultantList = "";
		try {
			if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
				setUserSessionId(Integer.parseInt(
				...
				setSessionOrgId(Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.ORG_ID).toString()));
				consultantList = ServiceLocator.getRecruitmentService().searchSubmittedListDetails(httpServletRequest,
						this);
				httpServletResponse.setHeader("Cache-Control", "no-cache, no-store, must-revalidate");
				httpServletResponse.setHeader("Pragma", "no-cache");
				httpServletResponse.setDateHeader("Expires", 0);
		...
		System.out
				.println("********************RecruitmentAction :: getSubmittedSearch Method End*********************");
		return null;
	}
	...
	public String addConsultAttachment() {
		...
		int addresult = 0;
		System.out.println(
				"********************RecruitmentAction :: addConsultAttachment Method Start*********************");
		try {
			if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString() != null) {
				if (getConsultAttachmentFileName() == null) {
					...
					short week = (short) (Math.round(dt.getDate() / 7));
					/*
					 * getrequestType is used to create a directory of the
					 * object type specified in the jsp page
					 */
					createPath = new File(
							createPath.getAbsolutePath() + File.separator + String.valueOf(dt.getYear() + 1900)
									+ File.separator + month + File.separator + String.valueOf(week));
					/*
					 * This creates a directory forcefully if the directory does
					 * not exsist
					 */
					createPath.mkdirs();
					/*
					...
					// String
					// userPrivateKey=dataSourceDataProvider.getInstance().getUserPrivateKey(getConsult_id(),"consultantId");
					// System.out.println("userPrivateKey-->in
					// AddConsultantAttacgments--"+userPrivateKey);
					SecurityServiceProvider.encryptFileUsingAES(aesKeyString, consultAttachment, destFile);
		...
		System.out.println(
				"********************RecruitmentAction :: addConsultAttachment Method End*********************");
		return SUCCESS;
	}
	...
	public String getActivityDetails() {
		resultType = LOGIN;
		System.out.println(
				"********************RecruitmentAction :: getActivityDetails Method Start*********************");
		try {
			if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
		...
		System.out
				.println("********************RecruitmentAction :: getActivityDetails Method End*********************");
		return null;
	}
	...
	public String doAddConsultantActivityDetails() {
		resultMessage = LOGIN;
		System.out.println(
				"********************RecruitmentAction :: doAddConsultantActivityDetails Method Start*********************");
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			try {
				int userid = Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString());
		...
		System.out.println(
				"********************RecruitmentAction :: doAddConsultantActivityDetails Method End*********************");
		return null;
	}
	...
	public String dogetConsultActivitydetailsbyActivity() {
		resultMessage = LOGIN;
		System.out.println(
				"********************RecruitmentAction :: dogetConsultActivitydetailsbyActivity Method Start*********************");
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			try {
				int userid = Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString());
				...
				setActivityCratedBy(userid);
				setActivityRelation("acc");
				String activityString = ServiceLocator.getRecruitmentService()
						.getConsultantActivityDetailsbyActivityId(this);
				httpServletResponse.setHeader("Cache-Control", "no-cache, no-store, must-revalidate");
				httpServletResponse.setHeader("Pragma", "no-cache");
				httpServletResponse.setDateHeader("Expires", 0);
				httpServletResponse.setContentType("text");
		...
		System.out.println(
				"********************RecruitmentAction :: dogetConsultActivitydetailsbyActivity Method End*********************");
		return null;
	}
	...
	public String doEditConsultantActivityDetails() {
		resultMessage = LOGIN;
		System.out.println(
				"********************RecruitmentAction :: doEditConsultantActivityDetails Method Start*********************");
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			try {
				int userid = Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString());
		...
		System.out.println(
				"********************RecruitmentAction :: doEditConsultantActivityDetails Method End*********************");
		return null;
	}
	...
	public String getLoginUserRequirementList() {
		resultMessage = LOGIN;
		System.out.println(
				"********************RecruitmentAction :: getLoginUserRequirementList Method Start*********************");
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			try {
				setTypeOfUser(Integer.parseInt(httpServletRequest.getSession(false)
						.getAttribute(ApplicationConstants.PRIMARYROLE).toString()));
				setUserSessionId(Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
				setSessionOrgId(Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.ORG_ID).toString()));
				...
				setSkillValuesMap(skillsmap);
				// requirementlistVTO =
				// ServiceLocator.getRecruitmentService().getLoginUserRequirementList(httpServletRequest,
				// this);
				setReqCategory(dataSourceDataProvider.getInstance().getRequiteCategory(1));
				/*
		...
		System.out.println(
				"********************RecruitmentAction :: getLoginUserRequirementList Method End*********************");
		return resultMessage;
	}
	...
	public String getConsultantStatus() {
		resultMessage = LOGIN;
		System.out.println(
				"********************RecruitmentAction :: getConsultantStatus Method Start*********************");
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			try {
				setOrgid(Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.ORG_ID).toString()));
		...
		System.out.println(
				"********************RecruitmentAction :: getConsultantStatus Method End*********************");
		return SUCCESS;
	}
	...
	public String techReview() {
		...
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			try {
				...
				setConsult_name(
						com.mss.msp.util.DataSourceDataProvider.getInstance().getConsultNameById(getConsult_id()));
			...
			if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
				...
				if (result > 0) {
					...
					if ("Online".equals(getInterviewType()) || "Psychometric".equals(getInterviewType())) {
						...
						mailResult = mailManager.doAddTechReviewEmailLogger(this, validKey, getConEmail(), accToken,
								getReqName());
	...
	public String getTechReviewDetails() {
		resultMessage = LOGIN;
		System.out.println(
				"********************RecruitmentAction :: getTechReviewDetails Method Start*********************");
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			try {
				...
				setUserSessionId(Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
				consultantList = ServiceLocator.getRecruitmentService().getTechReviewDetails(this, roleId,
						getUserSessionId(), orgId);
				if (consultantList.size() == 0) {
					setConsultantList(null);
				}
				resultMessage = SUCCESS;
		...
		System.out.println(
				"********************RecruitmentAction :: getTechReviewDetails Method End*********************");
		return resultMessage;
	}
	...
	public String getSearchTechReviewList() {
		resultMessage = LOGIN;
		System.out.println(
				"********************RecruitmentAction :: getSearchTechReviewList Method Start*********************");
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			try {
				setUserSessionId(Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
				...
				int roleId = Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.PRIMARYROLE).toString());
				String result = ServiceLocator.getRecruitmentService().getSearchTechReviewList(this, roleId,
						getUserSessionId(), getOrgid());
				httpServletResponse.setHeader("Cache-Control", "no-cache, no-store, must-revalidate");
				httpServletResponse.setHeader("Pragma", "no-cache");
				httpServletResponse.setDateHeader("Expires", 0);
				httpServletResponse.setContentType("text");
		...
		System.out.println(
				"********************RecruitmentAction :: getSearchTechReviewList Method End*********************");
		return null;
	}
	...
	public String getConsultDetailsOnOverlay() {
		resultMessage = LOGIN;
		System.out.println(
				"********************RecruitmentAction :: getConsultDetailsOnOverlay Method Start*********************");
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			try {
				setUserSessionId(Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
		...
		System.out.println(
				"********************RecruitmentAction :: getConsultDetailsOnOverlay Method End*********************");
		return null;
	}
	...
	public String saveTechReviewResults() {
		resultMessage = LOGIN;
		System.out.println(
				"********************RecruitmentAction :: saveTechReviewResults Method Start*********************");
		String resultString = "";
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			try {
				setUserSessionId(Integer.parseInt(
		...
		System.out.println(
				"********************RecruitmentAction :: saveTechReviewResults Method End*********************");
		return null;
	}
	...
	public String deleteConsultantAttachment() {
		resultMessage = LOGIN;
		System.out.println(
				"********************RecruitmentAction :: deleteConsultantAttachment Method Start*********************");
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			try {
				setOrgid(Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.ORG_ID).toString()));
		...
		System.out.println(
				"********************RecruitmentAction :: deleteConsultantAttachment Method End*********************");
		return SUCCESS;
	}
	...
	public String UploadConsultantAttachments() throws Exception {
		...
		int addresult = 0;
		System.out.println(
				"********************RecruitmentAction :: UploadConsultantAttachments Method Start*********************");
		try {
			if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString() != null) {
				if (getFileFileName() == null) {
				} else {
		...
		System.out.println(
				"********************RecruitmentAction :: UploadConsultantAttachments Method End*********************");
		return SUCCESS;
	}
	...
	public String forwardTechReview() {
		resultMessage = LOGIN;
		System.out.println(
				"********************RecruitmentAction :: forwardTechReview Method Start*********************");
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			try {
				setReqName(com.mss.msp.util.DataSourceDataProvider.getInstance().getReqNameById(getRequirementId()));
				setConsult_name(
		...
		System.out
				.println("********************RecruitmentAction :: forwardTechReview Method End*********************");
		return resultMessage;
	}
	...
	public String addVendorFormAttachments() {
		...
		int addresult = 0;
		System.out.println(
				"********************RecruitmentAction :: addVendorFormAttachments Method Start*********************");
		try {
			if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString() != null) {
				setUserSessionId(Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
				setUserType(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.TYPE_OF_USER)
						.toString());
				...
				if (getFileFileName() == null) {
					...
					// String
					// userPrivateKey=dataSourceDataProvider.getInstance().getUserPrivateKey(getUserSessionId(),"consultantId");
		...
		System.out.println(
				"********************RecruitmentAction :: addVendorFormAttachments Method End*********************");
		return SUCCESS;
	}
	...
	public String updateVendorFormAttachments() {
		...
		int addresult = 0;
		System.out.println(
				"********************RecruitmentAction :: updateVendorFormAttachments Method Start*********************");
		try {
			if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString() != null) {
				if (getFileFileName() == null) {
				} else {
				...
				setUserType(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.TYPE_OF_USER)
						.toString());
				String oId = httpServletRequest.getSession(false).getAttribute(ApplicationConstants.ORG_ID).toString();
				int res = ServiceLocator.getRecruitmentService().doUpdateVendorFormDetails(this,
						getAttachment_id_edit());
				// TODO Display Success message on JSP
				if (res > 0) {
					setConsultFlag("success");
				} else {
		...
		System.out.println(
				"********************RecruitmentAction :: updateVendorFormAttachments Method End*********************");
		return SUCCESS;
	}
	...
	public String getVendorRequirementsDashboard() {
		resultMessage = LOGIN;
		System.out.println(
				"********************RecruitmentAction :: getVendorRequirementsDashboard Method Start*********************");
		try {
			if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
				setUserSessionId(Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
				setOrgid(Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.ORG_ID).toString()));
				requirementlistVTO = ServiceLocator.getRecruitmentService()
						.getVendorRequirementsDashboard(httpServletRequest, this);
				resultMessage = SUCCESS;
			}
		} catch (Exception ex) {
			httpServletRequest.getSession(false).setAttribute("errorMessage:", ex.toString());
		...
		System.out.println(
				"********************RecruitmentAction :: getVendorRequirementsDashboard Method End*********************");
		return resultMessage;
	}
	 ...
	 *
	 * ForUse : getConsultantProfile() method is used to get consultant profile
	 * info.
	 *
	 * *****************************************************************************
	 */
	public String getConsultantProfile() {
		resultType = LOGIN;
		System.out.println(
				"********************RecruitmentAction :: getConsultantProfile Method Start*********************");
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			System.out.println(getAccountFlag());
			 if (getAccountFlag() != null && !"".equals(getAccountFlag()) && (getAccountFlag().equals("1") || getAccountFlag().equals("13") || getAccountFlag().equals("3") || getAccountFlag().equals("2") || getAccountFlag().equals("8") || getAccountFlag().equals("11") || getAccountFlag().equals("14"))){
					
					setConsult_id(getConsult_id());
				}
				else {
					setConsult_id(Integer.parseInt(
							httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
		...
		try {
			...
			Map skillsmap = (Map) session.get("skillsmap");
			setSkillValuesMap(skillsmap);
			consultantVTO = ServiceLocator.getRecruitmentService().getConsultantProfile(this, skillsmap);
			setPermanentState(
					DataSourceDataProvider.getInstance().getPermanentStates(consultantVTO.getConsult_Country()));
			setCurrentState(
					DataSourceDataProvider.getInstance().getPermanentStates(consultantVTO.getConsult_CCountry()));
	...
	}System.out.println("********************RecruitmentAction :: getConsultantProfile Method End*********************");return resultType;
	 ...
	 * Author : Manikanta Eeralla <meeralla@miraclesoft.com>
	 *
	 * ForUse : getVendorsListForConsultant() method is used to get all vendors.
	 *
	 * *****************************************************************************
	 */
	public String getVendorsListForConsultant() {
		resultType = LOGIN;
		System.out.println(
				"********************RecruitmentAction :: getVendorsListForConsultant Method Start*********************");
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {

			// setConsult_id(Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));

			try {
				int consultantId = Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString());
				...
				// System.out.println("form flag
				// value-->"+getVendorCountryStateFlag());

				if (!"formsubmittion".equals(getVendorCountryStateFlag())) {
					setVendorCountry(3);
				} else {
					setVendorCountry(getVendorCountry());
				}
				// System.out.println("getVendorCountry()-->"+getVendorCountry());
				setPermanentState(DataSourceDataProvider.getInstance().getPermanentStates(getVendorCountry()));

				vendorsList = ServiceLocator.getRecruitmentService().getVendorsListForConsultant(this, consultantId);
		...
		System.out.println(
				"********************RecruitmentAction :: getVendorsListForConsultant Method End*********************");
		return resultType;
	}
	 ...
	 * *****************************************************************************
	 */
	public String updateConsultantProfile() {
		resultMessage = LOGIN;
		System.out.println(
				"********************RecruitmentAction :: updateConsultantProfile Method Start*********************");
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {

			try {
				// int orgId =
				// Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.ORG_ID).toString());
				userSessionId = Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString());
				if (getConsult_checkAddress().equalsIgnoreCase("true")) {
					setConsult_checkAddress("PC");
				...
				consultantVTO = ServiceLocator.getRecruitmentService().updateConsultantProfile(this, userSessionId);
				addActionMessage("Updated successfully");
				resultMessage = SUCCESS;
			} catch (Exception ex) {
				httpServletRequest.getSession(false).setAttribute("errorMessage:", ex.toString());
	 ...
	 * *****************************************************************************
	 */
	public String getVenConRequirements() {
		resultMessage = LOGIN;
		System.out.println(
				"********************RecruitmentAction :: getLoginUserRequirementList Method Start*********************");
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			try {
				/*
				 * setTypeOfUser(Integer.parseInt(httpServletRequest.getSession(
				 * false)
				 * .getAttribute(ApplicationConstants.TYPE_OF_USER).toString()))
				 * ;
				 */
				setUserSessionId(Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
				...
				Map skillsmap = (Map) session.get("skillsmap");
				setSkillValuesMap(skillsmap);
				requirementlistVTO = ServiceLocator.getRecruitmentService().getVenConRequirements(httpServletRequest,
						this);
				// setReqCategory(dataSourceDataProvider.getInstance().getRequiteCategory(1));
				/*
				 * if (requirementlistVTO.size() == 0) {
	 ...
	 * Author :
	 *
	 * ForUse : Background attachment upload method is used to
	 *
	 * *****************************************************************************
	 */
	public String consultBackgroundUpload() {
		resultType = LOGIN;
		int addresult = 0;
		System.out.println(
				"********************RecruitmentAction :: addConsultAttachment Method Start*********************");
		try {
			if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString() != null) {
				if (getConsultBackgroundAttachmentFileName() == null) {
				} else {
					String basefilePath = Properties.getProperty("Consultant.Background"); 
					//File createPath = new File(filePath);
					
					String aesKeyString = Properties.getProperty("AES_KEY");
					setFilePath(DataSourceDataProvider.getInstance()
							.createFileInFileSystem(basefilePath,consultBackgroundAttachmentFileName,consultBackgroundAttachment,aesKeyString));
				System.out.println("consultBackgroundUpload--->"+getFilePath());
				...
				setUserSessionId(Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
				setAttachmentType(getBackgroundAttachmentType());
				
				setConsultAttachmentFileName(getConsultBackgroundAttachmentFileName());
				setAttachmentTitle(getBackgroundAttachmentTitle());
				addresult = ServiceLocator.getRecruitmentService().addConsultBackgroundAttachmentDetails(this);
				if (addresult > 0) {
					 setTabFlag("attachmentTab");
				} else {
				}
	...
	//consultBackgroundUploadInitiation
		public String consultBackgroundUploadInitiation() {
			resultType = LOGIN;
			int addresult = 0;
			System.out.println(
					"********************RecruitmentAction :: addConsultAttachment Method Start*********************");
		...
		public String getRateCardList() {
			resultMessage = LOGIN;
			System.out.println(
					"********************RecruitmentAction :: getRateCardList Method Start*********************");
			if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
				try {
					...
					rateCardVTO = ServiceLocator.getRecruitmentService().getRateCardList(this);
					// setReqCategory(dataSourceDataProvider.getInstance().getRequiteCategory(1));
					/*
					 * if (requirementlistVTO.size() == 0) {
					 * setRequirementlistVTO(null); }
			...
			System.out.println(
					"********************RecruitmentAction :: getRateCardList Method End*********************");
			return resultMessage;
		}
	...
	public String getReqPrimarySkillSet() {
		return reqPrimarySkillSet;
	}

	public void setReqPrimarySkillSet(String reqPrimarySkillSet) {
		this.reqPrimarySkillSet = reqPrimarySkillSet;
	}
	...
	public String getConsultantAppStatus() {
		return consultantAppStatus;
	}

	public void setConsultantAppStatus(String consultantAppStatus) {
		this.consultantAppStatus = consultantAppStatus;
	}

	public String getCsrAppStatus() {
		return csrAppStatus;
	}

	public void setCsrAppStatus(String csrAppStatus) {
		this.csrAppStatus = csrAppStatus;
	}

	public String getCsrAppComments() {
		return csrAppComments;
	}

	public void setCsrAppComments(String csrAppComments) {
		this.csrAppComments = csrAppComments;
	}
