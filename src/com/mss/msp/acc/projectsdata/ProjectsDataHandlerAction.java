...
public class ProjectsDataHandlerAction extends ActionSupport implements ServletRequestAware {
	...
	public String getProjectSearchDetails() throws ParseException {
		System.out.println(
				"********************ProjectsDataHandlerAction :: getProjectSearchDetails Method Start*********************");
		resultType = LOGIN;
		...
		try {
			...
			if (httpServletRequest.getSession(false).getAttributeNames() != null) {
				...
				searchDetails = ServiceLocator.getProjectDataHandlerService().getProjectSearchDetails(this,
						httpServletRequest);
		...
		System.out.println(
				"********************ProjectsDataHandlerAction :: getProjectSearchDetails Method End*********************");
		return resultType;
	}
	...
	public String checkProjectNames() throws ServiceLocatorException, UnsupportedEncodingException {
		...
		System.out.println(
				"********************ProjectsDataHandlerAction :: checkProjectNames Method Start*********************");

		accountID = (Integer
				.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.ORG_ID).toString()));
		if ("main".equals(getProjectFlag())) {
			setMainProjectId(0);
		}
		String projName = httpServletRequest.getAttribute("projectName").toString();
		inputStream = new ByteArrayInputStream(ServiceLocator.getProjectDataHandlerService()
				.checkProjectName(projName, getProjectFlag(), getMainProjectId(), accountID).toString()
				.getBytes("ISO-8859-1"));
		System.out.println(
				"********************ProjectsDataHandlerAction :: checkProjectNames Method End*********************");
		return SUCCESS;
	}
	...
	public String getProjectsByAccID() {
		System.out.println(
				"********************ProjectsDataHandlerAction :: getProjectsByAccID Method Start*********************");
		resultType = LOGIN;
		projectCreatedBy = Integer
				.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString());
		accountID = Integer
				.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.ORG_ID).toString());
		roleValue = httpServletRequest.getSession(false).getAttribute(ApplicationConstants.PRIMARYROLEVALUE).toString();
		setSessionOrgId(Integer
				.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.ORG_ID).toString()));
		try {
			if (httpServletRequest.getSession(false).getAttributeNames() != null) {
				searchDetails = ServiceLocator.getProjectDataHandlerService().getProjectsByAccID(accountID,
						projectCreatedBy, roleValue);
				searchDetails = processProjectType(searchDetails);
				setCostCenterNames(DataSourceDataProvider.getInstance().getCostCenterNames(getSessionOrgId()));
		...
		System.out.println(
				"********************ProjectsDataHandlerAction :: getProjectsByAccID Method End*********************");
		return resultType;
	}
	...
	public String addProject() {
		System.out.println(
				"********************ProjectsDataHandlerAction :: addProject Method Start*********************");
		String currentFormat = "MM-dd-yyyy";
		String newFormat = "yyyy-MM-dd";
		resultType = LOGIN;
		...
		try {
			if (httpServletRequest.getSession(false).getAttributeNames() != null) {
				...
				project.setProjectName(StringUtils.capitalize(projectName));
				project.setProjectType("MP");
				if (projectReqSkillSet != null && projectReqSkillSet != "") {
					project.setProjectReqSkillSet(StringUtils.capitalize(projectReqSkillSet));
				} else {
					project.setProjectReqSkillSet(projectReqSkillSet);
				}
				if (project_description != null && project_description != "") {
					project.setProject_description(StringUtils.capitalize(project_description));
				} else {
				...
				project.setProjectModifiedBy(Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
				project.setProjectCreatedBy(Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
		...
		System.out
				.println("********************ProjectsDataHandlerAction :: addProject Method End*********************");
		return resultType;
	...
	public String addSubProject() {
		System.out.println(
				"********************ProjectsDataHandlerAction :: addSubProject Method Start*********************");
		resultType = LOGIN;
		...
		System.out.println(
				"********************ProjectsDataHandlerAction :: addSubProject Method End*********************");
		return resultType;
	...
	public String getProjectDetails() {
		System.out.println(
				"********************ProjectsDataHandlerAction :: getProjectDetails Method Start*********************");
		...
		try {
			if (httpServletRequest.getSession(false).getAttributeNames() != null) {
				...
				numberOfResources = ServiceLocator.getProjectDataHandlerService().getProjectResourceCount(this,
						httpServletRequest);
		...
		System.out.println(
				"********************ProjectsDataHandlerAction :: getProjectDetails Method End*********************");
		return resultType;
	}
	...
	public String updateProject() {
		System.out.println(
				"********************ProjectsDataHandlerAction :: updateProject Method Start*********************");
		resultType = LOGIN;
		...
		try {
			if (httpServletRequest.getSession(false).getAttributeNames() != null) {
				...
				if (!p.getProjectName().equals(project.getProjectName())) {
					p.setProjectName(StringUtils.capitalize(project.getProjectName()));
				}
				p.setProjectModifiedBy(Integer.parseInt(user));
				p.setProjectModifiedDate(new Timestamp(currentDate.getTime()).toString());

				if (project.getProjectReqSkillSet() != null && project.getProjectReqSkillSet() != "") {
					p.setProjectReqSkillSet(StringUtils.capitalize(project.getProjectReqSkillSet()));
				}
				...
				if (project.getProject_description() != null && project.getProject_description() != "") {
					p.setProject_description(StringUtils.capitalize(project.getProject_description()));
				}
				...
				if (!project.getProjectName().isEmpty() && !project.getProjectTargetDate().isEmpty()
						&& !project.getProjectStartDate().isEmpty() && !project.getProject_status().isEmpty()) {
		...
		System.out.println(
				"********************ProjectsDataHandlerAction :: updateProject Method End*********************");
		return resultType;
	...
	public String getSubProjects() {
		System.out.println(
				"********************ProjectsDataHandlerAction :: getSubProjects Method Start*********************");
		resultType = LOGIN;
		projectID = Integer.parseInt(httpServletRequest.getSession(false).getAttribute("projectID").toString());
		try {
			if (httpServletRequest.getSession(false).getAttributeNames() != null) {
		...
		System.out.println(
				"********************ProjectsDataHandlerAction :: getSubProjects Method End*********************");
		return resultType;
	}
	...
	public List<ProjectsVTO> processProjectType(List<ProjectsVTO> projectList) {
		...
		for (int i = 0; i < projectList.size(); i++) {
			try {
				String currentFormat = "yyyy-MM-dd";
				String newFormat = "MM-dd-yyyy";
				projectList.get(i).setProjectStartDate(
						formatDate(projectList.get(i).getProjectStartDate(), currentFormat, newFormat));

				projectList.get(i).setProjectTargetDate(formatDate(
						projectList.get(i).getProjectTargetDate().substring(0, 10), currentFormat, newFormat));
	...
	public String getProjectsDashboard() {
		System.out.println(
				"********************ProjectsDataHandlerAction :: getProjectsDashboard Method Start*********************");
		resultType = LOGIN;
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			...
			try {
				...
				projectsMap = DataSourceDataProvider.getInstance().getProjectsMap(getSessionOrgId(), "MP",
						getDashBoardYear());
		...
		System.out.println(
				"********************ProjectsDataHandlerAction :: getProjectsDashboard Method End*********************");
		return resultType;
	}
	...
	public static String formatDate(String date, String initDateFormat, String endDateFormat) throws ParseException {
		// System.out.println("********************ProjectsDataHandlerAction ::
		// formatDate Method Start*********************");
		Date initDate = new SimpleDateFormat(initDateFormat).parse(date);
		SimpleDateFormat formatter = new SimpleDateFormat(endDateFormat);
		String parsedDate = formatter.format(initDate);
		// System.out.println("********************ProjectsDataHandlerAction ::
		// formatDate Method End*********************");
		return parsedDate;
	}
