...
import com.mss.msp.acc.accajax.AccountAjaxHandler;
...
public interface AccountService {
	...
	public List<Account> doAccountSearch(String name, String url, String zip, String status,
            State state, Country Country, Integer type, Integer industry, String lastAcccessDate, Integer orgId, Integer csrId, String diversity, String staffingMode, String staffingModeTemp) throws ServiceLocatorException;
