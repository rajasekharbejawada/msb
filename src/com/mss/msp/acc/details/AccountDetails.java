...
public class AccountDetails {
	...
	private List staffingModeList;
	private String venSpecialization;
	private List venSpecializationList;
	private String swiftBicCode;
	private String ownerShip;
	private String diversity;
	private String dunnbradStreetno;

	public AccountDetails() {
	}

	public AccountDetails(Integer id, String name, String url, String status, String region, String stockSymbol,
			String description, String industry, String taxId, Integer budget, String revenue, String phone, String fax,
			String noemp, String territory, String country, String address1, String address2, String state, String zip,
			String city, Integer accountType, String lkState, String lkCountry, String lkIndustry, String lkAccountType,
			String lkVendor, String emailExt, String bankAccountNumber, String bankName, String bankAddress,
			String bankCity, String bankZip, String bankRoutingNumber, Integer isPrimary, String beneficiaryName,
			String skillValues, String accLogo, String businessType, String businessTypeDesc, String minorityGroup,
			String staffingMode, String venSpecialization, String swiftBicCode, String ownerShip, String diversity,
			String dunnbradStreetno) {
		this.id = id;
		this.name = name;
		this.url = url;
		this.status = status;
		...
		this.dunnbradStreetno = dunnbradStreetno;

	}

	public List getStaffingModeList() {
		return staffingModeList;
	}

	public void setStaffingModeList(List staffingModeList) {
	...
	public String getDunnbradStreetno() {
		return dunnbradStreetno;
	}

	public void setDunnbradStreetno(String dunnbradStreetno) {
		this.dunnbradStreetno = dunnbradStreetno;
	}

	public List getVenSpecializationList() {
		return venSpecializationList;
	}

	public void setVenSpecializationList(List venSpecializationList) {
		this.venSpecializationList = venSpecializationList;
	}
	...
	public String toString() {
		return "AccountDetails{" + "id=" + id + ", name=" + name + ", url=" + url + ", status=" + status + ", region="
				+ region + ", stockSymbol=" + stockSymbol + ", description=" + description + ", industry=" + industry
				+ ", taxId=" + taxId + ", budget=" + budget + ", revenue=" + revenue + ", phone=" + phone + ", fax="
				+ fax + ", noemp=" + noemp + ", territory=" + territory + ", country=" + country + ", address1="
				+ address1 + ", address2=" + address2 + ", state=" + state + ", zip=" + zip + ", accountType="
				+ accountType + ", lkState=" + lkState + ", lkCountry=" + lkCountry + ", lkIndustry=" + lkIndustry
				+ ", lkAccountType=" + lkAccountType + '}';
	}
