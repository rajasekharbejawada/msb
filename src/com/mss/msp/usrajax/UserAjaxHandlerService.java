...
public interface UserAjaxHandlerService {
    ...
    public String approveOtherSkills(UserAjaxHandlerAction userAjaxHandlerAction, int userId, int empId, String other_skill, String skill_type, String action) throws ServiceLocatorException;
}
