...
public class RecruitmentAjaxHandlerAction extends ActionSupport implements ServletRequestAware, ServletResponseAware {
        ...
        public void onStartPage(PdfWriter writer, Document document) {
            try {
             ...
             //   Image image = Image.getInstance(contextPath + "/includes/images/logo30.png");
                Image image = Image.getInstance(Properties.getProperty("MSB_LOGO_FOR_PDF"));
 ...
 /**
     ...
     * ******************************************************************
     *
     * @doConsultantVendorAssociation() method is used Associates the Consultant and Vendors.
     * 
     * @Author:manikanta eeralla<meeralla@miraclesoft.com>
     *
    ...
    public String doConsultantVendorAssociation(){
    	
    	resultType = LOGIN;
        String reponseString = "";
        try {
            System.out.println("********************RecruitmentAjaxHandlerAction :: doConsultantVendorAssociation() Action Start*********************");
            if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
                int consultantId=(Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
                int reponse = ServiceLocator.getRecruitmentAjaxHandlerService().doConsultantVendorAssociation(consultantId,getVendorId());
                System.out.println("reponse in doConsultantVendorAssociation-->"+reponse);
                if (reponse > 0) {
                    reponseString = "Consult request Submitted Successfully";
                }
            ...
            resultType = ERROR;
             ...
             System.out.println("********************RecruitmentAjaxHandlerAction :: doConsultantVendorAssociation() Action End*********************");
        return null;
    	
    }
    
public String getUserEmailForRequirement(){
    	
    	resultType = LOGIN;
        String reponseString = "";
        try {
            System.out.println("********************RecruitmentAjaxHandlerAction :: getUserEmailForRequirement() Action Start*********************");
            if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
                int userSessionId=(Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
                int userSessionOrgId=(Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.ORG_ID).toString()));
                String reponse = ServiceLocator.getRecruitmentAjaxHandlerService().getUserEmailForRequirement(getEmpName(),userSessionOrgId,getResourceType());
                System.out.println("reponse in getUserEmailForRequirement-->"+reponse);
                ...
                httpServletResponse.setContentType("text");
                httpServletResponse.setCharacterEncoding("UTF-8");
                httpServletResponse.getWriter().write(reponse);
            ...
            resultType = ERROR;
             ...
             System.out.println("********************RecruitmentAjaxHandlerAction :: getUserEmailForRequirement() Action End*********************");
        return null;
...
public String doGetAvailableConsultantList(){
      ...
      try {
          ...
          if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
              int userSessionId=(Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
              int userSessionOrgId=(Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.ORG_ID).toString()));
              String reponse = ServiceLocator.getRecruitmentAjaxHandlerService().doGetAvailableConsultantList(getConEmail(),userSessionOrgId,getResourceType(),getSkillSett(),getRequirementId(),getAvailableFrom(),getRateFrom(),getRateTo());
              System.out.println("reponse in getUserEmailForRequirement-->"+reponse);
...
public String submitProfileToRequirement(){
          ...
          if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
             ...
             //
              String reponse = "";
               ...
               reponse = ServiceLocator.getRecruitmentAjaxHandlerService().storeProofData(httpServletRequest,this);
              System.out.println("reponse in getUserEmailForRequirement-->"+reponse);
...
public String checkResumeExistOrNot(){
      ...
      try {
          ...
          if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
             ...
             // setAcc_attachment_id(Integer.parseInt(httpServletRequest.getParameter("acc_attachment_id").toString()));

            
//                  if (getAcc_attachment_id() == -1) {
//                      setConsult_AttachmentLocation(DataSourceDataProvider.getInstance().getConsultVisaAttachment(getConsult_id()));
//                  } else {
                     String result= DataSourceDataProvider.getInstance().getConsult_AttachmentLocation(this.getAcc_attachment_id());
            System.out.println("-0----------------------------------------->"+result);
                      setConsult_AttachmentLocation(result);
//                  }
             
              File attachmentFile=new File(getConsult_AttachmentLocation());
...
* ******************************************************************
*
* @doUpdateCSRStatusforConsultant() method is used update the Approval status.
* 
...
*/
   ...
   public String doUpdateCSRStatusforConsultant(){
           ...
           try {
               ...
               if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
                   int userSessionId=(Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
                   int userSessionOrgId=(Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.ORG_ID).toString()));
                   String reponse = ServiceLocator.getRecruitmentAjaxHandlerService().doUpdateCSRStatusforConsultant(this);
                   System.out.println("reponse in getUserEmailForRequirement-->"+reponse);
    ...
    * Author :
    *
    * Method: getBackgroundAttachmentList() method can be used to get the attachment 
    *     
    * *****************************************************************************
    */
   public String getBackgroundAttachmentList() {
      
         System.out.println("********************RecruitmentAjaxHandlerAction :: getBackgroundAttachmentList() Action Start*********************");
       if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
           try {
               String attachmentList = ServiceLocator.getRecruitmentAjaxHandlerService().getBackgroundAttachmentDetails(this);
               int Response = Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString());
               httpServletResponse.setHeader("Cache-Control", "no-cache, no-store, must-revalidate");
               httpServletResponse.setHeader("Pragma", "no-cache");
               httpServletResponse.setDateHeader("Expires", 0);
    ...
    * *****************************************************************************
    */
   public String insertOrUpdateRatecard() {
      
         System.out.println("********************RecruitmentAjaxHandlerAction :: insertOrUpdateRatecard() Action Start*********************");
       if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
           try {
               ...
               String responseMessage = ServiceLocator.getRecruitmentAjaxHandlerService().insertOrUpdateRatecard(this);
               int Response = Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString());
               httpServletResponse.setHeader("Cache-Control", "no-cache, no-store, must-revalidate");
               httpServletResponse.setHeader("Pragma", "no-cache");
               httpServletResponse.setDateHeader("Expires", 0);
         ...
         System.out.println("********************RecruitmentAjaxHandlerAction :: insertOrUpdateRatecard() Action End*********************");
       return null;
   }
   
   
   public String getJobTitleSuggestions(){
   	
   	resultType = LOGIN;
       String reponseString = "";
       try {
           System.out.println("********************RecruitmentAjaxHandlerAction :: getJobTitleSuggestions() Action Start*********************");
           if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
               int userSessionId=(Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
               int userSessionOrgId=(Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.ORG_ID).toString()));
               String reponse = ServiceLocator.getRecruitmentAjaxHandlerService().getJobTitleSuggestions(getJobTitle(),userSessionOrgId);
               System.out.println("reponse in getUserEmailForRequirement-->"+reponse);
           ...
           resultType = ERROR;
            ...
            System.out.println("********************RecruitmentAjaxHandlerAction :: getJobTitleSuggestions() Action End*********************");
       return null;
	...
	public String getSkillSett() {
		return skillSett;
	}

	public void setSkillSett(String skillSett) {
		this.skillSett = skillSett;
	}
