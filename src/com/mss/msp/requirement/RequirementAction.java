...
public class RequirementAction extends ActionSupport implements ServletRequestAware, ServletResponseAware {
    ...
    private String skillCategoryValue;
   
	private Map preSkillValuesMap;
	private Map skillSetValuesMap;
    ...
    private int copyReqFlag;
    private String vendorOrgIds;
    private String activityType;
    private int vendorTierType;
	...
	public Map getSkillSetValuesMap() {

		return skillSetValuesMap;
	}

	public void setSkillSetValuesMap(Map skillSetValuesMap) {
		this.skillSetValuesMap = skillSetValuesMap;
	}
    public String getSkillCategoryValue() {
		return skillCategoryValue;
	}

	public void setSkillCategoryValue(String skillCategoryValue) {
        ...
        try {
            if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
               ...
               /* Map tempMap = new HashMap();
                ...
                Iterator entries = skillsmap.entrySet().iterator();
               ...
               System.out.println("Map values in tempMap: "+ tempMap);*/
               
              /*// Map<Integer, String> map = sortByValues(tempMap); 
...
//                setSkillValuesMap("");
                ...
                setSkillSetValuesMap(skillsmap);
        ...
        /*private static HashMap sortByValues(Map tempMap) { 
...
//                setSkillValuesMap(skillsmap);
                setPreSkillValuesMap(skillsmap);
                setSkillSetValuesMap(skillsmap);
//                dataSourceDataProvider.getInstance().getSkillsBasedOnPrimarySkill(getPriSkillId());
                ...
                requirementVTO = ServiceLocator.getRequirementService().editrequirement(getRequirementId(), skillsmap);
                if (typeOfUser.equals("VC") || typeOfUser.equals("IC")) {
     ...
     *
     * ForUse : getSubmissionList() method is used to
     *
     *
     * *****************************************************************************
     */
    public String getSubmissionList() {
        String resultMessage;
        resultMessage = LOGIN;
        log.info("********************RequirementAction :: getSubmissionList Method Start*********************");
        ...
        log.info("********************RequirementAction :: getSubmissionList Method End*********************");
        return resultMessage;
    }
    ...
    public String getVendorsBasedOnReqCategory() {
        resultMessage = LOGIN;
        String resultString = "";
        log.info("********************RequirementAction :: getVendorsBasedOnReqCategory Method Start*********************");
        if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
            try {
                setUserSessionId(Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
                setSessionOrgId(Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.ORG_ID).toString()));
                setAccount_name(dataSourceDataProvider.getInstance().getAccountNameById(getSessionOrgId()));
                resultString= dataSourceDataProvider.getInstance().getVendorsBasedOnReqCategory(getRequirementId(),getOrgId(),getTaxTerm());
                httpServletResponse.setHeader("Cache-Control", "no-cache, no-store, must-revalidate");
                httpServletResponse.setHeader("Pragma", "no-cache");
                httpServletResponse.setDateHeader("Expires", 0);
                httpServletResponse.setContentType("text");
        ...
        log.info("********************RequirementAction :: getVendorsBasedOnReqCategory Method End*********************");
        return null;
    }

    public int getVendorTierType() {
		return vendorTierType;
	}

	public void setVendorTierType(int vendorTierType) {
     ...
     * ForUse :
     *
     * @getCustomerRequirementPieChartDetails() method is used to 
     *
     * *****************************************************************************
     */
    public String getCustomerRequirementPieChartDetails() {
        resultMessage = LOGIN;
        System.out.println("********************RequirementAction :: getCustomerRequirementPieChartDetails Method Start*********************");
        if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
            try {
                setUserSessionId(Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
                setSessionOrgId(Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.ORG_ID).toString()));
                String csrReq = ServiceLocator.getRequirementService().getCustomerRequirementPieChartDetails(this);
                httpServletResponse.setHeader("Cache-Control", "no-cache, no-store, must-revalidate");
                httpServletResponse.setHeader("Pragma", "no-cache");
                httpServletResponse.setDateHeader("Expires", 0);
                httpServletResponse.setContentType("text");
        ...
        System.out.println("********************RequirementAction :: getCustomerRequirementPieChartDetails Method End*********************");
        return null;
    }
     ...
     *
     * ForUse : "getReleaseVendors"() method is used to
     *
     *
     * *****************************************************************************
    
    public String getReleaseVendors() {
        String resultMessage;
        resultMessage = LOGIN;
        if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
            try {
            	  System.out.println("getReleaseVendors..in if.");
    ...
    public String getReqReleaseVendors() {
        String resultMessage;
        resultMessage = LOGIN;
        if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
            try {
	 ...
	 * Date : 14/06/2017
	 *
	 * Author : Anand Patnaik<apatnaik@miraclesoft.com>
	 *
	 * ForUse :
	 *
	 * doGetTechReviewanalysis() method is used to
	 *
	 * *****************************************************************************
	 */
	public String doGetTechReviewanalysis() {
		resultMessage = LOGIN;
		System.out.println(
				"********************RequirementAction :: doGetTechReviewanalysis Method Start*********************");
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			try {
				...
				String csrReq = ServiceLocator.getRequirementService().doGetTechReviewanalysis(this);
				httpServletResponse.setHeader("Cache-Control", "no-cache, no-store, must-revalidate");
				httpServletResponse.setHeader("Pragma", "no-cache");
				httpServletResponse.setDateHeader("Expires", 0);
				httpServletResponse.setContentType("text");
		...
		System.out.println(
				"********************RequirementAction :: getCustomerRequirementPieChartDetails Method End*********************");
		return null;
	}
    ...
    public int getCopyReqFlag() {
        return copyReqFlag;
    }

    public void setCopyReqFlag(int copyReqFlag) {
        this.copyReqFlag = copyReqFlag;
    }

    public String getVendorOrgIds() {
        return vendorOrgIds;
    }

    public void setVendorOrgIds(String vendorOrgIds) {
        this.vendorOrgIds = vendorOrgIds;
    }
	...
	public String getRequirementEnd() {
		return requirementEnd;
	}

	public void setRequirementEnd(String requirementEnd) {
		this.requirementEnd = requirementEnd;
	}
